...
/**
 * NfeSefazPAASignature Class Doc Comment
 *
 * @category Class
 ...
 */
class NfeSefazPAASignature implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'NfeSefazPAASignature';
    ...
    protected static $openAPITypes = [
        ...
        'rsa_key_value' => '\ACBrAPI\Model\NfeSefazRSAKeyValueType'
    ];
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (!preg_match("/^(?:[A-Za-z0-9+\/]{4})*(?:[A-Za-z0-9+\/]{2}==|[A-Za-z0-9+\/]{3}=)?$/", $this->container['signature_value'])) {
            $invalidProperties[] = "invalid value for 'signature_value', must be conform to the pattern /^(?:[A-Za-z0-9+\/]{4})*(?:[A-Za-z0-9+\/]{2}==|[A-Za-z0-9+\/]{3}=)?$/.";
        }
    ...
    public function setSignatureValue($signature_value)
    {
        ...
        if (!is_null($signature_value) && (!preg_match("/^(?:[A-Za-z0-9+\/]{4})*(?:[A-Za-z0-9+\/]{2}==|[A-Za-z0-9+\/]{3}=)?$/", $signature_value))) {
            throw new \InvalidArgumentException("invalid value for \$signature_value when calling NfeSefazPAASignature., must conform to the pattern /^(?:[A-Za-z0-9+\/]{4})*(?:[A-Za-z0-9+\/]{2}==|[A-Za-z0-9+\/]{3}=)?$/.");
        }
     ...
     * Gets rsa_key_value
     *
     * @return \ACBrAPI\Model\NfeSefazRSAKeyValueType
     */
     ...
     * Sets rsa_key_value
     *
     * @param \ACBrAPI\Model\NfeSefazRSAKeyValueType $rsa_key_value rsa_key_value
     *
     * @return self
     */
