...
/**
 * DceSefazEmit Class Doc Comment
 *
 * @category Class
 ...
 */
class DceSefazEmit implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'DceSefazEmit';
    ...
    protected static $openAPITypes = [
        ...
        'cpf' => 'string',
        'x_nome' => 'string',
        'ender_emit' => '\ACBrAPI\Model\DceSefazEndeEmi'
    ];
    ...
    */
     ...
     * Sets cpf
     *
     * @param string|null $cpf Número do CPF do emitente.  Informar os zeros não significativos.
     *
     * @return self
     */
    ...
    public function setXNome($x_nome)
    {
        ...
        if (!is_null($x_nome) && (mb_strlen($x_nome) > 60)) {
            throw new \InvalidArgumentException('invalid length for $x_nome when calling DceSefazEmit., must be smaller than or equal to 60.');
        }
        if (!is_null($x_nome) && (mb_strlen($x_nome) < 2)) {
            throw new \InvalidArgumentException('invalid length for $x_nome when calling DceSefazEmit., must be bigger than or equal to 2.');
        }
     ...
     * Gets ender_emit
     *
     * @return \ACBrAPI\Model\DceSefazEndeEmi|null
     */
     ...
     * Sets ender_emit
     *
     * @param \ACBrAPI\Model\DceSefazEndeEmi|null $ender_emit ender_emit
     *
     * @return self
     */
