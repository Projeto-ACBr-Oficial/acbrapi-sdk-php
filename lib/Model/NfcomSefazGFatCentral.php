...
/**
 * NfcomSefazGFatCentral Class Doc Comment
 *
 * @category Class
 ...
 */
class NfcomSefazGFatCentral implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'NfcomSefazGFatCentral';
    ...
    */
     ...
     * Sets cnpj
     *
     * @param string $cnpj CNPJ do Emitente centralizador.  Informar o CNPJ do emitente do Documento Fiscal.
     *
     * @return self
     */
     ...
     * Sets c_uf
     *
     * @param int $c_uf Código da UF do emitente centralizador.  Código da UF do emitente do Documento Fiscal. Utilizar a  Tabela do IBGE de código de unidades da federação.
     *
     * @return self
     */
