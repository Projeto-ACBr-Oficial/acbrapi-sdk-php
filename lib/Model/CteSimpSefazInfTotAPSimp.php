...
/**
 * CteSimpSefazInfTotAPSimp Class Doc Comment
 *
 * @category Class
 ...
 */
class CteSimpSefazInfTotAPSimp implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CteSimpSefazInfTotAPSimp';
    ...
    */
    ...
    public function setQTotProd($q_tot_prod)
    {
        ...
        if (!is_null($q_tot_prod) && ($q_tot_prod < 0)) {
            throw new \InvalidArgumentException('invalid value for $q_tot_prod when calling CteSimpSefazInfTotAPSimp., must be bigger than or equal to 0.');
        }
