...
class CteSimpSefazEmitSimp implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'x_nome' => 'string',
        'x_fant' => 'string',
        'ender_emit' => '\ACBrAPI\Model\CteSimpSefazEndeEmiSimp',
        'crt' => 'int',
        'isuf_emit' => 'string'
    ];
    ...
    */
     ...
     * Sets cpf
     *
     * @param string|null $cpf CPF do emitente.  Informar zeros não significativos.  Usar com série específica 920-969 para emitente pessoa física com inscrição estadual.    ***Obrigatório caso o emitente seja pessoa física***.
     *
     * @return self
     */
     ...
     * Gets ender_emit
     *
     * @return \ACBrAPI\Model\CteSimpSefazEndeEmiSimp|null
     */
     ...
     * Sets ender_emit
     *
     * @param \ACBrAPI\Model\CteSimpSefazEndeEmiSimp|null $ender_emit ender_emit
     *
     * @return self
     */
    ...
    public function setIsufEmit($isuf_emit)
    {
        ...
        if (!is_null($isuf_emit) && (mb_strlen($isuf_emit) > 9)) {
            throw new \InvalidArgumentException('invalid length for $isuf_emit when calling CteSimpSefazEmitSimp., must be smaller than or equal to 9.');
        }
        if (!is_null($isuf_emit) && (mb_strlen($isuf_emit) < 8)) {
            throw new \InvalidArgumentException('invalid length for $isuf_emit when calling CteSimpSefazEmitSimp., must be bigger than or equal to 8.');
        }
