...
/**
 * CteSimpSefazInfNFeSimp Class Doc Comment
 *
 * @category Class
 ...
 */
class CteSimpSefazInfNFeSimp implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CteSimpSefazInfNFeSimp';
    ...
    protected static $openAPITypes = [
        ...
        'inf_unid_transp' => '\ACBrAPI\Model\CteSimpSefazUnidadeTranspSimp[]'
    ];
    ...
    */
     ...
     * Sets ch_nfe
     *
     * @param string $ch_nfe Chave de acesso da NF-e.
     *
     * @return self
     */
    ...
    public function setPin($pin)
    {
        ...
        if (!is_null($pin) && (mb_strlen($pin) > 9)) {
            throw new \InvalidArgumentException('invalid length for $pin when calling CteSimpSefazInfNFeSimp., must be smaller than or equal to 9.');
        }
        if (!is_null($pin) && (mb_strlen($pin) < 2)) {
            throw new \InvalidArgumentException('invalid length for $pin when calling CteSimpSefazInfNFeSimp., must be bigger than or equal to 2.');
        }
     ...
     *
     * @return \ACBrAPI\Model\CteSimpSefazUnidadeTranspSimp[]|null
     */
     ...
     *
     * @param \ACBrAPI\Model\CteSimpSefazUnidadeTranspSimp[]|null $inf_unid_transp inf_unid_transp
     *
     * @return self
     */
