    ...
    */
    ...
    public function setCodPontoEntrada($cod_ponto_entrada)
    {
        ...
        if (!is_null($cod_ponto_entrada) && (mb_strlen($cod_ponto_entrada) > 20)) {
            throw new \InvalidArgumentException('invalid length for $cod_ponto_entrada when calling CteSefazDuto., must be smaller than or equal to 20.');
        }
        if (!is_null($cod_ponto_entrada) && (mb_strlen($cod_ponto_entrada) < 2)) {
            throw new \InvalidArgumentException('invalid length for $cod_ponto_entrada when calling CteSefazDuto., must be bigger than or equal to 2.');
        }
    ...
    public function setCodPontoSaida($cod_ponto_saida)
    {
        ...
        if (!is_null($cod_ponto_saida) && (mb_strlen($cod_ponto_saida) > 20)) {
            throw new \InvalidArgumentException('invalid length for $cod_ponto_saida when calling CteSefazDuto., must be smaller than or equal to 20.');
        }
        if (!is_null($cod_ponto_saida) && (mb_strlen($cod_ponto_saida) < 2)) {
            throw new \InvalidArgumentException('invalid length for $cod_ponto_saida when calling CteSefazDuto., must be bigger than or equal to 2.');
        }
    ...
    public function setNContrato($n_contrato)
    {
        ...
        if (!is_null($n_contrato) && (mb_strlen($n_contrato) > 20)) {
            throw new \InvalidArgumentException('invalid length for $n_contrato when calling CteSefazDuto., must be smaller than or equal to 20.');
        }
        if (!is_null($n_contrato) && (mb_strlen($n_contrato) < 2)) {
            throw new \InvalidArgumentException('invalid length for $n_contrato when calling CteSefazDuto., must be bigger than or equal to 2.');
        }
