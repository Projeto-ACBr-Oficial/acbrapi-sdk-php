...
class NfeSefazICMS90 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['p_red_bc']) && ($this->container['p_red_bc'] < 0)) {
        ...
        if (!is_null($this->container['v_icmsop']) && ($this->container['v_icmsop'] < 0)) {
            $invalidProperties[] = "invalid value for 'v_icmsop', must be bigger than or equal to 0.";
        }
        ...
        if (!is_null($this->container['v_icms_dif']) && ($this->container['v_icms_dif'] < 0)) {
            $invalidProperties[] = "invalid value for 'v_icms_dif', must be bigger than or equal to 0.";
        }
        ...
        if (!is_null($this->container['p_fcp_dif']) && ($this->container['p_fcp_dif'] < 0)) {
            $invalidProperties[] = "invalid value for 'p_fcp_dif', must be bigger than or equal to 0.";
        }

        if (!is_null($this->container['v_fcp_dif']) && ($this->container['v_fcp_dif'] < 0)) {
            $invalidProperties[] = "invalid value for 'v_fcp_dif', must be bigger than or equal to 0.";
        }

        if (!is_null($this->container['v_fcp_efet']) && ($this->container['v_fcp_efet'] < 0)) {
            $invalidProperties[] = "invalid value for 'v_fcp_efet', must be bigger than or equal to 0.";
        }
        ...
        if (!is_null($this->container['v_bcst']) && ($this->container['v_bcst'] < 0)) {
            $invalidProperties[] = "invalid value for 'v_bcst', must be bigger than or equal to 0.";
        }

        if (!is_null($this->container['p_icmsst']) && ($this->container['p_icmsst'] < 0)) {
            $invalidProperties[] = "invalid value for 'p_icmsst', must be bigger than or equal to 0.";
        }

        if (!is_null($this->container['v_icmsst']) && ($this->container['v_icmsst'] < 0)) {
    ...
    public function setVBc($v_bc)
    {
        ...
        if (!is_null($v_bc) && ($v_bc < 0)) {
            throw new \InvalidArgumentException('invalid value for $v_bc when calling NfeSefazICMS90., must be bigger than or equal to 0.');
        }
    ...
    public function setPRedBc($p_red_bc)
    {
        ...
        if (!is_null($p_red_bc) && ($p_red_bc < 0)) {
            throw new \InvalidArgumentException('invalid value for $p_red_bc when calling NfeSefazICMS90., must be bigger than or equal to 0.');
        }
    ...
    public function setPIcms($p_icms)
    {
        ...
        if (!is_null($p_icms) && ($p_icms < 0)) {
            throw new \InvalidArgumentException('invalid value for $p_icms when calling NfeSefazICMS90., must be bigger than or equal to 0.');
        }
    ...
    public function setVIcmsop($v_icmsop)
    {
        ...
        if (!is_null($v_icmsop) && ($v_icmsop < 0)) {
            throw new \InvalidArgumentException('invalid value for $v_icmsop when calling NfeSefazICMS90., must be bigger than or equal to 0.');
        }
    ...
    public function setPDif($p_dif)
    {
        ...
        if (!is_null($p_dif) && ($p_dif > 1E+2)) {
            throw new \InvalidArgumentException('invalid value for $p_dif when calling NfeSefazICMS90., must be smaller than or equal to 1E+2.');
        }
        if (!is_null($p_dif) && ($p_dif < 0)) {
            throw new \InvalidArgumentException('invalid value for $p_dif when calling NfeSefazICMS90., must be bigger than or equal to 0.');
        }
    ...
    public function setVIcmsDif($v_icms_dif)
    {
        ...
        if (!is_null($v_icms_dif) && ($v_icms_dif < 0)) {
            throw new \InvalidArgumentException('invalid value for $v_icms_dif when calling NfeSefazICMS90., must be bigger than or equal to 0.');
        }
    ...
    public function setVIcms($v_icms)
    {
        ...
        if (!is_null($v_icms) && ($v_icms < 0)) {
            throw new \InvalidArgumentException('invalid value for $v_icms when calling NfeSefazICMS90., must be bigger than or equal to 0.');
        }
    ...
    public function setVBcfcp($v_bcfcp)
    {
        ...
        if (!is_null($v_bcfcp) && ($v_bcfcp < 0)) {
            throw new \InvalidArgumentException('invalid value for $v_bcfcp when calling NfeSefazICMS90., must be bigger than or equal to 0.');
        }
    ...
    public function setPFcp($p_fcp)
    {
        ...
        if (!is_null($p_fcp) && ($p_fcp < 0)) {
            throw new \InvalidArgumentException('invalid value for $p_fcp when calling NfeSefazICMS90., must be bigger than or equal to 0.');
        }
    ...
    public function setVFcp($v_fcp)
    {
        ...
        if (!is_null($v_fcp) && ($v_fcp < 0)) {
            throw new \InvalidArgumentException('invalid value for $v_fcp when calling NfeSefazICMS90., must be bigger than or equal to 0.');
        }
    ...
    public function setPFcpDif($p_fcp_dif)
    {
        ...
        if (!is_null($p_fcp_dif) && ($p_fcp_dif < 0)) {
            throw new \InvalidArgumentException('invalid value for $p_fcp_dif when calling NfeSefazICMS90., must be bigger than or equal to 0.');
        }
    ...
    public function setVFcpDif($v_fcp_dif)
    {
        ...
        if (!is_null($v_fcp_dif) && ($v_fcp_dif < 0)) {
            throw new \InvalidArgumentException('invalid value for $v_fcp_dif when calling NfeSefazICMS90., must be bigger than or equal to 0.');
        }
    ...
    public function setVFcpEfet($v_fcp_efet)
    {
        ...
        if (!is_null($v_fcp_efet) && ($v_fcp_efet < 0)) {
            throw new \InvalidArgumentException('invalid value for $v_fcp_efet when calling NfeSefazICMS90., must be bigger than or equal to 0.');
        }
    ...
    public function setPMvast($p_mvast)
    {
        ...
        if (!is_null($p_mvast) && ($p_mvast < 0)) {
            throw new \InvalidArgumentException('invalid value for $p_mvast when calling NfeSefazICMS90., must be bigger than or equal to 0.');
        }
    ...
    public function setPRedBcst($p_red_bcst)
    {
        ...
        if (!is_null($p_red_bcst) && ($p_red_bcst < 0)) {
            throw new \InvalidArgumentException('invalid value for $p_red_bcst when calling NfeSefazICMS90., must be bigger than or equal to 0.');
        }
    ...
    public function setVBcst($v_bcst)
    {
        ...
        if (!is_null($v_bcst) && ($v_bcst < 0)) {
            throw new \InvalidArgumentException('invalid value for $v_bcst when calling NfeSefazICMS90., must be bigger than or equal to 0.');
        }
    ...
    public function setPIcmsst($p_icmsst)
    {
        ...
        if (!is_null($p_icmsst) && ($p_icmsst < 0)) {
            throw new \InvalidArgumentException('invalid value for $p_icmsst when calling NfeSefazICMS90., must be bigger than or equal to 0.');
        }
    ...
    public function setVIcmsst($v_icmsst)
    {
        ...
        if (!is_null($v_icmsst) && ($v_icmsst < 0)) {
            throw new \InvalidArgumentException('invalid value for $v_icmsst when calling NfeSefazICMS90., must be bigger than or equal to 0.');
        }
    ...
    public function setVBcfcpst($v_bcfcpst)
    {
        ...
        if (!is_null($v_bcfcpst) && ($v_bcfcpst < 0)) {
            throw new \InvalidArgumentException('invalid value for $v_bcfcpst when calling NfeSefazICMS90., must be bigger than or equal to 0.');
        }
    ...
    public function setPFcpst($p_fcpst)
    {
        ...
        if (!is_null($p_fcpst) && ($p_fcpst < 0)) {
            throw new \InvalidArgumentException('invalid value for $p_fcpst when calling NfeSefazICMS90., must be bigger than or equal to 0.');
        }
    ...
    public function setVFcpst($v_fcpst)
    {
        ...
        if (!is_null($v_fcpst) && ($v_fcpst < 0)) {
            throw new \InvalidArgumentException('invalid value for $v_fcpst when calling NfeSefazICMS90., must be bigger than or equal to 0.');
        }
    ...
    public function setVIcmsDeson($v_icms_deson)
    {
        ...
        if (!is_null($v_icms_deson) && ($v_icms_deson < 0)) {
            throw new \InvalidArgumentException('invalid value for $v_icms_deson when calling NfeSefazICMS90., must be bigger than or equal to 0.');
        }
    ...
    public function setVIcmsstDeson($v_icmsst_deson)
    {
        ...
        if (!is_null($v_icmsst_deson) && ($v_icmsst_deson < 0)) {
            throw new \InvalidArgumentException('invalid value for $v_icmsst_deson when calling NfeSefazICMS90., must be bigger than or equal to 0.');
        }
