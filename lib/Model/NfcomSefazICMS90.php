...
/**
 * NfcomSefazICMS90 Class Doc Comment
 *
 * @category Class
 ...
 */
class NfcomSefazICMS90 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'NfcomSefazICMS90';
    ...
    */
    ...
    public function setVBc($v_bc)
    {
        ...
        if (!is_null($v_bc) && ($v_bc < 0)) {
            throw new \InvalidArgumentException('invalid value for $v_bc when calling NfcomSefazICMS90., must be bigger than or equal to 0.');
        }
    ...
    public function setPIcms($p_icms)
    {
        ...
        if (!is_null($p_icms) && ($p_icms < 0)) {
            throw new \InvalidArgumentException('invalid value for $p_icms when calling NfcomSefazICMS90., must be bigger than or equal to 0.');
        }
    ...
    public function setVIcms($v_icms)
    {
        ...
        if (!is_null($v_icms) && ($v_icms < 0)) {
            throw new \InvalidArgumentException('invalid value for $v_icms when calling NfcomSefazICMS90., must be bigger than or equal to 0.');
        }
    ...
    public function setVIcmsDeson($v_icms_deson)
    {
        ...
        if (!is_null($v_icms_deson) && ($v_icms_deson < 0)) {
            throw new \InvalidArgumentException('invalid value for $v_icms_deson when calling NfcomSefazICMS90., must be bigger than or equal to 0.');
        }
    ...
    public function setCBenef($c_benef)
    {
        ...
        if (!is_null($c_benef) && (mb_strlen($c_benef) > 10)) {
            throw new \InvalidArgumentException('invalid length for $c_benef when calling NfcomSefazICMS90., must be smaller than or equal to 10.');
        }
    ...
    public function setPFcp($p_fcp)
    {
        ...
        if (!is_null($p_fcp) && ($p_fcp < 0)) {
            throw new \InvalidArgumentException('invalid value for $p_fcp when calling NfcomSefazICMS90., must be bigger than or equal to 0.');
        }
    ...
    public function setVFcp($v_fcp)
    {
        ...
        if (!is_null($v_fcp) && ($v_fcp < 0)) {
            throw new \InvalidArgumentException('invalid value for $v_fcp when calling NfcomSefazICMS90., must be bigger than or equal to 0.');
        }
