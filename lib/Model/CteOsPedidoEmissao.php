...
/**
 * CteOsPedidoEmissao Class Doc Comment
 *
 * @category Class
 * @package  ACBrAPI
 * @author   OpenAPI Generator team
 ...
 */
class CteOsPedidoEmissao implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CteOsPedidoEmissao';
    ...
    protected static $openAPITypes = [
        'inf_cte' => '\ACBrAPI\Model\CteOsSefazInfCteOS',
        'inf_cte_supl' => '\ACBrAPI\Model\CteOsSefazInfCTeSuplOS',
        'ambiente' => 'string',
        'referencia' => 'string'
    ];
    ...
    */
     ...
     * Gets inf_cte
     *
     * @return \ACBrAPI\Model\CteOsSefazInfCteOS
     */
     ...
     * Sets inf_cte
     *
     * @param \ACBrAPI\Model\CteOsSefazInfCteOS $inf_cte inf_cte
     *
     * @return self
     */
     ...
     * Gets inf_cte_supl
     *
     * @return \ACBrAPI\Model\CteOsSefazInfCTeSuplOS|null
     */
     ...
     * Sets inf_cte_supl
     *
     * @param \ACBrAPI\Model\CteOsSefazInfCTeSuplOS|null $inf_cte_supl inf_cte_supl
     *
     * @return self
     */
    ...
    public function setReferencia($referencia)
    {
        ...
        if (!is_null($referencia) && (mb_strlen($referencia) > 50)) {
            throw new \InvalidArgumentException('invalid length for $referencia when calling CteOsPedidoEmissao., must be smaller than or equal to 50.');
        }
