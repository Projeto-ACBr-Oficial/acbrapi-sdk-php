...
/**
 * CteOsSefazRespTecOS Class Doc Comment
 *
 * @category Class
 ...
 */
class CteOsSefazRespTecOS implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CteOsSefazRespTecOS';
    ...
    */
    ...
    public function setXContato($x_contato)
    {
        ...
        if (!is_null($x_contato) && (mb_strlen($x_contato) > 60)) {
            throw new \InvalidArgumentException('invalid length for $x_contato when calling CteOsSefazRespTecOS., must be smaller than or equal to 60.');
        }
        if (!is_null($x_contato) && (mb_strlen($x_contato) < 2)) {
            throw new \InvalidArgumentException('invalid length for $x_contato when calling CteOsSefazRespTecOS., must be bigger than or equal to 2.');
        }
    ...
    public function setEmail($email)
    {
        ...
        if (!is_null($email) && (mb_strlen($email) > 60)) {
            throw new \InvalidArgumentException('invalid length for $email when calling CteOsSefazRespTecOS., must be smaller than or equal to 60.');
        }
        if (!is_null($email) && (mb_strlen($email) < 1)) {
            throw new \InvalidArgumentException('invalid length for $email when calling CteOsSefazRespTecOS., must be bigger than or equal to 1.');
        }
    ...
    public function setIdCsrt($id_csrt)
    {
        ...
        if (!is_null($id_csrt) && ($id_csrt > 999)) {
            throw new \InvalidArgumentException('invalid value for $id_csrt when calling CteOsSefazRespTecOS., must be smaller than or equal to 999.');
        }
        if (!is_null($id_csrt) && ($id_csrt < 0)) {
            throw new \InvalidArgumentException('invalid value for $id_csrt when calling CteOsSefazRespTecOS., must be bigger than or equal to 0.');
        }
    ...
    public function setHashCsrt($hash_csrt)
    {
        ...
        if (!is_null($hash_csrt) && (mb_strlen($hash_csrt) > 28)) {
            throw new \InvalidArgumentException('invalid length for $hash_csrt when calling CteOsSefazRespTecOS., must be smaller than or equal to 28.');
        }
