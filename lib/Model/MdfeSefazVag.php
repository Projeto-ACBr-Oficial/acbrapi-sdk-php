...
class MdfeSefazVag implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (($this->container['tu'] < 0)) {
            $invalidProperties[] = "invalid value for 'tu', must be bigger than or equal to 0.";
        }
    ...
    public function setTu($tu)
    {
        ...
        if (!is_null($tu) && ($tu < 0)) {
            throw new \InvalidArgumentException('invalid value for $tu when calling MdfeSefazVag., must be bigger than or equal to 0.');
        }
