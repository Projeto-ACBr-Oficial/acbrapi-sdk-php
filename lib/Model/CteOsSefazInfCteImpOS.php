...
/**
 * CteOsSefazInfCteImpOS Class Doc Comment
 *
 * @category Class
 ...
 */
class CteOsSefazInfCteImpOS implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CteOsSefazInfCte_ImpOS';
    ...
    protected static $openAPITypes = [
        'icms' => '\ACBrAPI\Model\CteOsSefazImpOS',
        'v_tot_trib' => 'float',
        'inf_ad_fisco' => 'string',
        'icmsuf_fim' => '\ACBrAPI\Model\CteOsSefazICMSUFFimOS',
        'inf_trib_fed' => '\ACBrAPI\Model\CteOsSefazInfTribFedOS',
        'ibscbs' => '\ACBrAPI\Model\CteOsSefazTribCTeOS',
        'v_tot_dfe' => 'float'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('inf_trib_fed', $data ?? [], null);
    ...
    */
     ...
     * Gets icms
     *
     * @return \ACBrAPI\Model\CteOsSefazImpOS
     */
     ...
     * Sets icms
     *
     * @param \ACBrAPI\Model\CteOsSefazImpOS $icms icms
     *
     * @return self
     */
    ...
    public function setVTotTrib($v_tot_trib)
    {
        ...
        if (!is_null($v_tot_trib) && ($v_tot_trib < 0)) {
            throw new \InvalidArgumentException('invalid value for $v_tot_trib when calling CteOsSefazInfCteImpOS., must be bigger than or equal to 0.');
        }
    ...
    public function setInfAdFisco($inf_ad_fisco)
    {
        ...
        if (!is_null($inf_ad_fisco) && (mb_strlen($inf_ad_fisco) > 2000)) {
            throw new \InvalidArgumentException('invalid length for $inf_ad_fisco when calling CteOsSefazInfCteImpOS., must be smaller than or equal to 2000.');
        }
        if (!is_null($inf_ad_fisco) && (mb_strlen($inf_ad_fisco) < 1)) {
            throw new \InvalidArgumentException('invalid length for $inf_ad_fisco when calling CteOsSefazInfCteImpOS., must be bigger than or equal to 1.');
        }
     ...
     * Gets icmsuf_fim
     *
     * @return \ACBrAPI\Model\CteOsSefazICMSUFFimOS|null
     */
     ...
     * Sets icmsuf_fim
     *
     * @param \ACBrAPI\Model\CteOsSefazICMSUFFimOS|null $icmsuf_fim icmsuf_fim
     *
     * @return self
     */
     ...
     * Gets inf_trib_fed
     *
     * @return \ACBrAPI\Model\CteOsSefazInfTribFedOS|null
     */
    public function getInfTribFed()
    {
        return $this->container['inf_trib_fed'];
    }

    /**
     * Sets inf_trib_fed
     *
     * @param \ACBrAPI\Model\CteOsSefazInfTribFedOS|null $inf_trib_fed inf_trib_fed
     *
     * @return self
     */
    public function setInfTribFed($inf_trib_fed)
    {
        if (is_null($inf_trib_fed)) {
            throw new \InvalidArgumentException('non-nullable inf_trib_fed cannot be null');
        }
        $this->container['inf_trib_fed'] = $inf_trib_fed;
     ...
     * Gets ibscbs
     *
     * @return \ACBrAPI\Model\CteOsSefazTribCTeOS|null
     */
     ...
     * Sets ibscbs
     *
     * @param \ACBrAPI\Model\CteOsSefazTribCTeOS|null $ibscbs ibscbs
     *
     * @return self
     */
    ...
    public function setVTotDfe($v_tot_dfe)
    {
        ...
        if (!is_null($v_tot_dfe) && ($v_tot_dfe < 0)) {
            throw new \InvalidArgumentException('invalid value for $v_tot_dfe when calling CteOsSefazInfCteImpOS., must be bigger than or equal to 0.');
        }
