...
/**
 * CteOsSefazInfCTeSuplOS Class Doc Comment
 *
 * @category Class
 ...
 */
class CteOsSefazInfCTeSuplOS implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CteOsSefazInfCTeSuplOS';
    ...
    */
    ...
    public function setQrCodCte($qr_cod_cte)
    {
        ...
        if (!is_null($qr_cod_cte) && (mb_strlen($qr_cod_cte) > 1000)) {
            throw new \InvalidArgumentException('invalid length for $qr_cod_cte when calling CteOsSefazInfCTeSuplOS., must be smaller than or equal to 1000.');
        }
        if (!is_null($qr_cod_cte) && (mb_strlen($qr_cod_cte) < 50)) {
            throw new \InvalidArgumentException('invalid length for $qr_cod_cte when calling CteOsSefazInfCTeSuplOS., must be bigger than or equal to 50.');
        }
