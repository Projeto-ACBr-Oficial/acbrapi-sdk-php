...
/**
 * CteSimpSefazTomaSimp Class Doc Comment
 *
 * @category Class
 ...
 */
class CteSimpSefazTomaSimp implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CteSimpSefazTomaSimp';
    ...
    protected static $openAPITypes = [
        ...
        'isuf' => 'string',
        'fone' => 'string',
        'ender_toma' => '\ACBrAPI\Model\CteSimpSefazEnderecoSimp',
        'email' => 'string'
    ];
    ...
    */
     ...
     * Sets toma
     *
     * @param int $toma Tomador do Serviço.  Preencher com:  * 0 - Remetente  * 1 - Expedidor  * 2 - Recebedor  * 3 - Destinatário  * 4 - Terceiro
     *
     * @return self
     */
     ...
     * Sets ind_ie_toma
     *
     * @param int $ind_ie_toma Indicador do papel do tomador na prestação do serviço:  * 1 - Contribuinte ICMS  * 2 - Contribuinte isento de inscrição  * 9 - Não Contribuinte  Aplica-se ao tomador que for indicado no toma.
     *
     * @return self
     */
    ...
    public function setXNome($x_nome)
    {
        ...
        if (!is_null($x_nome) && (mb_strlen($x_nome) > 60)) {
            throw new \InvalidArgumentException('invalid length for $x_nome when calling CteSimpSefazTomaSimp., must be smaller than or equal to 60.');
        }
        if (!is_null($x_nome) && (mb_strlen($x_nome) < 2)) {
            throw new \InvalidArgumentException('invalid length for $x_nome when calling CteSimpSefazTomaSimp., must be bigger than or equal to 2.');
        }
     ...
     * Gets ender_toma
     *
     * @return \ACBrAPI\Model\CteSimpSefazEnderecoSimp
     */
     ...
     * Sets ender_toma
     *
     * @param \ACBrAPI\Model\CteSimpSefazEnderecoSimp $ender_toma ender_toma
     *
     * @return self
     */
    ...
    public function setEmail($email)
    {
        ...
        if (!is_null($email) && (mb_strlen($email) > 60)) {
            throw new \InvalidArgumentException('invalid length for $email when calling CteSimpSefazTomaSimp., must be smaller than or equal to 60.');
        }
        if (!is_null($email) && (mb_strlen($email) < 1)) {
            throw new \InvalidArgumentException('invalid length for $email when calling CteSimpSefazTomaSimp., must be bigger than or equal to 1.');
        }
