...
/**
 * CteSimpSefazInfSolicNFFSimp Class Doc Comment
 *
 * @category Class
 ...
 */
class CteSimpSefazInfSolicNFFSimp implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CteSimpSefazInfSolicNFFSimp';
    ...
    */
    ...
    public function setXSolic($x_solic)
    {
        ...
        if (!is_null($x_solic) && (mb_strlen($x_solic) > 8000)) {
            throw new \InvalidArgumentException('invalid length for $x_solic when calling CteSimpSefazInfSolicNFFSimp., must be smaller than or equal to 8000.');
        }
        if (!is_null($x_solic) && (mb_strlen($x_solic) < 2)) {
            throw new \InvalidArgumentException('invalid length for $x_solic when calling CteSimpSefazInfSolicNFFSimp., must be bigger than or equal to 2.');
        }
