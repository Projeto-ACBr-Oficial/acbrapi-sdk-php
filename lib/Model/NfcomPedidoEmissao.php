...
/**
 * NfcomPedidoEmissao Class Doc Comment
 *
 * @category Class
 * @package  ACBrAPI
 * @author   OpenAPI Generator team
 ...
 */
class NfcomPedidoEmissao implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'NfcomPedidoEmissao';
    ...
    protected static $openAPITypes = [
        'inf_nf_com' => '\ACBrAPI\Model\NfcomSefazInfNFCom',
        'ambiente' => 'string',
        'referencia' => 'string'
    ];
    ...
    {
        $this->setIfExists('inf_nf_com', $data ?? [], null);
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['inf_nf_com'] === null) {
            $invalidProperties[] = "'inf_nf_com' can't be null";
        }
     ...
     * Gets inf_nf_com
     *
     * @return \ACBrAPI\Model\NfcomSefazInfNFCom
     */
    public function getInfNfCom()
    {
        return $this->container['inf_nf_com'];
    }

    /**
     * Sets inf_nf_com
     *
     * @param \ACBrAPI\Model\NfcomSefazInfNFCom $inf_nf_com inf_nf_com
     *
     * @return self
     */
    public function setInfNfCom($inf_nf_com)
    {
        if (is_null($inf_nf_com)) {
            throw new \InvalidArgumentException('non-nullable inf_nf_com cannot be null');
        }
        $this->container['inf_nf_com'] = $inf_nf_com;
    ...
    public function setReferencia($referencia)
    {
        ...
        if (!is_null($referencia) && (mb_strlen($referencia) > 50)) {
            throw new \InvalidArgumentException('invalid length for $referencia when calling NfcomPedidoEmissao., must be smaller than or equal to 50.');
        }
