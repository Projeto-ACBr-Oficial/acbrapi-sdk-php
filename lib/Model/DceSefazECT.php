 ...
 */
class DceSefazECT implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'DceSefazECT';
    ...
    */
     ...
     * Sets cnpj
     *
     * @param string $cnpj Número do CNPJ dos correios.
     *
     * @return self
     */
     ...
     * Sets x_nome
     *
     * @param string $x_nome Razão Social ou Nome dos correios.
     *
     * @return self
     */
    public function setXNome($x_nome)
    {
        ...
        if (!is_null($x_nome) && (mb_strlen($x_nome) > 60)) {
            throw new \InvalidArgumentException('invalid length for $x_nome when calling DceSefazECT., must be smaller than or equal to 60.');
        }
        if (!is_null($x_nome) && (mb_strlen($x_nome) < 2)) {
            throw new \InvalidArgumentException('invalid length for $x_nome when calling DceSefazECT., must be bigger than or equal to 2.');
        }
