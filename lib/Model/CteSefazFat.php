    ...
    */
    ...
    public function setVOrig($v_orig)
    {
        ...
        if (!is_null($v_orig) && ($v_orig <= 0)) {
            throw new \InvalidArgumentException('invalid value for $v_orig when calling CteSefazFat., must be bigger than 0.');
        }
    ...
    public function setVDesc($v_desc)
    {
        ...
        if (!is_null($v_desc) && ($v_desc <= 0)) {
            throw new \InvalidArgumentException('invalid value for $v_desc when calling CteSefazFat., must be bigger than 0.');
        }
    ...
    public function setVLiq($v_liq)
    {
        ...
        if (!is_null($v_liq) && ($v_liq <= 0)) {
            throw new \InvalidArgumentException('invalid value for $v_liq when calling CteSefazFat., must be bigger than 0.');
        }
