...
class TribMunicipal implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'tp_imunidade' => 'int',
        'exig_susp' => '\ACBrAPI\Model\ExigSuspensa',
        'bm' => '\ACBrAPI\Model\BeneficioMunicipal',
        'tp_ret_issqn' => 'int',
        'p_aliq' => 'float',
        'c_loc_incid' => 'string',
        'v_bc' => 'float',
    ...
    */
     ...
     * Gets exig_susp
     *
     * @return \ACBrAPI\Model\ExigSuspensa|null
     */
     ...
     * Sets exig_susp
     *
     * @param \ACBrAPI\Model\ExigSuspensa|null $exig_susp exig_susp
     *
     * @return self
     */
     ...
     * Gets bm
     *
     * @return \ACBrAPI\Model\BeneficioMunicipal|null
     */
     ...
     * Sets bm
     *
     * @param \ACBrAPI\Model\BeneficioMunicipal|null $bm bm
     *
     * @return self
     */
     ...
     * Sets c_loc_incid
     *
     * @param string|null $c_loc_incid Código do município de incidência do ISSQN (tabela do IBGE).    Caso o envio seja pelo Sistema Nacional NFS-e, essa propriedade - ignorada e o município de incidência do ISSQN - determinado automaticamente pela SEFIN nacional, conforme regras do aspecto espacial da lei complementar federal (LC 116/03) que são válidas para todos os municípios.
     *
     * @return self
     */
