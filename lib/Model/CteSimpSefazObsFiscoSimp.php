...
/**
 * CteSimpSefazObsFiscoSimp Class Doc Comment
 *
 * @category Class
 ...
 */
class CteSimpSefazObsFiscoSimp implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CteSimpSefazObsFiscoSimp';
    ...
    */
    ...
    public function setXCampo($x_campo)
    {
        ...
        if (!is_null($x_campo) && (mb_strlen($x_campo) > 20)) {
            throw new \InvalidArgumentException('invalid length for $x_campo when calling CteSimpSefazObsFiscoSimp., must be smaller than or equal to 20.');
        }
        if (!is_null($x_campo) && (mb_strlen($x_campo) < 1)) {
            throw new \InvalidArgumentException('invalid length for $x_campo when calling CteSimpSefazObsFiscoSimp., must be bigger than or equal to 1.');
        }
    ...
    public function setXTexto($x_texto)
    {
        ...
        if (!is_null($x_texto) && (mb_strlen($x_texto) > 60)) {
            throw new \InvalidArgumentException('invalid length for $x_texto when calling CteSimpSefazObsFiscoSimp., must be smaller than or equal to 60.');
        }
        if (!is_null($x_texto) && (mb_strlen($x_texto) < 1)) {
            throw new \InvalidArgumentException('invalid length for $x_texto when calling CteSimpSefazObsFiscoSimp., must be bigger than or equal to 1.');
        }
