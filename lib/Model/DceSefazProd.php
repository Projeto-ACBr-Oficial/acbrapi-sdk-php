    ...
    */
    ...
    public function setVUnCom($v_un_com)
    {
        ...
        if (!is_null($v_un_com) && ($v_un_com < 0)) {
            throw new \InvalidArgumentException('invalid value for $v_un_com when calling DceSefazProd., must be bigger than or equal to 0.');
        }
    ...
    public function setVProd($v_prod)
    {
        ...
        if (!is_null($v_prod) && ($v_prod < 0)) {
            throw new \InvalidArgumentException('invalid value for $v_prod when calling DceSefazProd., must be bigger than or equal to 0.');
        }
