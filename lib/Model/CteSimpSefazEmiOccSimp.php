...
/**
 * CteSimpSefazEmiOccSimp Class Doc Comment
 *
 * @category Class
 * @package  ACBrAPI
 * @author   OpenAPI Generator team
 ...
 */
class CteSimpSefazEmiOccSimp implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CteSimpSefazEmiOccSimp';
    ...
    */
    ...
    public function setCInt($c_int)
    {
        ...
        if (!is_null($c_int) && (mb_strlen($c_int) > 10)) {
            throw new \InvalidArgumentException('invalid length for $c_int when calling CteSimpSefazEmiOccSimp., must be smaller than or equal to 10.');
        }
        if (!is_null($c_int) && (mb_strlen($c_int) < 1)) {
            throw new \InvalidArgumentException('invalid length for $c_int when calling CteSimpSefazEmiOccSimp., must be bigger than or equal to 1.');
        }
    ...
    public function setIe($ie)
    {
        ...
        if (!is_null($ie) && (mb_strlen($ie) > 14)) {
            throw new \InvalidArgumentException('invalid length for $ie when calling CteSimpSefazEmiOccSimp., must be smaller than or equal to 14.');
        }
