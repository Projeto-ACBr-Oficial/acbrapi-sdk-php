...
/**
 * CteSimpSefazAereoSimp Class Doc Comment
 *
 * @category Class
 ...
 */
class CteSimpSefazAereoSimp implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CteSimpSefazAereoSimp';
    ...
    protected static $openAPITypes = [
        ...
        'nat_carga' => '\ACBrAPI\Model\CteSimpSefazNatCargaSimp',
        'tarifa' => '\ACBrAPI\Model\CteSimpSefazTarifaSimp',
        'peri' => '\ACBrAPI\Model\CteSimpSefazPeriSimp[]'
    ];
    ...
    */
    ...
    public function setNMinu($n_minu)
    {
        ...
        if (!is_null($n_minu) && ($n_minu > 999999999)) {
            throw new \InvalidArgumentException('invalid value for $n_minu when calling CteSimpSefazAereoSimp., must be smaller than or equal to 999999999.');
        }
        if (!is_null($n_minu) && ($n_minu < 0)) {
            throw new \InvalidArgumentException('invalid value for $n_minu when calling CteSimpSefazAereoSimp., must be bigger than or equal to 0.');
        }
     ...
     * Gets nat_carga
     *
     * @return \ACBrAPI\Model\CteSimpSefazNatCargaSimp
     */
     ...
     * Sets nat_carga
     *
     * @param \ACBrAPI\Model\CteSimpSefazNatCargaSimp $nat_carga nat_carga
     *
     * @return self
     */
     ...
     * Gets tarifa
     *
     * @return \ACBrAPI\Model\CteSimpSefazTarifaSimp
     */
     ...
     * Sets tarifa
     *
     * @param \ACBrAPI\Model\CteSimpSefazTarifaSimp $tarifa tarifa
     *
     * @return self
     */
     ...
     * Gets peri
     *
     * @return \ACBrAPI\Model\CteSimpSefazPeriSimp[]|null
     */
     ...
     * Sets peri
     *
     * @param \ACBrAPI\Model\CteSimpSefazPeriSimp[]|null $peri peri
     *
     * @return self
     */
