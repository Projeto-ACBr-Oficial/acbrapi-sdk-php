...
class ComExterior implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets vinc_prest
     *
     * @param int $vinc_prest Vínculo entre as partes no negócio:  * 0 - Sem vínculo com o Tomador/Prestador  * 1 - Controlada  * 2 - Controladora  * 3 - Coligada  * 4 - Matriz  * 5 - Filial ou sucursal  * 6 - Outro vínculo  * 9 - Desconhecido (tipo não informado na nota de origem)
     *
     * @return self
     */
