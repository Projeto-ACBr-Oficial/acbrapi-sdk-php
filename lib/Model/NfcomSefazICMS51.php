...
/**
 * NfcomSefazICMS51 Class Doc Comment
 *
 * @category Class
 * @description Tributação com Diferimento.  A exigência do preenchimento das informações do ICMS diferido fica a critério de cada UF.
 * @package  ACBrAPI
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class NfcomSefazICMS51 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'NfcomSefazICMS51';
    ...
    */
     ...
     * Sets cst
     *
     * @param string $cst Classificação Tributária do serviço.  Tributação pelo ICMS 51 - Diferimento.
     *
     * @return self
     */
    ...
    public function setVIcmsDeson($v_icms_deson)
    {
        ...
        if (!is_null($v_icms_deson) && ($v_icms_deson < 0)) {
            throw new \InvalidArgumentException('invalid value for $v_icms_deson when calling NfcomSefazICMS51., must be bigger than or equal to 0.');
        }
    ...
    public function setCBenef($c_benef)
    {
        ...
        if (!is_null($c_benef) && (mb_strlen($c_benef) > 10)) {
            throw new \InvalidArgumentException('invalid length for $c_benef when calling NfcomSefazICMS51., must be smaller than or equal to 10.');
        }
