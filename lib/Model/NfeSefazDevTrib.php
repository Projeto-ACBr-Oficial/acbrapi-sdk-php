...
/**
 * NfeSefazDevTrib Class Doc Comment
 *
 * @category Class
 ...
 */
class NfeSefazDevTrib implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'NfeSefazDevTrib';
    ...
    */
    ...
    public function setVDevTrib($v_dev_trib)
    {
        ...
        if (!is_null($v_dev_trib) && ($v_dev_trib < 0)) {
            throw new \InvalidArgumentException('invalid value for $v_dev_trib when calling NfeSefazDevTrib., must be bigger than or equal to 0.');
        }
