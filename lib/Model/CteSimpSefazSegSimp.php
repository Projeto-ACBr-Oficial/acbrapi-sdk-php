...
/**
 * CteSimpSefazSegSimp Class Doc Comment
 *
 * @category Class
 ...
 */
class CteSimpSefazSegSimp implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CteSimpSefazSegSimp';
    ...
    protected static $openAPITypes = [
        'inf_seg' => '\ACBrAPI\Model\CteSimpSefazInfSegSimp',
        'n_apol' => 'string',
        'n_aver' => 'string'
    ];
    ...
    */
     ...
     * Gets inf_seg
     *
     * @return \ACBrAPI\Model\CteSimpSefazInfSegSimp
     */
     ...
     * Sets inf_seg
     *
     * @param \ACBrAPI\Model\CteSimpSefazInfSegSimp $inf_seg inf_seg
     *
     * @return self
     */
    ...
    public function setNApol($n_apol)
    {
        ...
        if (!is_null($n_apol) && (mb_strlen($n_apol) > 20)) {
            throw new \InvalidArgumentException('invalid length for $n_apol when calling CteSimpSefazSegSimp., must be smaller than or equal to 20.');
        }
        if (!is_null($n_apol) && (mb_strlen($n_apol) < 1)) {
            throw new \InvalidArgumentException('invalid length for $n_apol when calling CteSimpSefazSegSimp., must be bigger than or equal to 1.');
        }
    ...
    public function setNAver($n_aver)
    {
        ...
        if (!is_null($n_aver) && (mb_strlen($n_aver) > 20)) {
            throw new \InvalidArgumentException('invalid length for $n_aver when calling CteSimpSefazSegSimp., must be smaller than or equal to 20.');
        }
        if (!is_null($n_aver) && (mb_strlen($n_aver) < 1)) {
            throw new \InvalidArgumentException('invalid length for $n_aver when calling CteSimpSefazSegSimp., must be bigger than or equal to 1.');
        }
