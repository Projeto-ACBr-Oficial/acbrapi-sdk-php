...
/**
 * CteSimpSefazICMSOutraUFSimp Class Doc Comment
 *
 * @category Class
 ...
 */
class CteSimpSefazICMSOutraUFSimp implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CteSimpSefazICMSOutraUFSimp';
    ...
    */
    ...
    public function setPRedBcOutraUf($p_red_bc_outra_uf)
    {
        ...
        if (!is_null($p_red_bc_outra_uf) && ($p_red_bc_outra_uf <= 0)) {
            throw new \InvalidArgumentException('invalid value for $p_red_bc_outra_uf when calling CteSimpSefazICMSOutraUFSimp., must be bigger than 0.');
        }
    ...
    public function setVBcOutraUf($v_bc_outra_uf)
    {
        ...
        if (!is_null($v_bc_outra_uf) && ($v_bc_outra_uf < 0)) {
            throw new \InvalidArgumentException('invalid value for $v_bc_outra_uf when calling CteSimpSefazICMSOutraUFSimp., must be bigger than or equal to 0.');
        }
    ...
    public function setPIcmsOutraUf($p_icms_outra_uf)
    {
        ...
        if (!is_null($p_icms_outra_uf) && ($p_icms_outra_uf < 0)) {
            throw new \InvalidArgumentException('invalid value for $p_icms_outra_uf when calling CteSimpSefazICMSOutraUFSimp., must be bigger than or equal to 0.');
        }
    ...
    public function setVIcmsOutraUf($v_icms_outra_uf)
    {
        ...
        if (!is_null($v_icms_outra_uf) && ($v_icms_outra_uf < 0)) {
            throw new \InvalidArgumentException('invalid value for $v_icms_outra_uf when calling CteSimpSefazICMSOutraUFSimp., must be bigger than or equal to 0.');
        }
    ...
    public function setVIcmsDeson($v_icms_deson)
    {
        ...
        if (!is_null($v_icms_deson) && ($v_icms_deson < 0)) {
            throw new \InvalidArgumentException('invalid value for $v_icms_deson when calling CteSimpSefazICMSOutraUFSimp., must be bigger than or equal to 0.');
        }
    ...
    public function setCBenef($c_benef)
    {
        ...
        if (!is_null($c_benef) && (mb_strlen($c_benef) > 10)) {
            throw new \InvalidArgumentException('invalid length for $c_benef when calling CteSimpSefazICMSOutraUFSimp., must be smaller than or equal to 10.');
        }
