...
/**
 * CteSimpSefazICMS60Simp Class Doc Comment
 *
 * @category Class
 ...
 */
class CteSimpSefazICMS60Simp implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CteSimpSefazICMS60Simp';
    ...
    */
    ...
    public function setVBcstRet($v_bcst_ret)
    {
        ...
        if (!is_null($v_bcst_ret) && ($v_bcst_ret < 0)) {
            throw new \InvalidArgumentException('invalid value for $v_bcst_ret when calling CteSimpSefazICMS60Simp., must be bigger than or equal to 0.');
        }
    ...
    public function setVIcmsstRet($v_icmsst_ret)
    {
        ...
        if (!is_null($v_icmsst_ret) && ($v_icmsst_ret < 0)) {
            throw new \InvalidArgumentException('invalid value for $v_icmsst_ret when calling CteSimpSefazICMS60Simp., must be bigger than or equal to 0.');
        }
    ...
    public function setPIcmsstRet($p_icmsst_ret)
    {
        ...
        if (!is_null($p_icmsst_ret) && ($p_icmsst_ret < 0)) {
            throw new \InvalidArgumentException('invalid value for $p_icmsst_ret when calling CteSimpSefazICMS60Simp., must be bigger than or equal to 0.');
        }
    ...
    public function setVCred($v_cred)
    {
        ...
        if (!is_null($v_cred) && ($v_cred < 0)) {
            throw new \InvalidArgumentException('invalid value for $v_cred when calling CteSimpSefazICMS60Simp., must be bigger than or equal to 0.');
        }
    ...
    public function setVIcmsDeson($v_icms_deson)
    {
        ...
        if (!is_null($v_icms_deson) && ($v_icms_deson < 0)) {
            throw new \InvalidArgumentException('invalid value for $v_icms_deson when calling CteSimpSefazICMS60Simp., must be bigger than or equal to 0.');
        }
    ...
    public function setCBenef($c_benef)
    {
        ...
        if (!is_null($c_benef) && (mb_strlen($c_benef) > 10)) {
            throw new \InvalidArgumentException('invalid length for $c_benef when calling CteSimpSefazICMS60Simp., must be smaller than or equal to 10.');
        }
