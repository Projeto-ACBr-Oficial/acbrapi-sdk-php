...
/**
 * CteSefazInfDCe Class Doc Comment
 *
 * @category Class
 ...
 */
class CteSefazInfDCe implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CteSefazInfDCe';
    ...
    */
     ...
     * Sets chave
     *
     * @param string $chave Chave de acesso da DCe.
     *
     * @return self
     */
    public function setChave($chave)
    {
        ...
        if (!is_null($chave) && (mb_strlen($chave) > 44)) {
            throw new \InvalidArgumentException('invalid length for $chave when calling CteSefazInfDCe., must be smaller than or equal to 44.');
        }
