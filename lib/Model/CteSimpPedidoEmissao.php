...
/**
 * CteSimpPedidoEmissao Class Doc Comment
 *
 * @category Class
 * @package  ACBrAPI
 * @author   OpenAPI Generator team
 ...
 */
class CteSimpPedidoEmissao implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CteSimpPedidoEmissao';
    ...
    protected static $openAPITypes = [
        'inf_cte' => '\ACBrAPI\Model\CteSimpSefazInfCteSimp',
        'inf_cte_supl' => '\ACBrAPI\Model\CteSimpSefazInfCTeSuplSimp',
        'ambiente' => 'string',
        'referencia' => 'string'
    ];
    ...
    */
     ...
     * Gets inf_cte
     *
     * @return \ACBrAPI\Model\CteSimpSefazInfCteSimp
     */
     ...
     * Sets inf_cte
     *
     * @param \ACBrAPI\Model\CteSimpSefazInfCteSimp $inf_cte inf_cte
     *
     * @return self
     */
     ...
     * Gets inf_cte_supl
     *
     * @return \ACBrAPI\Model\CteSimpSefazInfCTeSuplSimp|null
     */
     ...
     * Sets inf_cte_supl
     *
     * @param \ACBrAPI\Model\CteSimpSefazInfCTeSuplSimp|null $inf_cte_supl inf_cte_supl
     *
     * @return self
     */
    ...
    public function setReferencia($referencia)
    {
        ...
        if (!is_null($referencia) && (mb_strlen($referencia) > 50)) {
            throw new \InvalidArgumentException('invalid length for $referencia when calling CteSimpPedidoEmissao., must be smaller than or equal to 50.');
        }
