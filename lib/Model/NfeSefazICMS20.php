    ...
    */
    ...
    public function setPRedBc($p_red_bc)
    {
        ...
        if (!is_null($p_red_bc) && ($p_red_bc < 0)) {
            throw new \InvalidArgumentException('invalid value for $p_red_bc when calling NfeSefazICMS20., must be bigger than or equal to 0.');
        }
    ...
    public function setVBc($v_bc)
    {
        ...
        if (!is_null($v_bc) && ($v_bc < 0)) {
            throw new \InvalidArgumentException('invalid value for $v_bc when calling NfeSefazICMS20., must be bigger than or equal to 0.');
        }
    ...
    public function setPIcms($p_icms)
    {
        ...
        if (!is_null($p_icms) && ($p_icms < 0)) {
            throw new \InvalidArgumentException('invalid value for $p_icms when calling NfeSefazICMS20., must be bigger than or equal to 0.');
        }
    ...
    public function setVIcms($v_icms)
    {
        ...
        if (!is_null($v_icms) && ($v_icms < 0)) {
            throw new \InvalidArgumentException('invalid value for $v_icms when calling NfeSefazICMS20., must be bigger than or equal to 0.');
        }
    ...
    public function setVBcfcp($v_bcfcp)
    {
        ...
        if (!is_null($v_bcfcp) && ($v_bcfcp < 0)) {
            throw new \InvalidArgumentException('invalid value for $v_bcfcp when calling NfeSefazICMS20., must be bigger than or equal to 0.');
        }
    ...
    public function setPFcp($p_fcp)
    {
        ...
        if (!is_null($p_fcp) && ($p_fcp < 0)) {
            throw new \InvalidArgumentException('invalid value for $p_fcp when calling NfeSefazICMS20., must be bigger than or equal to 0.');
        }
    ...
    public function setVFcp($v_fcp)
    {
        ...
        if (!is_null($v_fcp) && ($v_fcp < 0)) {
            throw new \InvalidArgumentException('invalid value for $v_fcp when calling NfeSefazICMS20., must be bigger than or equal to 0.');
        }
    ...
    public function setVIcmsDeson($v_icms_deson)
    {
        ...
        if (!is_null($v_icms_deson) && ($v_icms_deson < 0)) {
            throw new \InvalidArgumentException('invalid value for $v_icms_deson when calling NfeSefazICMS20., must be bigger than or equal to 0.');
        }
     ...
     * Sets mot_des_icms
     *
     * @param int|null $mot_des_icms Motivo da desoneração do ICMS:3-Uso na agropecuária  * 9 - Outros  * 10 - Deficiente Condutor (Convênio ICMS 38/12)  * 11 - Deficiente Não Condutor (Convênio ICMS 38/12)  * 12 - Fomento agropecuário
     *
     * @return self
     */
