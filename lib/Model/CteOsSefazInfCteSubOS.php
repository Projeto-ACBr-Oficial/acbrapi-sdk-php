...
/**
 * CteOsSefazInfCteSubOS Class Doc Comment
 *
 * @category Class
 ...
 */
class CteOsSefazInfCteSubOS implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CteOsSefazInfCteSubOS';
    ...
    */
    ...
    public function setChCte($ch_cte)
    {
        ...
        if (!is_null($ch_cte) && (mb_strlen($ch_cte) > 44)) {
            throw new \InvalidArgumentException('invalid length for $ch_cte when calling CteOsSefazInfCteSubOS., must be smaller than or equal to 44.');
        }
