...
/**
 * CteSimpSefazOccSimp Class Doc Comment
 *
 * @category Class
 ...
 */
class CteSimpSefazOccSimp implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CteSimpSefazOccSimp';
    ...
    protected static $openAPITypes = [
        ...
        'n_occ' => 'int',
        'd_emi' => '\DateTime',
        'emi_occ' => '\ACBrAPI\Model\CteSimpSefazEmiOccSimp'
    ];
    ...
    */
    ...
    public function setSerie($serie)
    {
        ...
        if (!is_null($serie) && (mb_strlen($serie) > 3)) {
            throw new \InvalidArgumentException('invalid length for $serie when calling CteSimpSefazOccSimp., must be smaller than or equal to 3.');
        }
        if (!is_null($serie) && (mb_strlen($serie) < 1)) {
            throw new \InvalidArgumentException('invalid length for $serie when calling CteSimpSefazOccSimp., must be bigger than or equal to 1.');
        }
    ...
    public function setNOcc($n_occ)
    {
        ...
        if (!is_null($n_occ) && ($n_occ > 999999)) {
            throw new \InvalidArgumentException('invalid value for $n_occ when calling CteSimpSefazOccSimp., must be smaller than or equal to 999999.');
        }
        if (!is_null($n_occ) && ($n_occ < 1)) {
            throw new \InvalidArgumentException('invalid value for $n_occ when calling CteSimpSefazOccSimp., must be bigger than or equal to 1.');
        }
     ...
     * Gets emi_occ
     *
     * @return \ACBrAPI\Model\CteSimpSefazEmiOccSimp|null
     */
     ...
     * Sets emi_occ
     *
     * @param \ACBrAPI\Model\CteSimpSefazEmiOccSimp|null $emi_occ emi_occ
     *
     * @return self
     */
