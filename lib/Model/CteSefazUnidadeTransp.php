...
class CteSefazUnidadeTransp implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'lac_unid_transp' => '\ACBrAPI\Model\CteSefazLacUnidTransp[]',
        'inf_unid_carga' => '\ACBrAPI\Model\CteSefazUnidCarga[]',
        'qtd_rat' => 'float'
    ];
    ...
    */
     ...
     *
     * @return \ACBrAPI\Model\CteSefazLacUnidTransp[]|null
     */
     ...
     *
     * @param \ACBrAPI\Model\CteSefazLacUnidTransp[]|null $lac_unid_transp lac_unid_transp
     *
     * @return self
     */
     ...
     * Gets inf_unid_carga
     *
     * @return \ACBrAPI\Model\CteSefazUnidCarga[]|null
     */
     ...
     * Sets inf_unid_carga
     *
     * @param \ACBrAPI\Model\CteSefazUnidCarga[]|null $inf_unid_carga inf_unid_carga
     *
     * @return self
     */
    ...
    public function setQtdRat($qtd_rat)
    {
        ...
        if (!is_null($qtd_rat) && ($qtd_rat < 0)) {
            throw new \InvalidArgumentException('invalid value for $qtd_rat when calling CteSefazUnidadeTransp., must be bigger than or equal to 0.');
        }
