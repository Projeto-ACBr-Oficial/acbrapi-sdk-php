...
/**
 * CteSimpSefazUnidadeTranspSimp Class Doc Comment
 *
 * @category Class
 ...
 */
class CteSimpSefazUnidadeTranspSimp implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CteSimpSefazUnidadeTranspSimp';
    ...
    protected static $openAPITypes = [
        ...
        'lac_unid_transp' => '\ACBrAPI\Model\CteSimpSefazLacUnidTranspSimp[]',
        'inf_unid_carga' => '\ACBrAPI\Model\CteSimpSefazUnidCargaSimp[]',
        'qtd_rat' => 'float'
    ];
    ...
    */
    ...
    public function setIdUnidTransp($id_unid_transp)
    {
        ...
        if (!is_null($id_unid_transp) && (mb_strlen($id_unid_transp) > 20)) {
            throw new \InvalidArgumentException('invalid length for $id_unid_transp when calling CteSimpSefazUnidadeTranspSimp., must be smaller than or equal to 20.');
        }
        if (!is_null($id_unid_transp) && (mb_strlen($id_unid_transp) < 1)) {
            throw new \InvalidArgumentException('invalid length for $id_unid_transp when calling CteSimpSefazUnidadeTranspSimp., must be bigger than or equal to 1.');
        }
     ...
     *
     * @return \ACBrAPI\Model\CteSimpSefazLacUnidTranspSimp[]|null
     */
     ...
     *
     * @param \ACBrAPI\Model\CteSimpSefazLacUnidTranspSimp[]|null $lac_unid_transp lac_unid_transp
     *
     * @return self
     */
     ...
     * Gets inf_unid_carga
     *
     * @return \ACBrAPI\Model\CteSimpSefazUnidCargaSimp[]|null
     */
     ...
     * Sets inf_unid_carga
     *
     * @param \ACBrAPI\Model\CteSimpSefazUnidCargaSimp[]|null $inf_unid_carga inf_unid_carga
     *
     * @return self
     */
    ...
    public function setQtdRat($qtd_rat)
    {
        ...
        if (!is_null($qtd_rat) && ($qtd_rat < 0)) {
            throw new \InvalidArgumentException('invalid value for $qtd_rat when calling CteSimpSefazUnidadeTranspSimp., must be bigger than or equal to 0.');
        }
