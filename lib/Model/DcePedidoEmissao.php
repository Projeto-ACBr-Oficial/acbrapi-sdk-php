...
/**
 * DcePedidoEmissao Class Doc Comment
 *
 * @category Class
 * @package  ACBrAPI
 * @author   OpenAPI Generator team
 ...
 */
class DcePedidoEmissao implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'DcePedidoEmissao';
    ...
    protected static $openAPITypes = [
        'inf_dce' => '\ACBrAPI\Model\DceSefazInfDCe',
        'inf_solic_dce' => '\ACBrAPI\Model\DceSefazInfSolicDCe',
        'ambiente' => 'string',
        'referencia' => 'string'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('inf_solic_dce', $data ?? [], null);
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['inf_dce'] === null) {
            $invalidProperties[] = "'inf_dce' can't be null";
        }
        if ($this->container['inf_solic_dce'] === null) {
            $invalidProperties[] = "'inf_solic_dce' can't be null";
        }
     ...
     * Gets inf_dce
     *
     * @return \ACBrAPI\Model\DceSefazInfDCe
     */
     ...
     * Sets inf_dce
     *
     * @param \ACBrAPI\Model\DceSefazInfDCe $inf_dce inf_dce
     *
     * @return self
     */
     ...
     * Gets inf_solic_dce
     *
     * @return \ACBrAPI\Model\DceSefazInfSolicDCe
     */
    public function getInfSolicDce()
    {
        return $this->container['inf_solic_dce'];
    }

    /**
     * Sets inf_solic_dce
     *
     * @param \ACBrAPI\Model\DceSefazInfSolicDCe $inf_solic_dce inf_solic_dce
     *
     * @return self
     */
    public function setInfSolicDce($inf_solic_dce)
    {
        if (is_null($inf_solic_dce)) {
            throw new \InvalidArgumentException('non-nullable inf_solic_dce cannot be null');
        }
        $this->container['inf_solic_dce'] = $inf_solic_dce;
    ...
    public function setReferencia($referencia)
    {
        ...
        if (!is_null($referencia) && (mb_strlen($referencia) > 50)) {
            throw new \InvalidArgumentException('invalid length for $referencia when calling DcePedidoEmissao., must be smaller than or equal to 50.');
        }
