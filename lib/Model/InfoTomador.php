...
class InfoTomador implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets orgao_publico
     *
     * @param bool|null $orgao_publico Indica se o tomador do serviço - um órgão público.    **Atenção**: Para emissões pelo Sistema Nacional NFS-e, esse campo é ignorado.
     *
     * @return self
     */
     ...
     * Gets end
     *
     * @return \ACBrAPI\Model\Endereco|null
     */
     ...
     * Sets end
     *
     * @param \ACBrAPI\Model\Endereco|null $end end
     *
     * @return self
     */
