...
/**
 * CteSimpSefazIdeSimp Class Doc Comment
 *
 * @category Class
 ...
 */
class CteSimpSefazIdeSimp implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CteSimpSefazIdeSimp';
    ...
    protected static $openAPITypes = [
        ...
        'dh_cont' => '\DateTime',
        'x_just' => 'string',
        'g_compra_gov' => '\ACBrAPI\Model\CteSimpSefazCompraGovReduzidoSimp',
        'tp_pag_ant' => 'int',
        'g_pag_antecipado' => '\ACBrAPI\Model\CteSimpSefazGPagAntecipadoSimp'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('tp_pag_ant', $data ?? [], null);
    ...
    */
    ...
    public function setNatOp($nat_op)
    {
        ...
        if (!is_null($nat_op) && (mb_strlen($nat_op) > 60)) {
            throw new \InvalidArgumentException('invalid length for $nat_op when calling CteSimpSefazIdeSimp., must be smaller than or equal to 60.');
        }
        if (!is_null($nat_op) && (mb_strlen($nat_op) < 1)) {
            throw new \InvalidArgumentException('invalid length for $nat_op when calling CteSimpSefazIdeSimp., must be bigger than or equal to 1.');
        }
    ...
    public function setSerie($serie)
    {
        ...
        if (!is_null($serie) && ($serie > 999)) {
            throw new \InvalidArgumentException('invalid value for $serie when calling CteSimpSefazIdeSimp., must be smaller than or equal to 999.');
        }
        if (!is_null($serie) && ($serie < 0)) {
            throw new \InvalidArgumentException('invalid value for $serie when calling CteSimpSefazIdeSimp., must be bigger than or equal to 0.');
        }
    ...
    public function setNCt($n_ct)
    {
        ...
        if (!is_null($n_ct) && ($n_ct > 999999999)) {
            throw new \InvalidArgumentException('invalid value for $n_ct when calling CteSimpSefazIdeSimp., must be smaller than or equal to 999999999.');
        }
        if (!is_null($n_ct) && ($n_ct < 1)) {
            throw new \InvalidArgumentException('invalid value for $n_ct when calling CteSimpSefazIdeSimp., must be bigger than or equal to 1.');
        }
     ...
     * Sets tp_emis
     *
     * @param int $tp_emis Forma de emissão do CT-e.  Preencher com:  * 1 - Normal  * 3 - Regime Especial NFF  * 4 - EPEC pela SVC  * 7 - Autorização pela SVC-RS  * 8 - Autorização pela SVC-SP
     *
     * @return self
     */
    ...
    public function setCDv($c_dv)
    {
        ...
        if (!is_null($c_dv) && ($c_dv > 9)) {
            throw new \InvalidArgumentException('invalid value for $c_dv when calling CteSimpSefazIdeSimp., must be smaller than or equal to 9.');
        }
        if (!is_null($c_dv) && ($c_dv < 0)) {
            throw new \InvalidArgumentException('invalid value for $c_dv when calling CteSimpSefazIdeSimp., must be bigger than or equal to 0.');
        }
     ...
     * Sets tp_cte
     *
     * @param int $tp_cte Tipo do CT-e Simplificado.  Preencher com:  * 5 - CTe Simplificado  * 6 - Substituição CTe Simplificado
     *
     * @return self
     */
     ...
     * Sets proc_emi
     *
     * @param int $proc_emi Identificador do processo de emissão do CT-e.  Preencher com:  * 0 - emissão de CTe com aplicativo do contribuinte  * 3 - emissão CTe pelo contribuinte com aplicativo fornecido pelo SEBRAE  * 4 - emissão CTe pelo Provedor de Autorização e assinatura - PAA
     *
     * @return self
     */
     ...
     * Sets ver_proc
     *
     * @param string $ver_proc Versão do processo de emissão.  Informar a versão do aplicativo emissor de CT-e.
     *
     * @return self
     */
    public function setVerProc($ver_proc)
    {
        ...
        if (!is_null($ver_proc) && (mb_strlen($ver_proc) > 20)) {
            throw new \InvalidArgumentException('invalid length for $ver_proc when calling CteSimpSefazIdeSimp., must be smaller than or equal to 20.');
        }
        if (!is_null($ver_proc) && (mb_strlen($ver_proc) < 1)) {
            throw new \InvalidArgumentException('invalid length for $ver_proc when calling CteSimpSefazIdeSimp., must be bigger than or equal to 1.');
        }
    ...
    public function setXMunEnv($x_mun_env)
    {
        ...
        if (!is_null($x_mun_env) && (mb_strlen($x_mun_env) > 60)) {
            throw new \InvalidArgumentException('invalid length for $x_mun_env when calling CteSimpSefazIdeSimp., must be smaller than or equal to 60.');
        }
        if (!is_null($x_mun_env) && (mb_strlen($x_mun_env) < 2)) {
            throw new \InvalidArgumentException('invalid length for $x_mun_env when calling CteSimpSefazIdeSimp., must be bigger than or equal to 2.');
        }
     ...
     * Sets tp_serv
     *
     * @param int $tp_serv Tipo do Serviço.  Preencher com:  * 0 - Normal  * 1 - Subcontratação  * 2 - Redespacho
     *
     * @return self
     */
    ...
    public function setXDetRetira($x_det_retira)
    {
        ...
        if (!is_null($x_det_retira) && (mb_strlen($x_det_retira) > 160)) {
            throw new \InvalidArgumentException('invalid length for $x_det_retira when calling CteSimpSefazIdeSimp., must be smaller than or equal to 160.');
        }
        if (!is_null($x_det_retira) && (mb_strlen($x_det_retira) < 1)) {
            throw new \InvalidArgumentException('invalid length for $x_det_retira when calling CteSimpSefazIdeSimp., must be bigger than or equal to 1.');
        }
    ...
    public function setXJust($x_just)
    {
        ...
        if (!is_null($x_just) && (mb_strlen($x_just) > 256)) {
            throw new \InvalidArgumentException('invalid length for $x_just when calling CteSimpSefazIdeSimp., must be smaller than or equal to 256.');
        }
        if (!is_null($x_just) && (mb_strlen($x_just) < 15)) {
            throw new \InvalidArgumentException('invalid length for $x_just when calling CteSimpSefazIdeSimp., must be bigger than or equal to 15.');
        }
     ...
     * Gets g_compra_gov
     *
     * @return \ACBrAPI\Model\CteSimpSefazCompraGovReduzidoSimp|null
     */
     ...
     * Sets g_compra_gov
     *
     * @param \ACBrAPI\Model\CteSimpSefazCompraGovReduzidoSimp|null $g_compra_gov g_compra_gov
     *
     * @return self
     */
     ...
     * @return int|null
     */
    public function getTpPagAnt()
    {
        return $this->container['tp_pag_ant'];
    }

    /**
     * Sets tp_pag_ant
     *
     * @param int|null $tp_pag_ant Tipo Pagamento ou Pagamento Antecipado.  Informar:  * 1 - Pagamento Antecipado  * 3 - Fornecimento com pagamento realizado anteriormente  Este campo é opcional e apenas deve ser informado em caso de Antecipação de Pagamento e no CTe de fornecimento associada a esses pagamentos antecipados, demais hipóteses de prestação de serviço sem antecipação não devem preencher.
     *
     * @return self
     */
    public function setTpPagAnt($tp_pag_ant)
    {
        if (is_null($tp_pag_ant)) {
            array_push($this->openAPINullablesSetToNull, 'tp_pag_ant');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('tp_pag_ant', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['tp_pag_ant'] = $tp_pag_ant;
     ...
     *
     * @return \ACBrAPI\Model\CteSimpSefazGPagAntecipadoSimp|null
     */
     ...
     *
     * @param \ACBrAPI\Model\CteSimpSefazGPagAntecipadoSimp|null $g_pag_antecipado g_pag_antecipado
     *
     * @return self
     */
