...
/**
 * CteOsSefazTomaOS Class Doc Comment
 *
 * @category Class
 * @description Informações do Tomador/Usuário do Serviço.  Opcional para Excesso de Bagagem.
 * @package  ACBrAPI
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class CteOsSefazTomaOS implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CteOsSefazTomaOS';
    ...
    protected static $openAPITypes = [
        ...
        'x_fant' => 'string',
        'fone' => 'string',
        'ender_toma' => '\ACBrAPI\Model\CteOsSefazEnderecoOS',
        'email' => 'string'
    ];
    ...
    */
     ...
     * Sets x_nome
     *
     * @param string $x_nome Razão social ou nome do tomador.
     *
     * @return self
     */
    public function setXNome($x_nome)
    {
        ...
        if (!is_null($x_nome) && (mb_strlen($x_nome) > 60)) {
            throw new \InvalidArgumentException('invalid length for $x_nome when calling CteOsSefazTomaOS., must be smaller than or equal to 60.');
        }
        if (!is_null($x_nome) && (mb_strlen($x_nome) < 2)) {
            throw new \InvalidArgumentException('invalid length for $x_nome when calling CteOsSefazTomaOS., must be bigger than or equal to 2.');
        }
    ...
    public function setXFant($x_fant)
    {
        ...
        if (!is_null($x_fant) && (mb_strlen($x_fant) > 60)) {
            throw new \InvalidArgumentException('invalid length for $x_fant when calling CteOsSefazTomaOS., must be smaller than or equal to 60.');
        }
        if (!is_null($x_fant) && (mb_strlen($x_fant) < 2)) {
            throw new \InvalidArgumentException('invalid length for $x_fant when calling CteOsSefazTomaOS., must be bigger than or equal to 2.');
        }
     ...
     * Gets ender_toma
     *
     * @return \ACBrAPI\Model\CteOsSefazEnderecoOS
     */
     ...
     * Sets ender_toma
     *
     * @param \ACBrAPI\Model\CteOsSefazEnderecoOS $ender_toma ender_toma
     *
     * @return self
     */
