...
/**
 * NfcomSefazCOFINS Class Doc Comment
 *
 * @category Class
 ...
 */
class NfcomSefazCOFINS implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'NfcomSefazCOFINS';
    ...
    */
     ...
     * Sets cst
     *
     * @param string $cst classificação Tributária do COFINS.  * 01 - Tributável com alíquota básica  * 02 - Tributável com alíquota diferenciada  * 06 - Tributável com alíquota zero  * 07 - Operação isenta de contribuição  * 08 - Operação sem incidência da contribuição  * 09 - Operação com suspensão da contribuição  * 49 - Outras operações de saída
     *
     * @return self
     */
    ...
    public function setVBc($v_bc)
    {
        ...
        if (!is_null($v_bc) && ($v_bc < 0)) {
            throw new \InvalidArgumentException('invalid value for $v_bc when calling NfcomSefazCOFINS., must be bigger than or equal to 0.');
        }
    ...
    public function setPCofins($p_cofins)
    {
        ...
        if (!is_null($p_cofins) && ($p_cofins < 0)) {
            throw new \InvalidArgumentException('invalid value for $p_cofins when calling NfcomSefazCOFINS., must be bigger than or equal to 0.');
        }
    ...
    public function setVCofins($v_cofins)
    {
        ...
        if (!is_null($v_cofins) && ($v_cofins < 0)) {
            throw new \InvalidArgumentException('invalid value for $v_cofins when calling NfcomSefazCOFINS., must be bigger than or equal to 0.');
        }
