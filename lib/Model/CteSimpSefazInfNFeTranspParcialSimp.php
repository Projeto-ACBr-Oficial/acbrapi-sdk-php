...
/**
 * CteSimpSefazInfNFeTranspParcialSimp Class Doc Comment
 *
 * @category Class
 * @package  ACBrAPI
 * @author   OpenAPI Generator team
 ...
 */
class CteSimpSefazInfNFeTranspParcialSimp implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CteSimpSefazInfNFeTranspParcialSimp';
    ...
    */
     ...
     * Sets ch_nfe
     *
     * @param string $ch_nfe Chave de acesso da NF-e.  Informando o tpPrest com “2 - Parcial” deve-se informar as chaves de acesso das NF-e que acobertam a carga transportada.
     *
     * @return self
     */
    public function setChNfe($ch_nfe)
    {
        ...
        if (!is_null($ch_nfe) && (mb_strlen($ch_nfe) > 44)) {
            throw new \InvalidArgumentException('invalid length for $ch_nfe when calling CteSimpSefazInfNFeTranspParcialSimp., must be smaller than or equal to 44.');
        }
