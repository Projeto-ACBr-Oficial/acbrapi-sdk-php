...
/**
 * DceSefazAutXML Class Doc Comment
 *
 * @category Class
 * @description Autorizados para acessar o XML da DCe.  Informar CNPJ ou CPF. Preencher os zeros não significativos.
 * @package  ACBrAPI
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class DceSefazAutXML implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'DceSefazAutXML';
