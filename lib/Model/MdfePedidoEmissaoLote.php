...
class MdfePedidoEmissaoLote implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'documentos' => '\ACBrAPI\Model\MdfePedidoEmissao[]',
        'ambiente' => 'string',
        'referencia' => 'string',
        'id_lote' => 'string'
    ];
    ...
    */
     ...
     * Gets documentos
     *
     * @return \ACBrAPI\Model\MdfePedidoEmissao[]|null
     */
     ...
     * Sets documentos
     *
     * @param \ACBrAPI\Model\MdfePedidoEmissao[]|null $documentos documentos
     *
     * @return self
     */
    ...
    public function setReferencia($referencia)
    {
        ...
        if ((mb_strlen($referencia) > 50)) {
            throw new \InvalidArgumentException('invalid length for $referencia when calling MdfePedidoEmissaoLote., must be smaller than or equal to 50.');
        }
