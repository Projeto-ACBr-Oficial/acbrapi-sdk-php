...
/**
 * CteSimpSefazEnderFerSimp Class Doc Comment
 *
 * @category Class
 ...
 */
class CteSimpSefazEnderFerSimp implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CteSimpSefazEnderFerSimp';
    ...
    */
    ...
    public function setXLgr($x_lgr)
    {
        ...
        if (!is_null($x_lgr) && (mb_strlen($x_lgr) > 255)) {
            throw new \InvalidArgumentException('invalid length for $x_lgr when calling CteSimpSefazEnderFerSimp., must be smaller than or equal to 255.');
        }
        if (!is_null($x_lgr) && (mb_strlen($x_lgr) < 2)) {
            throw new \InvalidArgumentException('invalid length for $x_lgr when calling CteSimpSefazEnderFerSimp., must be bigger than or equal to 2.');
        }
    ...
    public function setNro($nro)
    {
        ...
        if (!is_null($nro) && (mb_strlen($nro) > 60)) {
            throw new \InvalidArgumentException('invalid length for $nro when calling CteSimpSefazEnderFerSimp., must be smaller than or equal to 60.');
        }
        if (!is_null($nro) && (mb_strlen($nro) < 1)) {
            throw new \InvalidArgumentException('invalid length for $nro when calling CteSimpSefazEnderFerSimp., must be bigger than or equal to 1.');
        }
    ...
    public function setXCpl($x_cpl)
    {
        ...
        if (!is_null($x_cpl) && (mb_strlen($x_cpl) > 60)) {
            throw new \InvalidArgumentException('invalid length for $x_cpl when calling CteSimpSefazEnderFerSimp., must be smaller than or equal to 60.');
        }
        if (!is_null($x_cpl) && (mb_strlen($x_cpl) < 1)) {
            throw new \InvalidArgumentException('invalid length for $x_cpl when calling CteSimpSefazEnderFerSimp., must be bigger than or equal to 1.');
        }
    ...
    public function setXBairro($x_bairro)
    {
        ...
        if (!is_null($x_bairro) && (mb_strlen($x_bairro) > 60)) {
            throw new \InvalidArgumentException('invalid length for $x_bairro when calling CteSimpSefazEnderFerSimp., must be smaller than or equal to 60.');
        }
        if (!is_null($x_bairro) && (mb_strlen($x_bairro) < 2)) {
            throw new \InvalidArgumentException('invalid length for $x_bairro when calling CteSimpSefazEnderFerSimp., must be bigger than or equal to 2.');
        }
    ...
    public function setXMun($x_mun)
    {
        ...
        if (!is_null($x_mun) && (mb_strlen($x_mun) > 60)) {
            throw new \InvalidArgumentException('invalid length for $x_mun when calling CteSimpSefazEnderFerSimp., must be smaller than or equal to 60.');
        }
        if (!is_null($x_mun) && (mb_strlen($x_mun) < 2)) {
            throw new \InvalidArgumentException('invalid length for $x_mun when calling CteSimpSefazEnderFerSimp., must be bigger than or equal to 2.');
        }
