...
/**
 * CteSimpSefazMultimodalSimp Class Doc Comment
 *
 * @category Class
 ...
 */
class CteSimpSefazMultimodalSimp implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CteSimpSefazMultimodalSimp';
    ...
    protected static $openAPITypes = [
        'cotm' => 'string',
        'ind_negociavel' => 'int',
        'seg' => '\ACBrAPI\Model\CteSimpSefazSegSimp'
    ];
    ...
    */
    ...
    public function setCotm($cotm)
    {
        ...
        if (!is_null($cotm) && (mb_strlen($cotm) > 20)) {
            throw new \InvalidArgumentException('invalid length for $cotm when calling CteSimpSefazMultimodalSimp., must be smaller than or equal to 20.');
        }
        if (!is_null($cotm) && (mb_strlen($cotm) < 1)) {
            throw new \InvalidArgumentException('invalid length for $cotm when calling CteSimpSefazMultimodalSimp., must be bigger than or equal to 1.');
        }
     ...
     * Gets seg
     *
     * @return \ACBrAPI\Model\CteSimpSefazSegSimp|null
     */
     ...
     * Sets seg
     *
     * @param \ACBrAPI\Model\CteSimpSefazSegSimp|null $seg seg
     *
     * @return self
     */
