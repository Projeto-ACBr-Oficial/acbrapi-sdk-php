...
/**
 * CteSimpSefazDetContSimp Class Doc Comment
 *
 * @category Class
 ...
 */
class CteSimpSefazDetContSimp implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CteSimpSefazDetContSimp';
    ...
    protected static $openAPITypes = [
        'n_cont' => 'string',
        'lacre' => '\ACBrAPI\Model\CteSimpSefazLacreSimp[]',
        'inf_doc' => '\ACBrAPI\Model\CteSimpSefazInfDocSimp'
    ];
    ...
    */
    ...
    public function setNCont($n_cont)
    {
        ...
        if (!is_null($n_cont) && (mb_strlen($n_cont) > 20)) {
            throw new \InvalidArgumentException('invalid length for $n_cont when calling CteSimpSefazDetContSimp., must be smaller than or equal to 20.');
        }
        if (!is_null($n_cont) && (mb_strlen($n_cont) < 1)) {
            throw new \InvalidArgumentException('invalid length for $n_cont when calling CteSimpSefazDetContSimp., must be bigger than or equal to 1.');
        }
     ...
     * Gets lacre
     *
     * @return \ACBrAPI\Model\CteSimpSefazLacreSimp[]|null
     */
     ...
     * Sets lacre
     *
     * @param \ACBrAPI\Model\CteSimpSefazLacreSimp[]|null $lacre lacre
     *
     * @return self
     */
    public function setLacre($lacre)
    {
        ...
        if ((count($lacre) > 3)) {
            throw new \InvalidArgumentException('invalid value for $lacre when calling CteSimpSefazDetContSimp., number of items must be less than or equal to 3.');
        }
     ...
     * Gets inf_doc
     *
     * @return \ACBrAPI\Model\CteSimpSefazInfDocSimp|null
     */
     ...
     * Sets inf_doc
     *
     * @param \ACBrAPI\Model\CteSimpSefazInfDocSimp|null $inf_doc inf_doc
     *
     * @return self
     */
