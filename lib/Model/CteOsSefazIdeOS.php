...
/**
 * CteOsSefazIdeOS Class Doc Comment
 *
 * @category Class
 ...
 */
class CteOsSefazIdeOS implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CteOsSefazIdeOS';
    ...
    protected static $openAPITypes = [
        ...
        'x_mun_fim' => 'string',
        'uf_fim' => 'string',
        'inf_percurso' => '\ACBrAPI\Model\CteOsSefazInfPercursoOS[]',
        'dh_cont' => '\DateTime',
        'x_just' => 'string',
        'g_compra_gov' => '\ACBrAPI\Model\CteOsSefazCompraGovReduzidoOS'
    ];
    ...
    */
    ...
    public function setNatOp($nat_op)
    {
        ...
        if (!is_null($nat_op) && (mb_strlen($nat_op) > 60)) {
            throw new \InvalidArgumentException('invalid length for $nat_op when calling CteOsSefazIdeOS., must be smaller than or equal to 60.');
        }
        if (!is_null($nat_op) && (mb_strlen($nat_op) < 1)) {
            throw new \InvalidArgumentException('invalid length for $nat_op when calling CteOsSefazIdeOS., must be bigger than or equal to 1.');
        }
     ...
     * Sets mod
     *
     * @param int|null $mod Modelo do documento fiscal.  Utilizar o código 67 para identificação do CT-e Outros Serviços, emitido em substituição a Nota Fiscal Modelo 7 para transporte de pessoas, valores e excesso de bagagem.
     *
     * @return self
     */
     ...
     * Sets serie
     *
     * @param int $serie Série do CT-e OS.  Preencher com \"0\" no caso de série única.
     *
     * @return self
     */
    public function setSerie($serie)
    {
        ...
        if (!is_null($serie) && ($serie > 999)) {
            throw new \InvalidArgumentException('invalid value for $serie when calling CteOsSefazIdeOS., must be smaller than or equal to 999.');
        }
        if (!is_null($serie) && ($serie < 0)) {
            throw new \InvalidArgumentException('invalid value for $serie when calling CteOsSefazIdeOS., must be bigger than or equal to 0.');
        }
     ...
     * Sets n_ct
     *
     * @param int $n_ct Número do CT-e OS.
     *
     * @return self
     */
    public function setNCt($n_ct)
    {
        ...
        if (!is_null($n_ct) && ($n_ct > 999999999)) {
            throw new \InvalidArgumentException('invalid value for $n_ct when calling CteOsSefazIdeOS., must be smaller than or equal to 999999999.');
        }
        if (!is_null($n_ct) && ($n_ct < 1)) {
            throw new \InvalidArgumentException('invalid value for $n_ct when calling CteOsSefazIdeOS., must be bigger than or equal to 1.');
        }
     ...
     * Sets dh_emi
     *
     * @param \DateTime $dh_emi Data e hora de emissão do CT-e OS.  Formato AAAA-MM-DDTHH:MM:DD TZD.
     *
     * @return self
     */
     ...
     * Sets tp_emis
     *
     * @param int $tp_emis Forma de emissão do CT-e.  Preencher com:  * 1 - Normal  * 5 - Contingência FSDA  * 7 - Autorização pela SVC-RS  * 8 - Autorização pela SVC-SP
     *
     * @return self
     */
    ...
    public function setCDv($c_dv)
    {
        ...
        if (!is_null($c_dv) && ($c_dv > 9)) {
            throw new \InvalidArgumentException('invalid value for $c_dv when calling CteOsSefazIdeOS., must be smaller than or equal to 9.');
        }
        if (!is_null($c_dv) && ($c_dv < 0)) {
            throw new \InvalidArgumentException('invalid value for $c_dv when calling CteOsSefazIdeOS., must be bigger than or equal to 0.');
        }
     ...
     * Sets tp_cte
     *
     * @param int $tp_cte Tipo do CT-e OS.  Preencher com:  * 0 - CT-e Normal  * 1 - CT-e Complementar  * 3 - CT-e de Substituição
     *
     * @return self
     */
     ...
     * Sets proc_emi
     *
     * @param int $proc_emi Identificador do processo de emissão do CTe OS.  Preencher com:         0 - emissão de CTe com aplicativo do contribuinte  * 3 - emissão CTe pelo contribuinte com aplicativo fornecido pelo Fisco
     *
     * @return self
     */
    ...
    public function setVerProc($ver_proc)
    {
        ...
        if (!is_null($ver_proc) && (mb_strlen($ver_proc) > 20)) {
            throw new \InvalidArgumentException('invalid length for $ver_proc when calling CteOsSefazIdeOS., must be smaller than or equal to 20.');
        }
        if (!is_null($ver_proc) && (mb_strlen($ver_proc) < 1)) {
            throw new \InvalidArgumentException('invalid length for $ver_proc when calling CteOsSefazIdeOS., must be bigger than or equal to 1.');
        }
    ...
    public function setXMunEnv($x_mun_env)
    {
        ...
        if (!is_null($x_mun_env) && (mb_strlen($x_mun_env) > 60)) {
            throw new \InvalidArgumentException('invalid length for $x_mun_env when calling CteOsSefazIdeOS., must be smaller than or equal to 60.');
        }
        if (!is_null($x_mun_env) && (mb_strlen($x_mun_env) < 2)) {
            throw new \InvalidArgumentException('invalid length for $x_mun_env when calling CteOsSefazIdeOS., must be bigger than or equal to 2.');
        }
     ...
     * Sets modal
     *
     * @param string $modal Modal. Preencher com:  * 01 - Rodoviário  * 02 - Aéreo  * 03 - Aquaviário  * 04 - Ferroviário
     *
     * @return self
     */
     ...
     * Sets tp_serv
     *
     * @param int $tp_serv Tipo do Serviço.  Preencher com:  * 6 - Transporte de Pessoas  * 7 - Transporte de Valores  * 8 - Excesso de Bagagem
     *
     * @return self
     */
     ...
     * Sets ind_ie_toma
     *
     * @param int $ind_ie_toma Indicador da IE do tomador:  * 1 - Contribuinte ICMS  * 2 - Contribuinte isento de inscrição  * 9 - Não Contribuinte  Aplica-se ao tomador que for indicado no toma3 ou toma4.
     *
     * @return self
     */
     ...
     * Sets c_mun_ini
     *
     * @param string|null $c_mun_ini Código do Município de início da prestação.  Utilizar a tabela do IBGE. Informar 9999999 para operações com o exterior.
     *
     * @return self
     */
     ...
     * Sets x_mun_ini
     *
     * @param string|null $x_mun_ini Nome do Município do início da prestação.  Informar 'EXTERIOR' para operações com o exterior.
     *
     * @return self
     */
    public function setXMunIni($x_mun_ini)
    {
        ...
        if (!is_null($x_mun_ini) && (mb_strlen($x_mun_ini) > 60)) {
            throw new \InvalidArgumentException('invalid length for $x_mun_ini when calling CteOsSefazIdeOS., must be smaller than or equal to 60.');
        }
        if (!is_null($x_mun_ini) && (mb_strlen($x_mun_ini) < 2)) {
            throw new \InvalidArgumentException('invalid length for $x_mun_ini when calling CteOsSefazIdeOS., must be bigger than or equal to 2.');
        }
     ...
     * Sets uf_ini
     *
     * @param string|null $uf_ini UF do início da prestação.  Informar 'EX' para operações com o exterior.
     *
     * @return self
     */
     ...
     * Sets c_mun_fim
     *
     * @param string|null $c_mun_fim Código do Município de término da prestação.  Utilizar a tabela do IBGE. Informar 9999999 para operações com o exterior.
     *
     * @return self
     */
     ...
     * Sets x_mun_fim
     *
     * @param string|null $x_mun_fim Nome do Município do término da prestação.  Informar 'EXTERIOR' para operações com o exterior.
     *
     * @return self
     */
    public function setXMunFim($x_mun_fim)
    {
        ...
        if (!is_null($x_mun_fim) && (mb_strlen($x_mun_fim) > 60)) {
            throw new \InvalidArgumentException('invalid length for $x_mun_fim when calling CteOsSefazIdeOS., must be smaller than or equal to 60.');
        }
        if (!is_null($x_mun_fim) && (mb_strlen($x_mun_fim) < 2)) {
            throw new \InvalidArgumentException('invalid length for $x_mun_fim when calling CteOsSefazIdeOS., must be bigger than or equal to 2.');
        }
     ...
     * Sets uf_fim
     *
     * @param string|null $uf_fim UF do término da prestação.  Informar 'EX' para operações com o exterior.
     *
     * @return self
     */
     ...
     * Gets inf_percurso
     *
     * @return \ACBrAPI\Model\CteOsSefazInfPercursoOS[]|null
     */
     ...
     * Sets inf_percurso
     *
     * @param \ACBrAPI\Model\CteOsSefazInfPercursoOS[]|null $inf_percurso inf_percurso
     *
     * @return self
     */
    public function setInfPercurso($inf_percurso)
    {
        ...
        if ((count($inf_percurso) > 25)) {
            throw new \InvalidArgumentException('invalid value for $inf_percurso when calling CteOsSefazIdeOS., number of items must be less than or equal to 25.');
        }
    ...
    public function setXJust($x_just)
    {
        ...
        if (!is_null($x_just) && (mb_strlen($x_just) > 256)) {
            throw new \InvalidArgumentException('invalid length for $x_just when calling CteOsSefazIdeOS., must be smaller than or equal to 256.');
        }
        if (!is_null($x_just) && (mb_strlen($x_just) < 15)) {
            throw new \InvalidArgumentException('invalid length for $x_just when calling CteOsSefazIdeOS., must be bigger than or equal to 15.');
        }
     ...
     * Gets g_compra_gov
     *
     * @return \ACBrAPI\Model\CteOsSefazCompraGovReduzidoOS|null
     */
     ...
     * Sets g_compra_gov
     *
     * @param \ACBrAPI\Model\CteOsSefazCompraGovReduzidoOS|null $g_compra_gov g_compra_gov
     *
     * @return self
     */
