...
class CteOsSefazIdeOS implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets proc_emi
     *
     * @param int $proc_emi Identificador do processo de emissão do CT-e OS.  Preencher com:  * 0 - emissão de CT-e com aplicativo do contribuinte  * 3 - emissão CT-e pelo contribuinte com aplicativo fornecido pelo Fisco
     *
     * @return self
     */
