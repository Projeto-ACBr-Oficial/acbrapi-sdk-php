...
/**
 * CteSimpSefazInfSegSimp Class Doc Comment
 *
 * @category Class
 ...
 */
class CteSimpSefazInfSegSimp implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CteSimpSefazInfSegSimp';
    ...
    */
    ...
    public function setXSeg($x_seg)
    {
        ...
        if (!is_null($x_seg) && (mb_strlen($x_seg) > 30)) {
            throw new \InvalidArgumentException('invalid length for $x_seg when calling CteSimpSefazInfSegSimp., must be smaller than or equal to 30.');
        }
        if (!is_null($x_seg) && (mb_strlen($x_seg) < 1)) {
            throw new \InvalidArgumentException('invalid length for $x_seg when calling CteSimpSefazInfSegSimp., must be bigger than or equal to 1.');
        }
