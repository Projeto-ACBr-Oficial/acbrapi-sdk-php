...
/**
 * CteOsSefazInfCteCompOS Class Doc Comment
 *
 * @category Class
 ...
 */
class CteOsSefazInfCteCompOS implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CteOsSefazInfCteCompOS';
    ...
    */
    ...
    public function setChCte($ch_cte)
    {
        ...
        if (!is_null($ch_cte) && (mb_strlen($ch_cte) > 44)) {
            throw new \InvalidArgumentException('invalid length for $ch_cte when calling CteOsSefazInfCteCompOS., must be smaller than or equal to 44.');
        }
