...
/**
 * CteOsSefazICMSUFFimOS Class Doc Comment
 *
 * @category Class
 ...
 */
class CteOsSefazICMSUFFimOS implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CteOsSefazICMSUFFimOS';
    ...
    */
    ...
    public function setVBcufFim($v_bcuf_fim)
    {
        ...
        if (!is_null($v_bcuf_fim) && ($v_bcuf_fim < 0)) {
            throw new \InvalidArgumentException('invalid value for $v_bcuf_fim when calling CteOsSefazICMSUFFimOS., must be bigger than or equal to 0.');
        }
    ...
    public function setPFcpufFim($p_fcpuf_fim)
    {
        ...
        if (!is_null($p_fcpuf_fim) && ($p_fcpuf_fim < 0)) {
            throw new \InvalidArgumentException('invalid value for $p_fcpuf_fim when calling CteOsSefazICMSUFFimOS., must be bigger than or equal to 0.');
        }
    ...
    public function setPIcmsufFim($p_icmsuf_fim)
    {
        ...
        if (!is_null($p_icmsuf_fim) && ($p_icmsuf_fim < 0)) {
            throw new \InvalidArgumentException('invalid value for $p_icmsuf_fim when calling CteOsSefazICMSUFFimOS., must be bigger than or equal to 0.');
        }
    ...
    public function setPIcmsInter($p_icms_inter)
    {
        ...
        if (!is_null($p_icms_inter) && ($p_icms_inter < 0)) {
            throw new \InvalidArgumentException('invalid value for $p_icms_inter when calling CteOsSefazICMSUFFimOS., must be bigger than or equal to 0.');
        }
    ...
    public function setVFcpufFim($v_fcpuf_fim)
    {
        ...
        if (!is_null($v_fcpuf_fim) && ($v_fcpuf_fim < 0)) {
            throw new \InvalidArgumentException('invalid value for $v_fcpuf_fim when calling CteOsSefazICMSUFFimOS., must be bigger than or equal to 0.');
        }
    ...
    public function setVIcmsufFim($v_icmsuf_fim)
    {
        ...
        if (!is_null($v_icmsuf_fim) && ($v_icmsuf_fim < 0)) {
            throw new \InvalidArgumentException('invalid value for $v_icmsuf_fim when calling CteOsSefazICMSUFFimOS., must be bigger than or equal to 0.');
        }
    ...
    public function setVIcmsufIni($v_icmsuf_ini)
    {
        ...
        if (!is_null($v_icmsuf_ini) && ($v_icmsuf_ini < 0)) {
            throw new \InvalidArgumentException('invalid value for $v_icmsuf_ini when calling CteOsSefazICMSUFFimOS., must be bigger than or equal to 0.');
        }
