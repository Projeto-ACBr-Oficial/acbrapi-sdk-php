    ...
    */
    ...
    public function setPMvast($p_mvast)
    {
        ...
        if (!is_null($p_mvast) && ($p_mvast < 0)) {
            throw new \InvalidArgumentException('invalid value for $p_mvast when calling NfeSefazICMSSN202., must be bigger than or equal to 0.');
        }
    ...
    public function setPRedBcst($p_red_bcst)
    {
        ...
        if (!is_null($p_red_bcst) && ($p_red_bcst < 0)) {
            throw new \InvalidArgumentException('invalid value for $p_red_bcst when calling NfeSefazICMSSN202., must be bigger than or equal to 0.');
        }
    ...
    public function setVBcst($v_bcst)
    {
        ...
        if (!is_null($v_bcst) && ($v_bcst < 0)) {
            throw new \InvalidArgumentException('invalid value for $v_bcst when calling NfeSefazICMSSN202., must be bigger than or equal to 0.');
        }
    ...
    public function setPIcmsst($p_icmsst)
    {
        ...
        if (!is_null($p_icmsst) && ($p_icmsst < 0)) {
            throw new \InvalidArgumentException('invalid value for $p_icmsst when calling NfeSefazICMSSN202., must be bigger than or equal to 0.');
        }
    ...
    public function setVIcmsst($v_icmsst)
    {
        ...
        if (!is_null($v_icmsst) && ($v_icmsst < 0)) {
            throw new \InvalidArgumentException('invalid value for $v_icmsst when calling NfeSefazICMSSN202., must be bigger than or equal to 0.');
        }
    ...
    public function setVBcfcpst($v_bcfcpst)
    {
        ...
        if (!is_null($v_bcfcpst) && ($v_bcfcpst < 0)) {
            throw new \InvalidArgumentException('invalid value for $v_bcfcpst when calling NfeSefazICMSSN202., must be bigger than or equal to 0.');
        }
    ...
    public function setPFcpst($p_fcpst)
    {
        ...
        if (!is_null($p_fcpst) && ($p_fcpst < 0)) {
            throw new \InvalidArgumentException('invalid value for $p_fcpst when calling NfeSefazICMSSN202., must be bigger than or equal to 0.');
        }
    ...
    public function setVFcpst($v_fcpst)
    {
        ...
        if (!is_null($v_fcpst) && ($v_fcpst < 0)) {
            throw new \InvalidArgumentException('invalid value for $v_fcpst when calling NfeSefazICMSSN202., must be bigger than or equal to 0.');
        }
