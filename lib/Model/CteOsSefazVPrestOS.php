...
/**
 * CteOsSefazVPrestOS Class Doc Comment
 *
 * @category Class
 ...
 */
class CteOsSefazVPrestOS implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CteOsSefazVPrestOS';
    ...
    protected static $openAPITypes = [
        'v_t_prest' => 'float',
        'v_rec' => 'float',
        'comp' => '\ACBrAPI\Model\CteOsSefazCompOS[]'
    ];
    ...
    */
    ...
    public function setVTPrest($v_t_prest)
    {
        ...
        if (!is_null($v_t_prest) && ($v_t_prest < 0)) {
            throw new \InvalidArgumentException('invalid value for $v_t_prest when calling CteOsSefazVPrestOS., must be bigger than or equal to 0.');
        }
    ...
    public function setVRec($v_rec)
    {
        ...
        if (!is_null($v_rec) && ($v_rec < 0)) {
            throw new \InvalidArgumentException('invalid value for $v_rec when calling CteOsSefazVPrestOS., must be bigger than or equal to 0.');
        }
     ...
     * Gets comp
     *
     * @return \ACBrAPI\Model\CteOsSefazCompOS[]|null
     */
     ...
     * Sets comp
     *
     * @param \ACBrAPI\Model\CteOsSefazCompOS[]|null $comp comp
     *
     * @return self
     */
