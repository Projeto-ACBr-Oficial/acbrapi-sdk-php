...
class NfeSefazIS implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('p_is_espec', $data ?? [], null);
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['p_is_espec']) && ($this->container['p_is_espec'] < 0)) {
            $invalidProperties[] = "invalid value for 'p_is_espec', must be bigger than or equal to 0.";
        }
     ...
     * @return float|null
     */
    public function getPIsEspec()
    {
        return $this->container['p_is_espec'];
    }

    /**
     * Sets p_is_espec
     *
     * @param float|null $p_is_espec Alíquota do Imposto Seletivo (por valor).
     *
     * @return self
     */
    public function setPIsEspec($p_is_espec)
    {
        if (is_null($p_is_espec)) {
            array_push($this->openAPINullablesSetToNull, 'p_is_espec');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('p_is_espec', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        ...
        if (!is_null($p_is_espec) && ($p_is_espec < 0)) {
            throw new \InvalidArgumentException('invalid value for $p_is_espec when calling NfeSefazIS., must be bigger than or equal to 0.');
        }

        $this->container['p_is_espec'] = $p_is_espec;
