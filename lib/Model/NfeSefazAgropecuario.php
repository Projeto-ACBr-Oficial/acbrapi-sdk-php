...
/**
 * NfeSefazAgropecuario Class Doc Comment
 *
 * @category Class
 ...
 */
class NfeSefazAgropecuario implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'NfeSefazAgropecuario';
    ...
    protected static $setters = [
        'defensivo' => 'setDefensivo',
        'guia_transito' => 'setGuiaTransito'
    ];
    ...
    {
        $this->setIfExists('defensivo', $data ?? [], null);
        $this->setIfExists('guia_transito', $data ?? [], null);
    }
    ...
    */
    ...
    {
        return $this->container['defensivo'];
    }
     ...
     * Gets guia_transito
     *
     * @return \ACBrAPI\Model\NfeSefazGuiaTransito|null
     */
    public function getGuiaTransito()
    {
        return $this->container['guia_transito'];
    }

    /**
     * Sets guia_transito
     *
     * @param \ACBrAPI\Model\NfeSefazGuiaTransito|null $guia_transito guia_transito
     *
     * @return self
     */
    public function setGuiaTransito($guia_transito)
    {
        if (is_null($guia_transito)) {
            throw new \InvalidArgumentException('non-nullable guia_transito cannot be null');
        }
        $this->container['guia_transito'] = $guia_transito;
