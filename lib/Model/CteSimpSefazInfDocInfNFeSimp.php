...
/**
 * CteSimpSefazInfDocInfNFeSimp Class Doc Comment
 *
 * @category Class
 ...
 */
class CteSimpSefazInfDocInfNFeSimp implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CteSimpSefazInfDoc_InfNFeSimp';
    ...
    */
    ...
    public function setChave($chave)
    {
        ...
        if (!is_null($chave) && (mb_strlen($chave) > 44)) {
            throw new \InvalidArgumentException('invalid length for $chave when calling CteSimpSefazInfDocInfNFeSimp., must be smaller than or equal to 44.');
        }
    ...
    public function setUnidRat($unid_rat)
    {
        ...
        if (!is_null($unid_rat) && ($unid_rat < 0)) {
            throw new \InvalidArgumentException('invalid value for $unid_rat when calling CteSimpSefazInfDocInfNFeSimp., must be bigger than or equal to 0.');
        }
