...
/**
 * CteSimpSefazLacUnidTranspSimp Class Doc Comment
 *
 * @category Class
 ...
 */
class CteSimpSefazLacUnidTranspSimp implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CteSimpSefazLacUnidTranspSimp';
    ...
    */
    ...
    public function setNLacre($n_lacre)
    {
        ...
        if (!is_null($n_lacre) && (mb_strlen($n_lacre) > 20)) {
            throw new \InvalidArgumentException('invalid length for $n_lacre when calling CteSimpSefazLacUnidTranspSimp., must be smaller than or equal to 20.');
        }
        if (!is_null($n_lacre) && (mb_strlen($n_lacre) < 1)) {
            throw new \InvalidArgumentException('invalid length for $n_lacre when calling CteSimpSefazLacUnidTranspSimp., must be bigger than or equal to 1.');
        }
