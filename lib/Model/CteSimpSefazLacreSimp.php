...
/**
 * CteSimpSefazLacreSimp Class Doc Comment
 *
 * @category Class
 ...
 */
class CteSimpSefazLacreSimp implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CteSimpSefazLacreSimp';
    ...
    */
    ...
    public function setNLacre($n_lacre)
    {
        ...
        if (!is_null($n_lacre) && (mb_strlen($n_lacre) > 20)) {
            throw new \InvalidArgumentException('invalid length for $n_lacre when calling CteSimpSefazLacreSimp., must be smaller than or equal to 20.');
        }
        if (!is_null($n_lacre) && (mb_strlen($n_lacre) < 1)) {
            throw new \InvalidArgumentException('invalid length for $n_lacre when calling CteSimpSefazLacreSimp., must be bigger than or equal to 1.');
        }
