...
/**
 * CteSimpSefazNatCargaSimp Class Doc Comment
 *
 * @category Class
 ...
 */
class CteSimpSefazNatCargaSimp implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CteSimpSefazNatCargaSimp';
    ...
    */
    ...
    public function setXDime($x_dime)
    {
        ...
        if (!is_null($x_dime) && (mb_strlen($x_dime) > 14)) {
            throw new \InvalidArgumentException('invalid length for $x_dime when calling CteSimpSefazNatCargaSimp., must be smaller than or equal to 14.');
        }
        if (!is_null($x_dime) && (mb_strlen($x_dime) < 5)) {
            throw new \InvalidArgumentException('invalid length for $x_dime when calling CteSimpSefazNatCargaSimp., must be bigger than or equal to 5.');
        }
