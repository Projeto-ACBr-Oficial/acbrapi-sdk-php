...
/**
 * CteSimpSefazFluxoSimp Class Doc Comment
 *
 * @category Class
 ...
 */
class CteSimpSefazFluxoSimp implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CteSimpSefazFluxoSimp';
    ...
    protected static $openAPITypes = [
        'x_orig' => 'string',
        'pass' => '\ACBrAPI\Model\CteSimpSefazPassSimp[]',
        'x_dest' => 'string',
        'x_rota' => 'string'
    ];
    ...
    */
    ...
    public function setXOrig($x_orig)
    {
        ...
        if (!is_null($x_orig) && (mb_strlen($x_orig) > 60)) {
            throw new \InvalidArgumentException('invalid length for $x_orig when calling CteSimpSefazFluxoSimp., must be smaller than or equal to 60.');
        }
        if (!is_null($x_orig) && (mb_strlen($x_orig) < 1)) {
            throw new \InvalidArgumentException('invalid length for $x_orig when calling CteSimpSefazFluxoSimp., must be bigger than or equal to 1.');
        }
     ...
     * Gets pass
     *
     * @return \ACBrAPI\Model\CteSimpSefazPassSimp[]|null
     */
     ...
     * Sets pass
     *
     * @param \ACBrAPI\Model\CteSimpSefazPassSimp[]|null $pass pass
     *
     * @return self
     */
    ...
    public function setXDest($x_dest)
    {
        ...
        if (!is_null($x_dest) && (mb_strlen($x_dest) > 60)) {
            throw new \InvalidArgumentException('invalid length for $x_dest when calling CteSimpSefazFluxoSimp., must be smaller than or equal to 60.');
        }
        if (!is_null($x_dest) && (mb_strlen($x_dest) < 1)) {
            throw new \InvalidArgumentException('invalid length for $x_dest when calling CteSimpSefazFluxoSimp., must be bigger than or equal to 1.');
        }
    ...
    public function setXRota($x_rota)
    {
        ...
        if (!is_null($x_rota) && (mb_strlen($x_rota) > 10)) {
            throw new \InvalidArgumentException('invalid length for $x_rota when calling CteSimpSefazFluxoSimp., must be smaller than or equal to 10.');
        }
        if (!is_null($x_rota) && (mb_strlen($x_rota) < 1)) {
            throw new \InvalidArgumentException('invalid length for $x_rota when calling CteSimpSefazFluxoSimp., must be bigger than or equal to 1.');
        }
