...
/**
 * CteSimpSefazPassSimp Class Doc Comment
 *
 * @category Class
 * @package  ACBrAPI
 * @author   OpenAPI Generator team
 ...
 */
class CteSimpSefazPassSimp implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CteSimpSefazPassSimp';
    ...
    */
    ...
    public function setXPass($x_pass)
    {
        ...
        if (!is_null($x_pass) && (mb_strlen($x_pass) > 15)) {
            throw new \InvalidArgumentException('invalid length for $x_pass when calling CteSimpSefazPassSimp., must be smaller than or equal to 15.');
        }
        if (!is_null($x_pass) && (mb_strlen($x_pass) < 1)) {
            throw new \InvalidArgumentException('invalid length for $x_pass when calling CteSimpSefazPassSimp., must be bigger than or equal to 1.');
        }
