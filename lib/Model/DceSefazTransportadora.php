...
/**
 * DceSefazTransportadora Class Doc Comment
 *
 * @category Class
 ...
 */
class DceSefazTransportadora implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'DceSefazTransportadora';
    ...
    */
     ...
     * Sets cnpj
     *
     * @param string $cnpj Número do CNPJ da Transportadora.
     *
     * @return self
     */
     ...
     * Sets x_nome
     *
     * @param string $x_nome Razão Social ou Nome da Transportadora.
     *
     * @return self
     */
    public function setXNome($x_nome)
    {
        ...
        if (!is_null($x_nome) && (mb_strlen($x_nome) > 60)) {
            throw new \InvalidArgumentException('invalid length for $x_nome when calling DceSefazTransportadora., must be smaller than or equal to 60.');
        }
        if (!is_null($x_nome) && (mb_strlen($x_nome) < 2)) {
            throw new \InvalidArgumentException('invalid length for $x_nome when calling DceSefazTransportadora., must be bigger than or equal to 2.');
        }
