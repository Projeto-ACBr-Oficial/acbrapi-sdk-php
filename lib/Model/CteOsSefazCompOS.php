...
/**
 * CteOsSefazCompOS Class Doc Comment
 *
 * @category Class
 ...
 */
class CteOsSefazCompOS implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CteOsSefazCompOS';
    ...
    */
    ...
    public function setXNome($x_nome)
    {
        ...
        if (!is_null($x_nome) && (mb_strlen($x_nome) > 15)) {
            throw new \InvalidArgumentException('invalid length for $x_nome when calling CteOsSefazCompOS., must be smaller than or equal to 15.');
        }
        if (!is_null($x_nome) && (mb_strlen($x_nome) < 1)) {
            throw new \InvalidArgumentException('invalid length for $x_nome when calling CteOsSefazCompOS., must be bigger than or equal to 1.');
        }
    ...
    public function setVComp($v_comp)
    {
        ...
        if (!is_null($v_comp) && ($v_comp < 0)) {
            throw new \InvalidArgumentException('invalid value for $v_comp when calling CteOsSefazCompOS., must be bigger than or equal to 0.');
        }
