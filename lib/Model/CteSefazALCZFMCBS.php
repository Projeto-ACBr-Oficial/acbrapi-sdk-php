...
/**
 * CteSefazALCZFMCBS Class Doc Comment
 *
 * @category Class
 ...
 */
class CteSefazALCZFMCBS implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CteSefazALCZFMCBS';
    ...
    */
    ...
    public function setPAliqEfetRegCbs($p_aliq_efet_reg_cbs)
    {
        ...
        if (!is_null($p_aliq_efet_reg_cbs) && ($p_aliq_efet_reg_cbs < 0)) {
            throw new \InvalidArgumentException('invalid value for $p_aliq_efet_reg_cbs when calling CteSefazALCZFMCBS., must be bigger than or equal to 0.');
        }
    ...
    public function setVTribRegCbs($v_trib_reg_cbs)
    {
        ...
        if (!is_null($v_trib_reg_cbs) && ($v_trib_reg_cbs < 0)) {
            throw new \InvalidArgumentException('invalid value for $v_trib_reg_cbs when calling CteSefazALCZFMCBS., must be bigger than or equal to 0.');
        }
