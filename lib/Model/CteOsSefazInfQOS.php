...
/**
 * CteOsSefazInfQOS Class Doc Comment
 *
 * @category Class
 * @description Informações de quantidades da Carga do CT-e.  Para Transporte de Pessoas indicar número de passageiros, para excesso de bagagem e transporte de valores indicar número de Volumes/Malotes.
 * @package  ACBrAPI
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class CteOsSefazInfQOS implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CteOsSefazInfQOS';
    ...
    */
    ...
    public function setQCarga($q_carga)
    {
        ...
        if (!is_null($q_carga) && ($q_carga < 0)) {
            throw new \InvalidArgumentException('invalid value for $q_carga when calling CteOsSefazInfQOS., must be bigger than or equal to 0.');
        }
