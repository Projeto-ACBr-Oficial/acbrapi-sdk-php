...
/**
 * CteSimpSefazTarifaSimp Class Doc Comment
 *
 * @category Class
 ...
 */
class CteSimpSefazTarifaSimp implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CteSimpSefazTarifaSimp';
    ...
    */
    ...
    public function setCl($cl)
    {
        ...
        if (!is_null($cl) && (mb_strlen($cl) > 1)) {
            throw new \InvalidArgumentException('invalid length for $cl when calling CteSimpSefazTarifaSimp., must be smaller than or equal to 1.');
        }
    ...
    public function setCTar($c_tar)
    {
        ...
        if (!is_null($c_tar) && (mb_strlen($c_tar) > 4)) {
            throw new \InvalidArgumentException('invalid length for $c_tar when calling CteSimpSefazTarifaSimp., must be smaller than or equal to 4.');
        }
        if (!is_null($c_tar) && (mb_strlen($c_tar) < 1)) {
            throw new \InvalidArgumentException('invalid length for $c_tar when calling CteSimpSefazTarifaSimp., must be bigger than or equal to 1.');
        }
    ...
    public function setVTar($v_tar)
    {
        ...
        if (!is_null($v_tar) && ($v_tar < 0)) {
            throw new \InvalidArgumentException('invalid value for $v_tar when calling CteSimpSefazTarifaSimp., must be bigger than or equal to 0.');
        }
