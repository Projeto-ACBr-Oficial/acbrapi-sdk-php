...
/**
 * NfcomSefazDevTrib Class Doc Comment
 *
 * @category Class
 ...
 */
class NfcomSefazDevTrib implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'NfcomSefazDevTrib';
    ...
    */
    ...
    public function setPDevTrib($p_dev_trib)
    {
        ...
        if (!is_null($p_dev_trib) && ($p_dev_trib < 0)) {
            throw new \InvalidArgumentException('invalid value for $p_dev_trib when calling NfcomSefazDevTrib., must be bigger than or equal to 0.');
        }
    ...
    public function setVDevTrib($v_dev_trib)
    {
        ...
        if (!is_null($v_dev_trib) && ($v_dev_trib < 0)) {
            throw new \InvalidArgumentException('invalid value for $v_dev_trib when calling NfcomSefazDevTrib., must be bigger than or equal to 0.');
        }
