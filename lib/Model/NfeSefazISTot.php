...
/**
 * NfeSefazISTot Class Doc Comment
 *
 * @category Class
 ...
 */
class NfeSefazISTot implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'NfeSefazISTot';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['v_is'] === null) {
            $invalidProperties[] = "'v_is' can't be null";
        }
        if (($this->container['v_is'] < 0)) {
     ...
     * Sets v_is
     *
     * @param float $v_is Valor Total do Imposto Seletivo.
     *
     * @return self
     */
    public function setVIs($v_is)
    {
        ...
        if (!is_null($v_is) && ($v_is < 0)) {
            throw new \InvalidArgumentException('invalid value for $v_is when calling NfeSefazISTot., must be bigger than or equal to 0.');
        }
