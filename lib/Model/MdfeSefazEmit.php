...
class MdfeSefazEmit implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'x_nome' => 'string',
        'x_fant' => 'string',
        'ender_emit' => '\ACBrAPI\Model\MdfeSefazEndeEmi'
    ];
    ...
    */
     ...
     * Sets cpf
     *
     * @param string|null $cpf CPF do emitente.  Informar zeros não significativos.  Usar com série específica 920-969 para emitente pessoa física com inscrição estadual.  Poderá ser usado também para emissão do Regime Especial da Nota Fiscal Fácil.    ***Obrigatório caso o emitente seja pessoa física***.
     *
     * @return self
     */
     ...
     * Gets ender_emit
     *
     * @return \ACBrAPI\Model\MdfeSefazEndeEmi|null
     */
     ...
     * Sets ender_emit
     *
     * @param \ACBrAPI\Model\MdfeSefazEndeEmi|null $ender_emit ender_emit
     *
     * @return self
     */
