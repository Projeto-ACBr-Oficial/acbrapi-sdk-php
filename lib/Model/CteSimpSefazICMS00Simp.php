...
/**
 * CteSimpSefazICMS00Simp Class Doc Comment
 *
 * @category Class
 ...
 */
class CteSimpSefazICMS00Simp implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CteSimpSefazICMS00Simp';
    ...
    */
    ...
    public function setVBc($v_bc)
    {
        ...
        if (!is_null($v_bc) && ($v_bc < 0)) {
            throw new \InvalidArgumentException('invalid value for $v_bc when calling CteSimpSefazICMS00Simp., must be bigger than or equal to 0.');
        }
    ...
    public function setPIcms($p_icms)
    {
        ...
        if (!is_null($p_icms) && ($p_icms < 0)) {
            throw new \InvalidArgumentException('invalid value for $p_icms when calling CteSimpSefazICMS00Simp., must be bigger than or equal to 0.');
        }
    ...
    public function setVIcms($v_icms)
    {
        ...
        if (!is_null($v_icms) && ($v_icms < 0)) {
            throw new \InvalidArgumentException('invalid value for $v_icms when calling CteSimpSefazICMS00Simp., must be bigger than or equal to 0.');
        }
