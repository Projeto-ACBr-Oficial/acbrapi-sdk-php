...
class CtePedidoEmissao implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'inf_cte' => '\ACBrAPI\Model\CteSefazInfCte',
        'inf_cte_supl' => '\ACBrAPI\Model\CteSefazInfCTeSupl',
        'ambiente' => 'string',
        'referencia' => 'string'
    ];
    ...
    */
     ...
     * Gets inf_cte
     *
     * @return \ACBrAPI\Model\CteSefazInfCte
     */
     ...
     * Sets inf_cte
     *
     * @param \ACBrAPI\Model\CteSefazInfCte $inf_cte inf_cte
     *
     * @return self
     */
     ...
     * Gets inf_cte_supl
     *
     * @return \ACBrAPI\Model\CteSefazInfCTeSupl|null
     */
     ...
     * Sets inf_cte_supl
     *
     * @param \ACBrAPI\Model\CteSefazInfCTeSupl|null $inf_cte_supl inf_cte_supl
     *
     * @return self
     */
    ...
    public function setReferencia($referencia)
    {
        ...
        if (!is_null($referencia) && (mb_strlen($referencia) > 50)) {
            throw new \InvalidArgumentException('invalid length for $referencia when calling CtePedidoEmissao., must be smaller than or equal to 50.');
        }
