...
/**
 * CteSimpSefazBalsaSimp Class Doc Comment
 *
 * @category Class
 ...
 */
class CteSimpSefazBalsaSimp implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CteSimpSefazBalsaSimp';
    ...
    */
    ...
    public function setXBalsa($x_balsa)
    {
        ...
        if (!is_null($x_balsa) && (mb_strlen($x_balsa) > 60)) {
            throw new \InvalidArgumentException('invalid length for $x_balsa when calling CteSimpSefazBalsaSimp., must be smaller than or equal to 60.');
        }
        if (!is_null($x_balsa) && (mb_strlen($x_balsa) < 1)) {
            throw new \InvalidArgumentException('invalid length for $x_balsa when calling CteSimpSefazBalsaSimp., must be bigger than or equal to 1.');
        }
