...
/**
 * NfcomSefazDest Class Doc Comment
 *
 * @category Class
 ...
 */
class NfcomSefazDest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'NfcomSefazDest';
    ...
    protected static $openAPITypes = [
        ...
        'ie' => 'string',
        'im' => 'string',
        'ender_dest' => '\ACBrAPI\Model\NfcomSefazEndeDest'
    ];
    ...
    */
    ...
    public function setXNome($x_nome)
    {
        ...
        if (!is_null($x_nome) && (mb_strlen($x_nome) > 60)) {
            throw new \InvalidArgumentException('invalid length for $x_nome when calling NfcomSefazDest., must be smaller than or equal to 60.');
        }
        if (!is_null($x_nome) && (mb_strlen($x_nome) < 2)) {
            throw new \InvalidArgumentException('invalid length for $x_nome when calling NfcomSefazDest., must be bigger than or equal to 2.');
        }
    ...
    public function setIdOutros($id_outros)
    {
        ...
        if (!is_null($id_outros) && (mb_strlen($id_outros) > 20)) {
            throw new \InvalidArgumentException('invalid length for $id_outros when calling NfcomSefazDest., must be smaller than or equal to 20.');
        }
        if (!is_null($id_outros) && (mb_strlen($id_outros) < 2)) {
            throw new \InvalidArgumentException('invalid length for $id_outros when calling NfcomSefazDest., must be bigger than or equal to 2.');
        }
     ...
     * Sets ind_ie_dest
     *
     * @param int $ind_ie_dest Indicador da IE do Destinatário.  * 1 - Contribuinte ICMS (informar a IE do destinatário)  * 2 - Contribuinte isento de Inscrição no cadastro de Contribuintes do ICMS  * 9 - Não Contribuinte, que pode ou não possuir Inscrição Estadual no Cadastro de Contribuintes do ICMS  Nota: No caso de Contribuinte Isento de Inscrição (indIEDest=2) informar a tag IE do destinatário com o literal ISENTO.
     *
     * @return self
     */
     ...
     * Sets ie
     *
     * @param string|null $ie Inscrição Estadual do destinatário.
     *
     * @return self
     */
    ...
    public function setIm($im)
    {
        ...
        if (!is_null($im) && (mb_strlen($im) > 15)) {
            throw new \InvalidArgumentException('invalid length for $im when calling NfcomSefazDest., must be smaller than or equal to 15.');
        }
        if (!is_null($im) && (mb_strlen($im) < 1)) {
            throw new \InvalidArgumentException('invalid length for $im when calling NfcomSefazDest., must be bigger than or equal to 1.');
        }
     ...
     * Gets ender_dest
     *
     * @return \ACBrAPI\Model\NfcomSefazEndeDest
     */
     ...
     * Sets ender_dest
     *
     * @param \ACBrAPI\Model\NfcomSefazEndeDest $ender_dest ender_dest
     *
     * @return self
     */
