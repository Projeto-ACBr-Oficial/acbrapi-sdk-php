 ...
 */
class DceSefazDet implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'DceSefazDet';
    ...
    protected static $openAPITypes = [
        'n_item' => 'int',
        'prod' => '\ACBrAPI\Model\DceSefazProd',
        'inf_ad_prod' => 'string'
    ];
    ...
    */
     ...
     * Sets n_item
     *
     * @param int $n_item Número do item da DCe.
     *
     * @return self
     */
    public function setNItem($n_item)
    {
        ...
        if (!is_null($n_item) && ($n_item > 9999)) {
            throw new \InvalidArgumentException('invalid value for $n_item when calling DceSefazDet., must be smaller than or equal to 9999.');
        }
        if (!is_null($n_item) && ($n_item < 1)) {
            throw new \InvalidArgumentException('invalid value for $n_item when calling DceSefazDet., must be bigger than or equal to 1.');
        }
     ...
     * Gets prod
     *
     * @return \ACBrAPI\Model\DceSefazProd
     */
     ...
     * Sets prod
     *
     * @param \ACBrAPI\Model\DceSefazProd $prod prod
     *
     * @return self
     */
     ...
     * Sets inf_ad_prod
     *
     * @param string|null $inf_ad_prod Informações adicionais do item.
     *
     * @return self
     */
    public function setInfAdProd($inf_ad_prod)
    {
        ...
        if (!is_null($inf_ad_prod) && (mb_strlen($inf_ad_prod) > 500)) {
            throw new \InvalidArgumentException('invalid length for $inf_ad_prod when calling DceSefazDet., must be smaller than or equal to 500.');
        }
        if (!is_null($inf_ad_prod) && (mb_strlen($inf_ad_prod) < 1)) {
            throw new \InvalidArgumentException('invalid length for $inf_ad_prod when calling DceSefazDet., must be bigger than or equal to 1.');
        }
