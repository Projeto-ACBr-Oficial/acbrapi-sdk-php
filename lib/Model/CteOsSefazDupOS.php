...
/**
 * CteOsSefazDupOS Class Doc Comment
 *
 * @category Class
 ...
 */
class CteOsSefazDupOS implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CteOsSefazDupOS';
    ...
    */
    ...
    public function setNDup($n_dup)
    {
        ...
        if (!is_null($n_dup) && (mb_strlen($n_dup) > 60)) {
            throw new \InvalidArgumentException('invalid length for $n_dup when calling CteOsSefazDupOS., must be smaller than or equal to 60.');
        }
        if (!is_null($n_dup) && (mb_strlen($n_dup) < 1)) {
            throw new \InvalidArgumentException('invalid length for $n_dup when calling CteOsSefazDupOS., must be bigger than or equal to 1.');
        }
    ...
    public function setVDup($v_dup)
    {
        ...
        if (!is_null($v_dup) && ($v_dup <= 0)) {
            throw new \InvalidArgumentException('invalid value for $v_dup when calling CteOsSefazDupOS., must be bigger than 0.');
        }
