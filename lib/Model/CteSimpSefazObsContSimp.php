...
/**
 * CteSimpSefazObsContSimp Class Doc Comment
 *
 * @category Class
 ...
 */
class CteSimpSefazObsContSimp implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CteSimpSefazObsContSimp';
    ...
    */
    ...
    public function setXCampo($x_campo)
    {
        ...
        if (!is_null($x_campo) && (mb_strlen($x_campo) > 20)) {
            throw new \InvalidArgumentException('invalid length for $x_campo when calling CteSimpSefazObsContSimp., must be smaller than or equal to 20.');
        }
        if (!is_null($x_campo) && (mb_strlen($x_campo) < 1)) {
            throw new \InvalidArgumentException('invalid length for $x_campo when calling CteSimpSefazObsContSimp., must be bigger than or equal to 1.');
        }
    ...
    public function setXTexto($x_texto)
    {
        ...
        if (!is_null($x_texto) && (mb_strlen($x_texto) > 160)) {
            throw new \InvalidArgumentException('invalid length for $x_texto when calling CteSimpSefazObsContSimp., must be smaller than or equal to 160.');
        }
        if (!is_null($x_texto) && (mb_strlen($x_texto) < 1)) {
            throw new \InvalidArgumentException('invalid length for $x_texto when calling CteSimpSefazObsContSimp., must be bigger than or equal to 1.');
        }
