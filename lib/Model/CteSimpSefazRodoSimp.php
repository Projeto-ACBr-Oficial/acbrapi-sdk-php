...
/**
 * CteSimpSefazRodoSimp Class Doc Comment
 *
 * @category Class
 ...
 */
class CteSimpSefazRodoSimp implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CteSimpSefazRodoSimp';
    ...
    protected static $openAPITypes = [
        'rntrc' => 'string',
        'occ' => '\ACBrAPI\Model\CteSimpSefazOccSimp[]'
    ];
    ...
    */
     ...
     * Gets occ
     *
     * @return \ACBrAPI\Model\CteSimpSefazOccSimp[]|null
     */
     ...
     * Sets occ
     *
     * @param \ACBrAPI\Model\CteSimpSefazOccSimp[]|null $occ occ
     *
     * @return self
     */
    public function setOcc($occ)
    {
        ...
        if ((count($occ) > 10)) {
            throw new \InvalidArgumentException('invalid value for $occ when calling CteSimpSefazRodoSimp., number of items must be less than or equal to 10.');
        }
