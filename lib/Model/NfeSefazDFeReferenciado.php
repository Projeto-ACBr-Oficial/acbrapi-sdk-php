...
/**
 * NfeSefazDFeReferenciado Class Doc Comment
 *
 * @category Class
 ...
 */
class NfeSefazDFeReferenciado implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'NfeSefazDFeReferenciado';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ((mb_strlen($this->container['chave_acesso']) > 44)) {
            $invalidProperties[] = "invalid value for 'chave_acesso', the character length must be smaller than or equal to 44.";
        }

        if (!is_null($this->container['n_item']) && ($this->container['n_item'] > 990)) {
            $invalidProperties[] = "invalid value for 'n_item', must be smaller than or equal to 990.";
        }

        if (!is_null($this->container['n_item']) && ($this->container['n_item'] < 1)) {
     ...
     * Sets chave_acesso
     *
     * @param string $chave_acesso Chave de Acesso do DFe referenciado.
     *
     * @return self
     */
    public function setChaveAcesso($chave_acesso)
    {
        ...
        if (!is_null($chave_acesso) && (mb_strlen($chave_acesso) > 44)) {
            throw new \InvalidArgumentException('invalid length for $chave_acesso when calling NfeSefazDFeReferenciado., must be smaller than or equal to 44.');
        }
     ...
     * Sets n_item
     *
     * @param int|null $n_item Número do item do documento referenciado. Corresponde ao atributo nItem do elemento det do documento original.
     *
     * @return self
     */
    public function setNItem($n_item)
    {
        ...
        if (!is_null($n_item) && ($n_item > 990)) {
            throw new \InvalidArgumentException('invalid value for $n_item when calling NfeSefazDFeReferenciado., must be smaller than or equal to 990.');
        }
        if (!is_null($n_item) && ($n_item < 1)) {
            throw new \InvalidArgumentException('invalid value for $n_item when calling NfeSefazDFeReferenciado., must be bigger than or equal to 1.');
        }
