...
/**
 * CteOsInfCorrecao Class Doc Comment
 *
 * @category Class
 * @package  ACBrAPI
 * @author   OpenAPI Generator team
 ...
 */
class CteOsInfCorrecao implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CteOsInfCorrecao';
    ...
    */
    ...
    public function setGrupoAlterado($grupo_alterado)
    {
        ...
        if ((mb_strlen($grupo_alterado) > 20)) {
            throw new \InvalidArgumentException('invalid length for $grupo_alterado when calling CteOsInfCorrecao., must be smaller than or equal to 20.');
        }
        if ((mb_strlen($grupo_alterado) < 1)) {
            throw new \InvalidArgumentException('invalid length for $grupo_alterado when calling CteOsInfCorrecao., must be bigger than or equal to 1.');
        }
     ...
     * Sets campo_alterado
     *
     * @param string $campo_alterado Nome do campo modificado do CT-e OS Original.
     *
     * @return self
     */
    public function setCampoAlterado($campo_alterado)
    {
        ...
        if ((mb_strlen($campo_alterado) > 20)) {
            throw new \InvalidArgumentException('invalid length for $campo_alterado when calling CteOsInfCorrecao., must be smaller than or equal to 20.');
        }
        if ((mb_strlen($campo_alterado) < 1)) {
            throw new \InvalidArgumentException('invalid length for $campo_alterado when calling CteOsInfCorrecao., must be bigger than or equal to 1.');
        }
    ...
    public function setValorAlterado($valor_alterado)
    {
        ...
        if ((mb_strlen($valor_alterado) > 500)) {
            throw new \InvalidArgumentException('invalid length for $valor_alterado when calling CteOsInfCorrecao., must be smaller than or equal to 500.');
        }
        if ((mb_strlen($valor_alterado) < 1)) {
            throw new \InvalidArgumentException('invalid length for $valor_alterado when calling CteOsInfCorrecao., must be bigger than or equal to 1.');
        }
