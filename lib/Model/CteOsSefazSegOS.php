...
/**
 * CteOsSefazSegOS Class Doc Comment
 *
 * @category Class
 ...
 */
class CteOsSefazSegOS implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CteOsSefazSegOS';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['x_seg']) && (mb_strlen($this->container['x_seg']) > 30)) {
            $invalidProperties[] = "invalid value for 'x_seg', the character length must be smaller than or equal to 30.";
        }

        if (!is_null($this->container['x_seg']) && (mb_strlen($this->container['x_seg']) < 1)) {
     ...
     * Sets resp_seg
     *
     * @param int $resp_seg Responsável pelo seguro.  Preencher com:  * 4 - Emitente do CT-e  * 5 - Tomador de Serviço
     *
     * @return self
     */
     ...
     * Sets x_seg
     *
     * @param string|null $x_seg Nome da Seguradora.
     *
     * @return self
     */
    public function setXSeg($x_seg)
    {
        ...
        if (!is_null($x_seg) && (mb_strlen($x_seg) > 30)) {
            throw new \InvalidArgumentException('invalid length for $x_seg when calling CteOsSefazSegOS., must be smaller than or equal to 30.');
        }
        if (!is_null($x_seg) && (mb_strlen($x_seg) < 1)) {
            throw new \InvalidArgumentException('invalid length for $x_seg when calling CteOsSefazSegOS., must be bigger than or equal to 1.');
        }
    ...
    public function setNApol($n_apol)
    {
        ...
        if (!is_null($n_apol) && (mb_strlen($n_apol) > 20)) {
            throw new \InvalidArgumentException('invalid length for $n_apol when calling CteOsSefazSegOS., must be smaller than or equal to 20.');
        }
        if (!is_null($n_apol) && (mb_strlen($n_apol) < 1)) {
            throw new \InvalidArgumentException('invalid length for $n_apol when calling CteOsSefazSegOS., must be bigger than or equal to 1.');
        }
