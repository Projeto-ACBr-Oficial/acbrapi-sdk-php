...
/**
 * CteSimpSefazTrafMutSimp Class Doc Comment
 *
 * @category Class
 ...
 */
class CteSimpSefazTrafMutSimp implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CteSimpSefazTrafMutSimp';
    ...
    protected static $openAPITypes = [
        ...
        'ferro_env' => '\ACBrAPI\Model\CteSimpSefazFerroEnvSimp[]'
    ];
    ...
    */
    ...
    public function setVFrete($v_frete)
    {
        ...
        if (!is_null($v_frete) && ($v_frete < 0)) {
            throw new \InvalidArgumentException('invalid value for $v_frete when calling CteSimpSefazTrafMutSimp., must be bigger than or equal to 0.');
        }
    ...
    public function setChCteFerroOrigem($ch_cte_ferro_origem)
    {
        ...
        if (!is_null($ch_cte_ferro_origem) && (mb_strlen($ch_cte_ferro_origem) > 44)) {
            throw new \InvalidArgumentException('invalid length for $ch_cte_ferro_origem when calling CteSimpSefazTrafMutSimp., must be smaller than or equal to 44.');
        }
     ...
     * Gets ferro_env
     *
     * @return \ACBrAPI\Model\CteSimpSefazFerroEnvSimp[]|null
     */
     ...
     * Sets ferro_env
     *
     * @param \ACBrAPI\Model\CteSimpSefazFerroEnvSimp[]|null $ferro_env ferro_env
     *
     * @return self
     */
