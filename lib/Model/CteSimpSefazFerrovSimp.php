...
/**
 * CteSimpSefazFerrovSimp Class Doc Comment
 *
 * @category Class
 ...
 */
class CteSimpSefazFerrovSimp implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CteSimpSefazFerrovSimp';
    ...
    protected static $openAPITypes = [
        'tp_traf' => 'int',
        'traf_mut' => '\ACBrAPI\Model\CteSimpSefazTrafMutSimp',
        'fluxo' => 'string'
    ];
    ...
    */
     ...
     * Gets traf_mut
     *
     * @return \ACBrAPI\Model\CteSimpSefazTrafMutSimp|null
     */
     ...
     * Sets traf_mut
     *
     * @param \ACBrAPI\Model\CteSimpSefazTrafMutSimp|null $traf_mut traf_mut
     *
     * @return self
     */
    ...
    public function setFluxo($fluxo)
    {
        ...
        if (!is_null($fluxo) && (mb_strlen($fluxo) > 10)) {
            throw new \InvalidArgumentException('invalid length for $fluxo when calling CteSimpSefazFerrovSimp., must be smaller than or equal to 10.');
        }
        if (!is_null($fluxo) && (mb_strlen($fluxo) < 1)) {
            throw new \InvalidArgumentException('invalid length for $fluxo when calling CteSimpSefazFerrovSimp., must be bigger than or equal to 1.');
        }
