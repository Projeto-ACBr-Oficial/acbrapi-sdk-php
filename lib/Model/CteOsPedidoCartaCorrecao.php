...
/**
 * CteOsPedidoCartaCorrecao Class Doc Comment
 *
 * @category Class
 * @package  ACBrAPI
 * @author   OpenAPI Generator team
 ...
 */
class CteOsPedidoCartaCorrecao implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CteOsPedidoCartaCorrecao';
    ...
    protected static $openAPITypes = [
        'correcoes' => '\ACBrAPI\Model\CteOsInfCorrecao[]'
    ];
    ...
    */
     ...
     * Gets correcoes
     *
     * @return \ACBrAPI\Model\CteOsInfCorrecao[]
     */
     ...
     * Sets correcoes
     *
     * @param \ACBrAPI\Model\CteOsInfCorrecao[] $correcoes Grupo de Informações de Correção.
     *
     * @return self
     */
    public function setCorrecoes($correcoes)
    {
        ...
        if ((count($correcoes) < 1)) {
            throw new \InvalidArgumentException('invalid length for $correcoes when calling CteOsPedidoCartaCorrecao., number of items must be greater than or equal to 1.');
        }
