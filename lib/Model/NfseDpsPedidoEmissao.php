    ...
    */
    ...
    public function setReferencia($referencia)
    {
        ...
        if (!is_null($referencia) && (mb_strlen($referencia) > 50)) {
            throw new \InvalidArgumentException('invalid length for $referencia when calling NfseDpsPedidoEmissao., must be smaller than or equal to 50.');
        }
     ...
     * Sets inf_dps
     *
     * @param \ACBrAPI\Model\InfDPS $inf_dps inf_dps
     *
     * @return self
     */
