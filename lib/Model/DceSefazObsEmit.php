...
/**
 * DceSefazObsEmit Class Doc Comment
 *
 * @category Class
 * @description Grupo Campo de uso livre do Emitente.  Informar o nome do campo no atributo xCampo e o conteúdo do campo no xTexto.
 * @package  ACBrAPI
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class DceSefazObsEmit implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'DceSefazObsEmit';
    ...
    */
    ...
    public function setXTexto($x_texto)
    {
        ...
        if (!is_null($x_texto) && (mb_strlen($x_texto) > 60)) {
            throw new \InvalidArgumentException('invalid length for $x_texto when calling DceSefazObsEmit., must be smaller than or equal to 60.');
        }
        if (!is_null($x_texto) && (mb_strlen($x_texto) < 1)) {
            throw new \InvalidArgumentException('invalid length for $x_texto when calling DceSefazObsEmit., must be bigger than or equal to 1.');
        }
