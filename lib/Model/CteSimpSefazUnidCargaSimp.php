...
/**
 * CteSimpSefazUnidCargaSimp Class Doc Comment
 *
 * @category Class
 ...
 */
class CteSimpSefazUnidCargaSimp implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CteSimpSefazUnidCargaSimp';
    ...
    protected static $openAPITypes = [
        ...
        'lac_unid_carga' => '\ACBrAPI\Model\CteSimpSefazLacUnidCargaSimp[]',
        'qtd_rat' => 'float'
    ];
    ...
    */
    ...
    public function setIdUnidCarga($id_unid_carga)
    {
        ...
        if (!is_null($id_unid_carga) && (mb_strlen($id_unid_carga) > 20)) {
            throw new \InvalidArgumentException('invalid length for $id_unid_carga when calling CteSimpSefazUnidCargaSimp., must be smaller than or equal to 20.');
        }
        if (!is_null($id_unid_carga) && (mb_strlen($id_unid_carga) < 1)) {
            throw new \InvalidArgumentException('invalid length for $id_unid_carga when calling CteSimpSefazUnidCargaSimp., must be bigger than or equal to 1.');
        }
     ...
     * Gets lac_unid_carga
     *
     * @return \ACBrAPI\Model\CteSimpSefazLacUnidCargaSimp[]|null
     */
     ...
     * Sets lac_unid_carga
     *
     * @param \ACBrAPI\Model\CteSimpSefazLacUnidCargaSimp[]|null $lac_unid_carga lac_unid_carga
     *
     * @return self
     */
    ...
    public function setQtdRat($qtd_rat)
    {
        ...
        if (!is_null($qtd_rat) && ($qtd_rat < 0)) {
            throw new \InvalidArgumentException('invalid value for $qtd_rat when calling CteSimpSefazUnidCargaSimp., must be bigger than or equal to 0.');
        }
