...
class MdfeSefazIde implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'uf_ini' => 'string',
        'uf_fim' => 'string',
        'inf_mun_carrega' => '\ACBrAPI\Model\MdfeSefazInfMunCarrega[]',
        'inf_percurso' => '\ACBrAPI\Model\MdfeSefazInfPercurso[]',
    ...
    */
     ...
     * Sets proc_emi
     *
     * @param string $proc_emi Identificação do processo de emissão do Manifesto.  * 0 - emissão de MDFe com aplicativo do contribuinte  * 4 - emissão de MDFe por Provedor de Assinatura e Autorização - PAA
     *
     * @return self
     */
     ...
     *
     * @return \ACBrAPI\Model\MdfeSefazInfMunCarrega[]
     */
     ...
     *
     * @param \ACBrAPI\Model\MdfeSefazInfMunCarrega[] $inf_mun_carrega inf_mun_carrega
     *
     * @return self
     */
     ...
     * Gets inf_percurso
     *
     * @return \ACBrAPI\Model\MdfeSefazInfPercurso[]|null
     */
     ...
     * Sets inf_percurso
     *
     * @param \ACBrAPI\Model\MdfeSefazInfPercurso[]|null $inf_percurso inf_percurso
     *
     * @return self
     */
