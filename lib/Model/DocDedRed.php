...
class DocDedRed implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'ch_nfse' => 'string',
        'ch_nfe' => 'string',
        'nfse_mun' => '\ACBrAPI\Model\DocOutNFSe',
        'nfnfs' => '\ACBrAPI\Model\DocNFNFS',
        'n_doc_fisc' => 'string',
        'n_doc' => 'string',
        'tp_ded_red' => 'int',
        ...
        'fornec' => '\ACBrAPI\Model\InfoFornecDocDedRed'
    ];
    ...
    */
     ...
     * Gets nfse_mun
     *
     * @return \ACBrAPI\Model\DocOutNFSe|null
     */
     ...
     * Sets nfse_mun
     *
     * @param \ACBrAPI\Model\DocOutNFSe|null $nfse_mun nfse_mun
     *
     * @return self
     */
     ...
     * Gets nfnfs
     *
     * @return \ACBrAPI\Model\DocNFNFS|null
     */
     ...
     * Sets nfnfs
     *
     * @param \ACBrAPI\Model\DocNFNFS|null $nfnfs nfnfs
     *
     * @return self
     */
     ...
     * Sets tp_ded_red
     *
     * @param int $tp_ded_red Identificação da Dedução/Redução:  * 1 - Alimentação e bebidas/frigobar  * 2 - Materiais  * 3 - Produção Externa  * 4 - Reembolso de despesas  * 5 - Repasse consorciado  * 6 - Repasse plano de saúde  * 7 - Serviços  * 8 - Subempreitada de mão de obra  * 9 - Profissional parceiro  * 99 - Outras deduções
     *
     * @return self
     */
     ...
     * Gets fornec
     *
     * @return \ACBrAPI\Model\InfoFornecDocDedRed|null
     */
     ...
     * Sets fornec
     *
     * @param \ACBrAPI\Model\InfoFornecDocDedRed|null $fornec fornec
     *
     * @return self
     */
