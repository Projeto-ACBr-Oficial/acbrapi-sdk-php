...
/**
 * MdfeSefazInfNFePrestParcial Class Doc Comment
 *
 * @category Class
 ...
 */
class MdfeSefazInfNFePrestParcial implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'MdfeSefazInfNFePrestParcial';
    ...
    */
    ...
    public function setChNfe($ch_nfe)
    {
        ...
        if (!is_null($ch_nfe) && (mb_strlen($ch_nfe) > 44)) {
            throw new \InvalidArgumentException('invalid length for $ch_nfe when calling MdfeSefazInfNFePrestParcial., must be smaller than or equal to 44.');
        }
