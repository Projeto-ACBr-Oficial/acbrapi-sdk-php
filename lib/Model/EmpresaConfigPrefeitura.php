...
class EmpresaConfigPrefeitura implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['senha']) && (mb_strlen($this->container['senha']) > 255)) {
            $invalidProperties[] = "invalid value for 'senha', the character length must be smaller than or equal to 255.";
        }
    ...
    public function setLogin($login)
    {
        ...
        if ((mb_strlen($login) > 255)) {
            throw new \InvalidArgumentException('invalid length for $login when calling EmpresaConfigPrefeitura., must be smaller than or equal to 255.');
        }
    ...
    public function setSenha($senha)
    {
        ...
        if ((mb_strlen($senha) > 255)) {
            throw new \InvalidArgumentException('invalid length for $senha when calling EmpresaConfigPrefeitura., must be smaller than or equal to 255.');
        }
    ...
    public function setToken($token)
    {
        ...
        if ((mb_strlen($token) > 255)) {
            throw new \InvalidArgumentException('invalid length for $token when calling EmpresaConfigPrefeitura., must be smaller than or equal to 255.');
        }
