...
class CteSefazEmit implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'x_nome' => 'string',
        'x_fant' => 'string',
        'ender_emit' => '\ACBrAPI\Model\CteSefazEndeEmi',
        'crt' => 'int',
        'isuf_emit' => 'string'
    ];
    ...
    */
     ...
     * Gets ender_emit
     *
     * @return \ACBrAPI\Model\CteSefazEndeEmi|null
     */
     ...
     * Sets ender_emit
     *
     * @param \ACBrAPI\Model\CteSefazEndeEmi|null $ender_emit ender_emit
     *
     * @return self
     */
    ...
    public function setIsufEmit($isuf_emit)
    {
        ...
        if (!is_null($isuf_emit) && (mb_strlen($isuf_emit) > 9)) {
            throw new \InvalidArgumentException('invalid length for $isuf_emit when calling CteSefazEmit., must be smaller than or equal to 9.');
        }
        if (!is_null($isuf_emit) && (mb_strlen($isuf_emit) < 8)) {
            throw new \InvalidArgumentException('invalid length for $isuf_emit when calling CteSefazEmit., must be bigger than or equal to 8.');
        }
