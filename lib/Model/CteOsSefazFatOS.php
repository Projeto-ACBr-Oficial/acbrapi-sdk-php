...
/**
 * CteOsSefazFatOS Class Doc Comment
 *
 * @category Class
 ...
 */
class CteOsSefazFatOS implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CteOsSefazFatOS';
    ...
    */
    ...
    public function setNFat($n_fat)
    {
        ...
        if (!is_null($n_fat) && (mb_strlen($n_fat) > 60)) {
            throw new \InvalidArgumentException('invalid length for $n_fat when calling CteOsSefazFatOS., must be smaller than or equal to 60.');
        }
        if (!is_null($n_fat) && (mb_strlen($n_fat) < 1)) {
            throw new \InvalidArgumentException('invalid length for $n_fat when calling CteOsSefazFatOS., must be bigger than or equal to 1.');
        }
    ...
    public function setVOrig($v_orig)
    {
        ...
        if (!is_null($v_orig) && ($v_orig <= 0)) {
            throw new \InvalidArgumentException('invalid value for $v_orig when calling CteOsSefazFatOS., must be bigger than 0.');
        }
    ...
    public function setVDesc($v_desc)
    {
        ...
        if (!is_null($v_desc) && ($v_desc <= 0)) {
            throw new \InvalidArgumentException('invalid value for $v_desc when calling CteOsSefazFatOS., must be bigger than 0.');
        }
    ...
    public function setVLiq($v_liq)
    {
        ...
        if (!is_null($v_liq) && ($v_liq <= 0)) {
            throw new \InvalidArgumentException('invalid value for $v_liq when calling CteOsSefazFatOS., must be bigger than 0.');
        }
