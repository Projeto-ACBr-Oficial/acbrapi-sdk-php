...
/**
 * CteSimpSefazInfQSimp Class Doc Comment
 *
 * @category Class
 ...
 */
class CteSimpSefazInfQSimp implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CteSimpSefazInfQSimp';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ((mb_strlen($this->container['tp_med']) > 2)) {
            $invalidProperties[] = "invalid value for 'tp_med', the character length must be smaller than or equal to 2.";
        }
     ...
     * Sets tp_med
     *
     * @param string $tp_med Tipo da Medida.  Informar com:  * 00 - Cubagem da NF-e  * 01 - Cubagem Aferida pelo Transportador  * 02 - Peso Bruto da NF-e  * 03 - Peso Bruto Aferido pelo Transportador  * 04 - Peso Cubado  * 05 - Peso Base do Cálculo do Frete  * 06 - Peso para uso Operacional  * 07 - Caixas  * 08 - Paletes  * 09 - Sacas  * 10 - Containers  * 11 - Rolos  * 12 - Bombonas  * 13 - Latas  * 14 - Litragem  * 15 - Milhão de BTU (British Thermal Units)  * 99 - Outros
     *
     * @return self
     */
    public function setTpMed($tp_med)
    {
        ...
        if (!is_null($tp_med) && (mb_strlen($tp_med) > 2)) {
            throw new \InvalidArgumentException('invalid length for $tp_med when calling CteSimpSefazInfQSimp., must be smaller than or equal to 2.');
        }
        if (!is_null($tp_med) && (mb_strlen($tp_med) < 1)) {
            throw new \InvalidArgumentException('invalid length for $tp_med when calling CteSimpSefazInfQSimp., must be bigger than or equal to 1.');
        }
    ...
    public function setQCarga($q_carga)
    {
        ...
        if (!is_null($q_carga) && ($q_carga < 0)) {
            throw new \InvalidArgumentException('invalid value for $q_carga when calling CteSimpSefazInfQSimp., must be bigger than or equal to 0.');
        }
