...
class MdfeSefazComp implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets tp_comp
     *
     * @param string $tp_comp Tipo do Componente.  Preencher com:  * 01 - Vale Pedágio  * 02 - Impostos, taxas e contribuições  * 03 - Despesas (bancárias, meios de pagamento, outras)  * 04 - Frete  * 99 - Outros
     *
     * @return self
     */
    ...
    public function setVComp($v_comp)
    {
        ...
        if (!is_null($v_comp) && ($v_comp < 0)) {
            throw new \InvalidArgumentException('invalid value for $v_comp when calling MdfeSefazComp., must be bigger than or equal to 0.');
        }
