...
/**
 * CteOsSefazInfGTVeOS Class Doc Comment
 *
 * @category Class
 ...
 */
class CteOsSefazInfGTVeOS implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CteOsSefazInfGTVeOS';
    ...
    protected static $openAPITypes = [
        'ch_cte' => 'string',
        'comp' => '\ACBrAPI\Model\CteOsSefazInfGTVeCompOS[]'
    ];
    ...
    */
     ...
     * Sets ch_cte
     *
     * @param string $ch_cte Chave de acesso da GTV-e.
     *
     * @return self
     */
     ...
     * Gets comp
     *
     * @return \ACBrAPI\Model\CteOsSefazInfGTVeCompOS[]
     */
     ...
     * Sets comp
     *
     * @param \ACBrAPI\Model\CteOsSefazInfGTVeCompOS[] $comp comp
     *
     * @return self
     */
    public function setComp($comp)
    {
        ...
        if ((count($comp) < 1)) {
            throw new \InvalidArgumentException('invalid length for $comp when calling CteOsSefazInfGTVeOS., number of items must be greater than or equal to 1.');
        }
