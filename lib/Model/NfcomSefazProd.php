...
class NfcomSefazProd implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'ind_devolucao' => 'int',
        'cnpj_cobr_terc' => 'string',
        'g_pag_antecipado' => '\ACBrAPI\Model\NfcomSefazGPagAntecipado'
    ];
    ...
    protected static $setters = [
        ...
        'cnpj_cobr_terc' => 'setCnpjCobrTerc',
    ...
    protected static $getters = [
        ...
        'cnpj_cobr_terc' => 'getCnpjCobrTerc',
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('cnpj_cobr_terc', $data ?? [], null);
    ...
    */
     ...
     * @return string|null
     */
    public function getCnpjCobrTerc()
    {
        return $this->container['cnpj_cobr_terc'];
    }

    /**
     * Sets cnpj_cobr_terc
     *
     * @param string|null $cnpj_cobr_terc CNPJ de cobrança de terceiro.  Informar quando cClass do grupo 110 - Cobrança de terceiros.
     *
     * @return self
     */
    public function setCnpjCobrTerc($cnpj_cobr_terc)
    {
        if (is_null($cnpj_cobr_terc)) {
            array_push($this->openAPINullablesSetToNull, 'cnpj_cobr_terc');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('cnpj_cobr_terc', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['cnpj_cobr_terc'] = $cnpj_cobr_terc;
     ...
     *
     * @return \ACBrAPI\Model\NfcomSefazGPagAntecipado|null
     */
     ...
     *
     * @param \ACBrAPI\Model\NfcomSefazGPagAntecipado|null $g_pag_antecipado g_pag_antecipado
     *
     * @return self
     */
