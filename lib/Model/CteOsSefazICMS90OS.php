...
/**
 * CteOsSefazICMS90OS Class Doc Comment
 *
 * @category Class
 ...
 */
class CteOsSefazICMS90OS implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CteOsSefazICMS90OS';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['p_red_bc']) && ($this->container['p_red_bc'] <= 0)) {
            $invalidProperties[] = "invalid value for 'p_red_bc', must be bigger than 0.";
        }
     ...
     * Sets cst
     *
     * @param string $cst Classificação Tributária do Serviço.  * 90 - Outros
     *
     * @return self
     */
    ...
    public function setPRedBc($p_red_bc)
    {
        ...
        if (!is_null($p_red_bc) && ($p_red_bc <= 0)) {
            throw new \InvalidArgumentException('invalid value for $p_red_bc when calling CteOsSefazICMS90OS., must be bigger than 0.');
        }
    ...
    public function setVBc($v_bc)
    {
        ...
        if (!is_null($v_bc) && ($v_bc < 0)) {
            throw new \InvalidArgumentException('invalid value for $v_bc when calling CteOsSefazICMS90OS., must be bigger than or equal to 0.');
        }
    ...
    public function setPIcms($p_icms)
    {
        ...
        if (!is_null($p_icms) && ($p_icms < 0)) {
            throw new \InvalidArgumentException('invalid value for $p_icms when calling CteOsSefazICMS90OS., must be bigger than or equal to 0.');
        }
    ...
    public function setVIcms($v_icms)
    {
        ...
        if (!is_null($v_icms) && ($v_icms < 0)) {
            throw new \InvalidArgumentException('invalid value for $v_icms when calling CteOsSefazICMS90OS., must be bigger than or equal to 0.');
        }
    ...
    public function setVCred($v_cred)
    {
        ...
        if (!is_null($v_cred) && ($v_cred < 0)) {
            throw new \InvalidArgumentException('invalid value for $v_cred when calling CteOsSefazICMS90OS., must be bigger than or equal to 0.');
        }
    ...
    public function setVIcmsDeson($v_icms_deson)
    {
        ...
        if (!is_null($v_icms_deson) && ($v_icms_deson < 0)) {
            throw new \InvalidArgumentException('invalid value for $v_icms_deson when calling CteOsSefazICMS90OS., must be bigger than or equal to 0.');
        }
    ...
    public function setCBenef($c_benef)
    {
        ...
        if (!is_null($c_benef) && (mb_strlen($c_benef) > 10)) {
            throw new \InvalidArgumentException('invalid length for $c_benef when calling CteOsSefazICMS90OS., must be smaller than or equal to 10.');
        }
