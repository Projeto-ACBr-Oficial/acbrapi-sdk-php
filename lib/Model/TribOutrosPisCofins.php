...
class TribOutrosPisCofins implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     *
     * @param float|null $v_bc_pis_cofins Valor da Base de Cálculo do PIS/COFINS, relativo à apuração própria (R$).
     *
     * @return self
     */
     ...
     * Sets p_aliq_pis
     *
     * @param float|null $p_aliq_pis Alíquota do PIS, relativa à apuração própria (%%).
     *
     * @return self
     */
     ...
     * Sets p_aliq_cofins
     *
     * @param float|null $p_aliq_cofins Alíquota da COFINS, relativa à apuração própria (%%).
     *
     * @return self
     */
     ...
     * Sets v_pis
     *
     * @param float|null $v_pis Valor do débito de PIS apuração própria (R$).
     *
     * @return self
     */
     ...
     * Sets v_cofins
     *
     * @param float|null $v_cofins Valor do débito de COFINS apuração própria (R$).
     *
     * @return self
     */
