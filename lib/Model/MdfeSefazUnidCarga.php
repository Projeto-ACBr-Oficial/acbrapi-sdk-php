...
class MdfeSefazUnidCarga implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'lac_unid_carga' => '\ACBrAPI\Model\MdfeSefazLacUnidCarga[]',
        'qtd_rat' => 'float'
    ];
    ...
    */
     ...
     * Gets lac_unid_carga
     *
     * @return \ACBrAPI\Model\MdfeSefazLacUnidCarga[]|null
     */
     ...
     * Sets lac_unid_carga
     *
     * @param \ACBrAPI\Model\MdfeSefazLacUnidCarga[]|null $lac_unid_carga lac_unid_carga
     *
     * @return self
     */
    ...
    public function setQtdRat($qtd_rat)
    {
        ...
        if (!is_null($qtd_rat) && ($qtd_rat < 0)) {
            throw new \InvalidArgumentException('invalid value for $qtd_rat when calling MdfeSefazUnidCarga., must be bigger than or equal to 0.');
        }
