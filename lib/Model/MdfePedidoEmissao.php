...
class MdfePedidoEmissao implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'inf_mdfe' => '\ACBrAPI\Model\MdfeSefazInfMDFe',
        'inf_mdfe_supl' => '\ACBrAPI\Model\MdfeSefazInfMDFeSupl',
        'ambiente' => 'string',
        'referencia' => 'string'
    ];
    ...
    */
     ...
     * Gets inf_mdfe
     *
     * @return \ACBrAPI\Model\MdfeSefazInfMDFe
     */
     ...
     * Sets inf_mdfe
     *
     * @param \ACBrAPI\Model\MdfeSefazInfMDFe $inf_mdfe inf_mdfe
     *
     * @return self
     */
     ...
     * Gets inf_mdfe_supl
     *
     * @return \ACBrAPI\Model\MdfeSefazInfMDFeSupl|null
     */
     ...
     * Sets inf_mdfe_supl
     *
     * @param \ACBrAPI\Model\MdfeSefazInfMDFeSupl|null $inf_mdfe_supl inf_mdfe_supl
     *
     * @return self
     */
    ...
    public function setReferencia($referencia)
    {
        ...
        if (!is_null($referencia) && (mb_strlen($referencia) > 50)) {
            throw new \InvalidArgumentException('invalid length for $referencia when calling MdfePedidoEmissao., must be smaller than or equal to 50.');
        }
