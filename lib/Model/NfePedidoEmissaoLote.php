...
class NfePedidoEmissaoLote implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'documentos' => '\ACBrAPI\Model\NfePedidoEmissao[]',
        'ambiente' => 'string',
        'referencia' => 'string',
        'id_lote' => 'string'
    ];
    ...
    */
     ...
     * Gets documentos
     *
     * @return \ACBrAPI\Model\NfePedidoEmissao[]
     */
     ...
     * Sets documentos
     *
     * @param \ACBrAPI\Model\NfePedidoEmissao[] $documentos documentos
     *
     * @return self
     */
    ...
    public function setReferencia($referencia)
    {
        ...
        if ((mb_strlen($referencia) > 50)) {
            throw new \InvalidArgumentException('invalid length for $referencia when calling NfePedidoEmissaoLote., must be smaller than or equal to 50.');
        }
