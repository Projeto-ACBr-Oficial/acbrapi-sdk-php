...
/**
 * DceSefazInfSolicDCe Class Doc Comment
 *
 * @category Class
 ...
 */
class DceSefazInfSolicDCe implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'DceSefazInfSolicDCe';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ((mb_strlen($this->container['x_solic']) < 0)) {
            $invalidProperties[] = "invalid value for 'x_solic', the character length must be bigger than or equal to 0.";
        }
     ...
     * Sets x_solic
     *
     * @param string $x_solic Solicitação do pedido de emissão da DCe.
     *
     * @return self
     */
    public function setXSolic($x_solic)
    {
        ...
        if (!is_null($x_solic) && (mb_strlen($x_solic) > 2000)) {
            throw new \InvalidArgumentException('invalid length for $x_solic when calling DceSefazInfSolicDCe., must be smaller than or equal to 2000.');
        }
        if (!is_null($x_solic) && (mb_strlen($x_solic) < 0)) {
            throw new \InvalidArgumentException('invalid length for $x_solic when calling DceSefazInfSolicDCe., must be bigger than or equal to 0.');
        }
