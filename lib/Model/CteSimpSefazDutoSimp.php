...
/**
 * CteSimpSefazDutoSimp Class Doc Comment
 *
 * @category Class
 ...
 */
class CteSimpSefazDutoSimp implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CteSimpSefazDutoSimp';
    ...
    */
    ...
    public function setVTar($v_tar)
    {
        ...
        if (!is_null($v_tar) && ($v_tar <= 0)) {
            throw new \InvalidArgumentException('invalid value for $v_tar when calling CteSimpSefazDutoSimp., must be bigger than 0.');
        }
