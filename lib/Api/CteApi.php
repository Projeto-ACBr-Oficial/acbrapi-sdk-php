...
/**
     ...
     * @throws \ACBrAPI\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \ACBrAPI\Model\CteCartaCorrecao
     */
     ...
     * @throws \ACBrAPI\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \ACBrAPI\Model\CteCartaCorrecao, HTTP status code, HTTP response headers (array of strings)
     */
    public function consultarCartaCorrecaoCteWithHttpInfo($id, string $contentType = self::contentTypes['consultarCartaCorrecaoCte'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\ACBrAPI\Model\CteCartaCorrecao' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\ACBrAPI\Model\CteCartaCorrecao' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\ACBrAPI\Model\CteCartaCorrecao', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\ACBrAPI\Model\CteCartaCorrecao';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\ACBrAPI\Model\CteCartaCorrecao',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * Emitir CT-e
     *
     * @param  \ACBrAPI\Model\CtePedidoEmissao $body body (required)
     ...
     * Emitir CT-e
     *
     * @param  \ACBrAPI\Model\CtePedidoEmissao $body (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['emitirCte'] to see the possible values for this operation
     *
     * @throws \ACBrAPI\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     ...
     *
     * @param  \ACBrAPI\Model\CteSimpPedidoEmissao $body body (required)
     ...
     * Emitir CT-e Simplificado
     *
     * @param  \ACBrAPI\Model\CteSimpPedidoEmissao $body (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['emitirCteSimp'] to see the possible values for this operation
     *
     * @throws \ACBrAPI\ApiException on non-2xx response
     * @throws \InvalidArgumentException
