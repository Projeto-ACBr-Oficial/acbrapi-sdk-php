...
/**
     ...
     * @throws \ACBrAPI\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \ACBrAPI\Model\DistribuicaoNfe
     */
     ...
     * @throws \ACBrAPI\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \ACBrAPI\Model\DistribuicaoNfe, HTTP status code, HTTP response headers (array of strings)
     */
    public function consultarDistribuicaoNfeWithHttpInfo($id, string $contentType = self::contentTypes['consultarDistribuicaoNfe'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\ACBrAPI\Model\DistribuicaoNfe' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\ACBrAPI\Model\DistribuicaoNfe' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\ACBrAPI\Model\DistribuicaoNfe', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\ACBrAPI\Model\DistribuicaoNfe';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
     ...
     * @throws \ACBrAPI\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \ACBrAPI\Model\DistribuicaoNfeDocumento
     */
     ...
     * @throws \ACBrAPI\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \ACBrAPI\Model\DistribuicaoNfeDocumento, HTTP status code, HTTP response headers (array of strings)
     */
    public function consultarDocumentoDistribuicaoNfeWithHttpInfo($id, string $contentType = self::contentTypes['consultarDocumentoDistribuicaoNfe'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\ACBrAPI\Model\DistribuicaoNfeDocumento' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\ACBrAPI\Model\DistribuicaoNfeDocumento' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\ACBrAPI\Model\DistribuicaoNfeDocumento', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\ACBrAPI\Model\DistribuicaoNfeDocumento';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\ACBrAPI\Model\DistribuicaoNfeDocumento',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @throws \ACBrAPI\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \ACBrAPI\Model\DistribuicaoNfeEvento
     */
     ...
     * @throws \ACBrAPI\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \ACBrAPI\Model\DistribuicaoNfeEvento, HTTP status code, HTTP response headers (array of strings)
     */
    public function consultarManifestacaoNfeWithHttpInfo($id, string $contentType = self::contentTypes['consultarManifestacaoNfe'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\ACBrAPI\Model\DistribuicaoNfeEvento' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\ACBrAPI\Model\DistribuicaoNfeEvento' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\ACBrAPI\Model\DistribuicaoNfeEvento', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\ACBrAPI\Model\DistribuicaoNfeEvento';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\ACBrAPI\Model\DistribuicaoNfeEvento',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     *
     * @param  \ACBrAPI\Model\DistribuicaoNfePedido $body body (required)
     ...
     * Distribuir documentos
     *
     * @param  \ACBrAPI\Model\DistribuicaoNfePedido $body (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['gerarDistribuicaoNfe'] to see the possible values for this operation
     *
     * @throws \ACBrAPI\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     ...
     * @throws \ACBrAPI\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \ACBrAPI\Model\DistribuicaoNfeListagem
     */
     ...
     * @throws \ACBrAPI\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \ACBrAPI\Model\DistribuicaoNfeListagem, HTTP status code, HTTP response headers (array of strings)
     */
    public function listarDistribuicaoNfeWithHttpInfo($cpf_cnpj, $ambiente, $top = 10, $skip = 0, $inlinecount = false, string $contentType = self::contentTypes['listarDistribuicaoNfe'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\ACBrAPI\Model\DistribuicaoNfeListagem' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\ACBrAPI\Model\DistribuicaoNfeListagem' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\ACBrAPI\Model\DistribuicaoNfeListagem', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\ACBrAPI\Model\DistribuicaoNfeListagem';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\ACBrAPI\Model\DistribuicaoNfeListagem',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @throws \ACBrAPI\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \ACBrAPI\Model\DistribuicaoNfeDocumentoListagem
     */
     ...
     * @throws \ACBrAPI\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \ACBrAPI\Model\DistribuicaoNfeDocumentoListagem, HTTP status code, HTTP response headers (array of strings)
     */
    public function listarDocumentoDistribuicaoNfeWithHttpInfo($cpf_cnpj, $ambiente, $top = 10, $skip = 0, $inlinecount = false, $dist_nsu = null, $tipo_documento = null, $forma_distribuicao = null, $chave_acesso = null, string $contentType = self::contentTypes['listarDocumentoDistribuicaoNfe'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\ACBrAPI\Model\DistribuicaoNfeDocumentoListagem' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\ACBrAPI\Model\DistribuicaoNfeDocumentoListagem' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\ACBrAPI\Model\DistribuicaoNfeDocumentoListagem', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\ACBrAPI\Model\DistribuicaoNfeDocumentoListagem';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\ACBrAPI\Model\DistribuicaoNfeDocumentoListagem',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @throws \ACBrAPI\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \ACBrAPI\Model\ManifestacaoNfeListagem
     */
     ...
     * @throws \ACBrAPI\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \ACBrAPI\Model\ManifestacaoNfeListagem, HTTP status code, HTTP response headers (array of strings)
     */
    public function listarManifestacaoNfeWithHttpInfo($cpf_cnpj, $ambiente, $top = 10, $skip = 0, $inlinecount = false, string $contentType = self::contentTypes['listarManifestacaoNfe'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\ACBrAPI\Model\ManifestacaoNfeListagem' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\ACBrAPI\Model\ManifestacaoNfeListagem' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\ACBrAPI\Model\ManifestacaoNfeListagem', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\ACBrAPI\Model\ManifestacaoNfeListagem';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\ACBrAPI\Model\ManifestacaoNfeListagem',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @throws \ACBrAPI\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \ACBrAPI\Model\DistribuicaoNfeNotaListagem
     */
     ...
     * @throws \ACBrAPI\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \ACBrAPI\Model\DistribuicaoNfeNotaListagem, HTTP status code, HTTP response headers (array of strings)
     */
    public function listarNfeSemManifestacaoWithHttpInfo($cpf_cnpj, $ambiente, $top = 10, $skip = 0, $inlinecount = false, $conclusiva = false, string $contentType = self::contentTypes['listarNfeSemManifestacao'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\ACBrAPI\Model\DistribuicaoNfeNotaListagem' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\ACBrAPI\Model\DistribuicaoNfeNotaListagem' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\ACBrAPI\Model\DistribuicaoNfeNotaListagem', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\ACBrAPI\Model\DistribuicaoNfeNotaListagem';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\ACBrAPI\Model\DistribuicaoNfeNotaListagem',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * Manifestar nota
     *
     * @param  \ACBrAPI\Model\DistribuicaoNfePedidoManifestacao $body Contém os dados do pedido para manifestação do destinatário. (required)
