...
/**
     ...
     * @param  \ACBrAPI\Model\EmpresaConfigCte $body body (required)
     ...
     * @return \ACBrAPI\Model\EmpresaConfigCte
     */
     ...
     *
     * @param  string $cpf_cnpj CPF ou CNPJ da empresa.  Utilize o valor sem máscara. (required)
     * @param  \ACBrAPI\Model\EmpresaConfigCte $body (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['alterarConfigCte'] to see the possible values for this operation
     *
     * @throws \ACBrAPI\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \ACBrAPI\Model\EmpresaConfigCte, HTTP status code, HTTP response headers (array of strings)
     */
    public function alterarConfigCteWithHttpInfo($cpf_cnpj, $body, string $contentType = self::contentTypes['alterarConfigCte'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\ACBrAPI\Model\EmpresaConfigCte' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\ACBrAPI\Model\EmpresaConfigCte' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\ACBrAPI\Model\EmpresaConfigCte', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\ACBrAPI\Model\EmpresaConfigCte';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\ACBrAPI\Model\EmpresaConfigCte',
     ...
     *
     * @param  string $cpf_cnpj CPF ou CNPJ da empresa.  Utilize o valor sem máscara. (required)
     * @param  \ACBrAPI\Model\EmpresaConfigCteOs $body body (required)
     ...
     * @throws \ACBrAPI\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \ACBrAPI\Model\EmpresaConfigCteOs
     */
     ...
     *
     * @param  string $cpf_cnpj CPF ou CNPJ da empresa.  Utilize o valor sem máscara. (required)
     * @param  \ACBrAPI\Model\EmpresaConfigCteOs $body (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['alterarConfigCteOs'] to see the possible values for this operation
     *
     * @throws \ACBrAPI\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \ACBrAPI\Model\EmpresaConfigCteOs, HTTP status code, HTTP response headers (array of strings)
     */
    public function alterarConfigCteOsWithHttpInfo($cpf_cnpj, $body, string $contentType = self::contentTypes['alterarConfigCteOs'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\ACBrAPI\Model\EmpresaConfigCteOs' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\ACBrAPI\Model\EmpresaConfigCteOs' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\ACBrAPI\Model\EmpresaConfigCteOs', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\ACBrAPI\Model\EmpresaConfigCteOs';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\ACBrAPI\Model\EmpresaConfigCteOs',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     *
     * @param  string $cpf_cnpj CPF ou CNPJ da empresa.  Utilize o valor sem máscara. (required)
     * @param  \ACBrAPI\Model\EmpresaConfigDce $body body (required)
     ...
     * @throws \ACBrAPI\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \ACBrAPI\Model\EmpresaConfigDce
     */
     ...
     *
     * @param  string $cpf_cnpj CPF ou CNPJ da empresa.  Utilize o valor sem máscara. (required)
     * @param  \ACBrAPI\Model\EmpresaConfigDce $body (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['alterarConfigDce'] to see the possible values for this operation
     *
     * @throws \ACBrAPI\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \ACBrAPI\Model\EmpresaConfigDce, HTTP status code, HTTP response headers (array of strings)
     */
    public function alterarConfigDceWithHttpInfo($cpf_cnpj, $body, string $contentType = self::contentTypes['alterarConfigDce'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\ACBrAPI\Model\EmpresaConfigDce' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\ACBrAPI\Model\EmpresaConfigDce' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\ACBrAPI\Model\EmpresaConfigDce', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\ACBrAPI\Model\EmpresaConfigDce';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\ACBrAPI\Model\EmpresaConfigDce',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     *
     * @param  string $cpf_cnpj CPF ou CNPJ da empresa.  Utilize o valor sem máscara. (required)
     * @param  \ACBrAPI\Model\EmpresaConfigDistribuicaoNfe $body body (required)
     ...
     * @throws \ACBrAPI\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \ACBrAPI\Model\EmpresaConfigDistribuicaoNfe
     */
     ...
     *
     * @param  string $cpf_cnpj CPF ou CNPJ da empresa.  Utilize o valor sem máscara. (required)
     * @param  \ACBrAPI\Model\EmpresaConfigDistribuicaoNfe $body (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['alterarConfigDistribuicaoNfe'] to see the possible values for this operation
     *
     * @throws \ACBrAPI\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \ACBrAPI\Model\EmpresaConfigDistribuicaoNfe, HTTP status code, HTTP response headers (array of strings)
     */
    public function alterarConfigDistribuicaoNfeWithHttpInfo($cpf_cnpj, $body, string $contentType = self::contentTypes['alterarConfigDistribuicaoNfe'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\ACBrAPI\Model\EmpresaConfigDistribuicaoNfe' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\ACBrAPI\Model\EmpresaConfigDistribuicaoNfe' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\ACBrAPI\Model\EmpresaConfigDistribuicaoNfe', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\ACBrAPI\Model\EmpresaConfigDistribuicaoNfe';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\ACBrAPI\Model\EmpresaConfigDistribuicaoNfe',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     *
     * @param  string $cpf_cnpj CPF ou CNPJ da empresa.  Utilize o valor sem máscara. (required)
     * @param  \ACBrAPI\Model\EmpresaConfigMdfe $body body (required)
     ...
     * @throws \ACBrAPI\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \ACBrAPI\Model\EmpresaConfigMdfe
     */
     ...
     *
     * @param  string $cpf_cnpj CPF ou CNPJ da empresa.  Utilize o valor sem máscara. (required)
     * @param  \ACBrAPI\Model\EmpresaConfigMdfe $body (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['alterarConfigMdfe'] to see the possible values for this operation
     *
     * @throws \ACBrAPI\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \ACBrAPI\Model\EmpresaConfigMdfe, HTTP status code, HTTP response headers (array of strings)
     */
    public function alterarConfigMdfeWithHttpInfo($cpf_cnpj, $body, string $contentType = self::contentTypes['alterarConfigMdfe'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\ACBrAPI\Model\EmpresaConfigMdfe' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\ACBrAPI\Model\EmpresaConfigMdfe' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\ACBrAPI\Model\EmpresaConfigMdfe', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\ACBrAPI\Model\EmpresaConfigMdfe';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\ACBrAPI\Model\EmpresaConfigMdfe',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     *
     * @param  string $cpf_cnpj CPF ou CNPJ da empresa.  Utilize o valor sem máscara. (required)
     * @param  \ACBrAPI\Model\EmpresaConfigNfce $body body (required)
     ...
     * @throws \ACBrAPI\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \ACBrAPI\Model\EmpresaConfigNfce
     */
     ...
     *
     * @param  string $cpf_cnpj CPF ou CNPJ da empresa.  Utilize o valor sem máscara. (required)
     * @param  \ACBrAPI\Model\EmpresaConfigNfce $body (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['alterarConfigNfce'] to see the possible values for this operation
     *
     * @throws \ACBrAPI\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \ACBrAPI\Model\EmpresaConfigNfce, HTTP status code, HTTP response headers (array of strings)
     */
    public function alterarConfigNfceWithHttpInfo($cpf_cnpj, $body, string $contentType = self::contentTypes['alterarConfigNfce'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\ACBrAPI\Model\EmpresaConfigNfce' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\ACBrAPI\Model\EmpresaConfigNfce' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\ACBrAPI\Model\EmpresaConfigNfce', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\ACBrAPI\Model\EmpresaConfigNfce';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\ACBrAPI\Model\EmpresaConfigNfce',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     *
     * @param  string $cpf_cnpj CPF ou CNPJ da empresa.  Utilize o valor sem máscara. (required)
     * @param  \ACBrAPI\Model\EmpresaConfigNfcom $body body (required)
     ...
     * @throws \ACBrAPI\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \ACBrAPI\Model\EmpresaConfigNfcom
     */
     ...
     *
     * @param  string $cpf_cnpj CPF ou CNPJ da empresa.  Utilize o valor sem máscara. (required)
     * @param  \ACBrAPI\Model\EmpresaConfigNfcom $body (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['alterarConfigNfcom'] to see the possible values for this operation
     *
     * @throws \ACBrAPI\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \ACBrAPI\Model\EmpresaConfigNfcom, HTTP status code, HTTP response headers (array of strings)
     */
    public function alterarConfigNfcomWithHttpInfo($cpf_cnpj, $body, string $contentType = self::contentTypes['alterarConfigNfcom'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\ACBrAPI\Model\EmpresaConfigNfcom' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\ACBrAPI\Model\EmpresaConfigNfcom' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\ACBrAPI\Model\EmpresaConfigNfcom', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\ACBrAPI\Model\EmpresaConfigNfcom';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\ACBrAPI\Model\EmpresaConfigNfcom',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     *
     * @param  string $cpf_cnpj CPF ou CNPJ da empresa.  Utilize o valor sem máscara. (required)
     * @param  \ACBrAPI\Model\EmpresaConfigNfe $body body (required)
     ...
     * @throws \ACBrAPI\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \ACBrAPI\Model\EmpresaConfigNfe
     */
     ...
     *
     * @param  string $cpf_cnpj CPF ou CNPJ da empresa.  Utilize o valor sem máscara. (required)
     * @param  \ACBrAPI\Model\EmpresaConfigNfe $body (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['alterarConfigNfe'] to see the possible values for this operation
     *
     * @throws \ACBrAPI\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \ACBrAPI\Model\EmpresaConfigNfe, HTTP status code, HTTP response headers (array of strings)
     */
    public function alterarConfigNfeWithHttpInfo($cpf_cnpj, $body, string $contentType = self::contentTypes['alterarConfigNfe'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\ACBrAPI\Model\EmpresaConfigNfe' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\ACBrAPI\Model\EmpresaConfigNfe' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\ACBrAPI\Model\EmpresaConfigNfe', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\ACBrAPI\Model\EmpresaConfigNfe';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\ACBrAPI\Model\EmpresaConfigNfe',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     *
     * @param  string $cpf_cnpj CPF ou CNPJ da empresa.  Utilize o valor sem máscara. (required)
     * @param  \ACBrAPI\Model\EmpresaConfigNfse $body body (required)
     ...
     * @throws \ACBrAPI\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \ACBrAPI\Model\EmpresaConfigNfse
     */
     ...
     *
     * @param  string $cpf_cnpj CPF ou CNPJ da empresa.  Utilize o valor sem máscara. (required)
     * @param  \ACBrAPI\Model\EmpresaConfigNfse $body (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['alterarConfigNfse'] to see the possible values for this operation
     *
     * @throws \ACBrAPI\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \ACBrAPI\Model\EmpresaConfigNfse, HTTP status code, HTTP response headers (array of strings)
     */
    public function alterarConfigNfseWithHttpInfo($cpf_cnpj, $body, string $contentType = self::contentTypes['alterarConfigNfse'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\ACBrAPI\Model\EmpresaConfigNfse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\ACBrAPI\Model\EmpresaConfigNfse' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\ACBrAPI\Model\EmpresaConfigNfse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\ACBrAPI\Model\EmpresaConfigNfse';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\ACBrAPI\Model\EmpresaConfigNfse',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     *
     * @param  string $cpf_cnpj CPF ou CNPJ da empresa.  Utilize o valor sem máscara. (required)
     * @param  \ACBrAPI\Model\Empresa $body body (required)
     ...
     *
     * @param  string $cpf_cnpj CPF ou CNPJ da empresa.  Utilize o valor sem máscara. (required)
     * @param  \ACBrAPI\Model\Empresa $body (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['atualizarEmpresa'] to see the possible values for this operation
     *
     * @throws \ACBrAPI\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \ACBrAPI\Model\Empresa, HTTP status code, HTTP response headers (array of strings)
     */
    public function atualizarEmpresaWithHttpInfo($cpf_cnpj, $body, string $contentType = self::contentTypes['atualizarEmpresa'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\ACBrAPI\Model\Empresa' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\ACBrAPI\Model\Empresa' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\ACBrAPI\Model\Empresa', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\ACBrAPI\Model\Empresa';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
     ...
     *
     * @param  string $cpf_cnpj CPF ou CNPJ da empresa.  Utilize o valor sem máscara. (required)
     * @param  \ACBrAPI\Model\EmpresaPedidoCadastroCertificado $body body (required)
     ...
     * @throws \ACBrAPI\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \ACBrAPI\Model\EmpresaCertificado
     */
     ...
     *
     * @param  string $cpf_cnpj CPF ou CNPJ da empresa.  Utilize o valor sem máscara. (required)
     * @param  \ACBrAPI\Model\EmpresaPedidoCadastroCertificado $body (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['cadastrarCertificadoEmpresa'] to see the possible values for this operation
     *
     * @throws \ACBrAPI\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \ACBrAPI\Model\EmpresaCertificado, HTTP status code, HTTP response headers (array of strings)
     */
    public function cadastrarCertificadoEmpresaWithHttpInfo($cpf_cnpj, $body, string $contentType = self::contentTypes['cadastrarCertificadoEmpresa'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\ACBrAPI\Model\EmpresaCertificado' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\ACBrAPI\Model\EmpresaCertificado' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\ACBrAPI\Model\EmpresaCertificado', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\ACBrAPI\Model\EmpresaCertificado';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\ACBrAPI\Model\EmpresaCertificado',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @throws \ACBrAPI\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \ACBrAPI\Model\EmpresaCertificadoListagem
     */
     ...
     * @throws \ACBrAPI\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \ACBrAPI\Model\EmpresaCertificadoListagem, HTTP status code, HTTP response headers (array of strings)
     */
    public function listarCertificadosWithHttpInfo($top = 10, $skip = 0, $inlinecount = false, $expires_in = null, $include_expired = true, string $contentType = self::contentTypes['listarCertificados'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\ACBrAPI\Model\EmpresaCertificadoListagem' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\ACBrAPI\Model\EmpresaCertificadoListagem' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\ACBrAPI\Model\EmpresaCertificadoListagem', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\ACBrAPI\Model\EmpresaCertificadoListagem';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\ACBrAPI\Model\EmpresaCertificadoListagem',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @throws \ACBrAPI\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \ACBrAPI\Model\EmpresaListagem
     */
     ...
     * @throws \ACBrAPI\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \ACBrAPI\Model\EmpresaListagem, HTTP status code, HTTP response headers (array of strings)
     */
    public function listarEmpresasWithHttpInfo($top = 10, $skip = 0, $inlinecount = false, $cpf_cnpj = null, $nome_razao_social = null, string $contentType = self::contentTypes['listarEmpresas'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\ACBrAPI\Model\EmpresaListagem' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\ACBrAPI\Model\EmpresaListagem' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\ACBrAPI\Model\EmpresaListagem', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\ACBrAPI\Model\EmpresaListagem';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
