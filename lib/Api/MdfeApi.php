...
/**
     ...
     * @throws \ACBrAPI\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \ACBrAPI\Model\MdfeEncerramento
     */
     ...
     * @throws \ACBrAPI\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \ACBrAPI\Model\MdfeEncerramento, HTTP status code, HTTP response headers (array of strings)
     */
    public function consultarEncerramentoMdfeWithHttpInfo($id, string $contentType = self::contentTypes['consultarEncerramentoMdfe'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\ACBrAPI\Model\MdfeEncerramento' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\ACBrAPI\Model\MdfeEncerramento' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\ACBrAPI\Model\MdfeEncerramento', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\ACBrAPI\Model\MdfeEncerramento';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\ACBrAPI\Model\MdfeEncerramento',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @throws \ACBrAPI\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \ACBrAPI\Model\MdfeNaoEncerrados
     */
     ...
     * @throws \ACBrAPI\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \ACBrAPI\Model\MdfeNaoEncerrados, HTTP status code, HTTP response headers (array of strings)
     */
    public function consultarMdfeNaoEncerradosWithHttpInfo($cpf_cnpj, string $contentType = self::contentTypes['consultarMdfeNaoEncerrados'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\ACBrAPI\Model\MdfeNaoEncerrados' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\ACBrAPI\Model\MdfeNaoEncerrados' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\ACBrAPI\Model\MdfeNaoEncerrados', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\ACBrAPI\Model\MdfeNaoEncerrados';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\ACBrAPI\Model\MdfeNaoEncerrados',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     *
     * @param  \ACBrAPI\Model\MdfePedidoEmissaoLote $body body (required)
     ...
     * Emitir lote de MDF-e
     *
     * @param  \ACBrAPI\Model\MdfePedidoEmissaoLote $body (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['emitirLoteMdfe'] to see the possible values for this operation
     *
     * @throws \ACBrAPI\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     ...
     * Emitir MDF-e
     *
     * @param  \ACBrAPI\Model\MdfePedidoEmissao $body body (required)
     ...
     * Emitir MDF-e
     *
     * @param  \ACBrAPI\Model\MdfePedidoEmissao $body (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['emitirMdfe'] to see the possible values for this operation
     *
     * @throws \ACBrAPI\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     ...
     * @throws \ACBrAPI\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \ACBrAPI\Model\MdfeInclusaoCondutor
     */
     ...
     * @throws \ACBrAPI\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \ACBrAPI\Model\MdfeInclusaoCondutor, HTTP status code, HTTP response headers (array of strings)
     */
    public function incluirCondutorMdfeWithHttpInfo($id, $body, string $contentType = self::contentTypes['incluirCondutorMdfe'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\ACBrAPI\Model\MdfeInclusaoCondutor' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\ACBrAPI\Model\MdfeInclusaoCondutor' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\ACBrAPI\Model\MdfeInclusaoCondutor', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\ACBrAPI\Model\MdfeInclusaoCondutor';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\ACBrAPI\Model\MdfeInclusaoCondutor',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @throws \ACBrAPI\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \ACBrAPI\Model\MdfeInclusaoDfe
     */
     ...
     * @throws \ACBrAPI\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \ACBrAPI\Model\MdfeInclusaoDfe, HTTP status code, HTTP response headers (array of strings)
     */
    public function incluirDfeMdfeWithHttpInfo($id, $body, string $contentType = self::contentTypes['incluirDfeMdfe'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\ACBrAPI\Model\MdfeInclusaoDfe' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\ACBrAPI\Model\MdfeInclusaoDfe' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\ACBrAPI\Model\MdfeInclusaoDfe', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\ACBrAPI\Model\MdfeInclusaoDfe';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
