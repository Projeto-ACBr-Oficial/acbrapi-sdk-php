...
/**
     ...
     * @throws \ACBrAPI\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \ACBrAPI\Model\NfseCancelamento
     */
     ...
     * @throws \ACBrAPI\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \ACBrAPI\Model\NfseCancelamento, HTTP status code, HTTP response headers (array of strings)
     */
    public function cancelarNfseWithHttpInfo($id, $body = null, string $contentType = self::contentTypes['cancelarNfse'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\ACBrAPI\Model\NfseCancelamento' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\ACBrAPI\Model\NfseCancelamento' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\ACBrAPI\Model\NfseCancelamento', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\ACBrAPI\Model\NfseCancelamento';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\ACBrAPI\Model\NfseCancelamento',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @throws \ACBrAPI\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \ACBrAPI\Model\NfseCidadesAtendidas
     */
     ...
     * @throws \ACBrAPI\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \ACBrAPI\Model\NfseCidadesAtendidas, HTTP status code, HTTP response headers (array of strings)
     */
    public function cidadesAtendidasWithHttpInfo(string $contentType = self::contentTypes['cidadesAtendidas'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\ACBrAPI\Model\NfseCidadesAtendidas' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\ACBrAPI\Model\NfseCidadesAtendidas' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\ACBrAPI\Model\NfseCidadesAtendidas', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\ACBrAPI\Model\NfseCidadesAtendidas';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\ACBrAPI\Model\NfseCidadesAtendidas',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @throws \ACBrAPI\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \ACBrAPI\Model\RpsLote, HTTP status code, HTTP response headers (array of strings)
     */
    public function consultarLoteNfseWithHttpInfo($id, string $contentType = self::contentTypes['consultarLoteNfse'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\ACBrAPI\Model\RpsLote' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\ACBrAPI\Model\RpsLote' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\ACBrAPI\Model\RpsLote', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\ACBrAPI\Model\RpsLote';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
     ...
     * @throws \ACBrAPI\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \ACBrAPI\Model\NfseCidadeMetadados
     */
     ...
     * @throws \ACBrAPI\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \ACBrAPI\Model\NfseCidadeMetadados, HTTP status code, HTTP response headers (array of strings)
     */
    public function consultarMetadadosWithHttpInfo($codigo_ibge, string $contentType = self::contentTypes['consultarMetadados'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\ACBrAPI\Model\NfseCidadeMetadados' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\ACBrAPI\Model\NfseCidadeMetadados' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\ACBrAPI\Model\NfseCidadeMetadados', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\ACBrAPI\Model\NfseCidadeMetadados';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\ACBrAPI\Model\NfseCidadeMetadados',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @throws \ACBrAPI\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \ACBrAPI\Model\Nfse, HTTP status code, HTTP response headers (array of strings)
     */
    public function consultarNfseWithHttpInfo($id, string $contentType = self::contentTypes['consultarNfse'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\ACBrAPI\Model\Nfse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\ACBrAPI\Model\Nfse' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\ACBrAPI\Model\Nfse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\ACBrAPI\Model\Nfse';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
     ...
     *
     * @param  \ACBrAPI\Model\RpsPedidoEmissaoLote $body body (required)
     ...
     * Emitir lote de NFS-e
     *
     * @param  \ACBrAPI\Model\RpsPedidoEmissaoLote $body (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['emitirLoteNfse'] to see the possible values for this operation
     *
     * @throws \ACBrAPI\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     ...
     * Emitir lote de NFS-e
     *
     * @param  \ACBrAPI\Model\NfseLoteDpsPedidoEmissao $body body (required)
     ...
     * Emitir lote de NFS-e
     *
     * @param  \ACBrAPI\Model\NfseLoteDpsPedidoEmissao $body (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['emitirLoteNfseDps'] to see the possible values for this operation
     *
     * @throws \ACBrAPI\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     ...
     * Emitir NFS-e
     *
     * @param  \ACBrAPI\Model\NfsePedidoEmissao $body body (required)
     ...
     * Emitir NFS-e
     *
     * @param  \ACBrAPI\Model\NfsePedidoEmissao $body (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['emitirNfse'] to see the possible values for this operation
     *
     * @throws \ACBrAPI\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     ...
     * Emitir NFS-e
     *
     * @param  \ACBrAPI\Model\NfseDpsPedidoEmissao $body body (required)
     ...
     * Emitir NFS-e
     *
     * @param  \ACBrAPI\Model\NfseDpsPedidoEmissao $body (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['emitirNfseDps'] to see the possible values for this operation
     *
     * @throws \ACBrAPI\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     ...
     * @throws \ACBrAPI\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \ACBrAPI\Model\RpsLoteListagem
     */
     ...
     * @throws \ACBrAPI\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \ACBrAPI\Model\RpsLoteListagem, HTTP status code, HTTP response headers (array of strings)
     */
    public function listarLotesNfseWithHttpInfo($cpf_cnpj, $ambiente, $top = 10, $skip = 0, $inlinecount = false, $referencia = null, string $contentType = self::contentTypes['listarLotesNfse'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\ACBrAPI\Model\RpsLoteListagem' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\ACBrAPI\Model\RpsLoteListagem' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\ACBrAPI\Model\RpsLoteListagem', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\ACBrAPI\Model\RpsLoteListagem';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
     ...
     * @throws \ACBrAPI\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \ACBrAPI\Model\NfseListagem
     */
     ...
     * @throws \ACBrAPI\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \ACBrAPI\Model\NfseListagem, HTTP status code, HTTP response headers (array of strings)
     */
    public function listarNfseWithHttpInfo($cpf_cnpj, $ambiente, $top = 10, $skip = 0, $inlinecount = false, $referencia = null, $chave = null, $serie = null, string $contentType = self::contentTypes['listarNfse'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\ACBrAPI\Model\NfseListagem' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\ACBrAPI\Model\NfseListagem' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\ACBrAPI\Model\NfseListagem', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\ACBrAPI\Model\NfseListagem';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
     ...
     * @throws \ACBrAPI\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \ACBrAPI\Model\NfseSincronizacao
     */
     ...
     * @throws \ACBrAPI\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \ACBrAPI\Model\NfseSincronizacao, HTTP status code, HTTP response headers (array of strings)
     */
    public function sincronizarNfseWithHttpInfo($id, $body = null, string $contentType = self::contentTypes['sincronizarNfse'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\ACBrAPI\Model\NfseSincronizacao' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\ACBrAPI\Model\NfseSincronizacao' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\ACBrAPI\Model\NfseSincronizacao', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\ACBrAPI\Model\NfseSincronizacao';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\ACBrAPI\Model\NfseSincronizacao',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
