...
$apiInstance = new ACBrAPI\Api\DistribuioNFEApi(
...
```php
consultarDistribuicaoNfe($id): \ACBrAPI\Model\DistribuicaoNfe
```
...
[**\ACBrAPI\Model\DistribuicaoNfe**](../Model/DistribuicaoNfe.md)
...
```php
consultarDocumentoDistribuicaoNfe($id): \ACBrAPI\Model\DistribuicaoNfeDocumento
```
...
[**\ACBrAPI\Model\DistribuicaoNfeDocumento**](../Model/DistribuicaoNfeDocumento.md)
...
```php
consultarManifestacaoNfe($id): \ACBrAPI\Model\DistribuicaoNfeEvento
```
...
[**\ACBrAPI\Model\DistribuicaoNfeEvento**](../Model/DistribuicaoNfeEvento.md)
...
```php
gerarDistribuicaoNfe($body): \ACBrAPI\Model\DistribuicaoNfe
```
...
$body = new \ACBrAPI\Model\DistribuicaoNfePedido(); // \ACBrAPI\Model\DistribuicaoNfePedido
...
| Nome | Tipo | Descrição  | Notas |
| ------------- | ------------- | ------------- | ------------- |
| **body** | [**\ACBrAPI\Model\DistribuicaoNfePedido**](../Model/DistribuicaoNfePedido.md)|  | |
...
```php
listarDistribuicaoNfe($cpf_cnpj, $ambiente, $top, $skip, $inlinecount): \ACBrAPI\Model\DistribuicaoNfeListagem
```
...
[**\ACBrAPI\Model\DistribuicaoNfeListagem**](../Model/DistribuicaoNfeListagem.md)
...
```php
listarDocumentoDistribuicaoNfe($cpf_cnpj, $ambiente, $top, $skip, $inlinecount, $dist_nsu, $tipo_documento, $forma_distribuicao, $chave_acesso): \ACBrAPI\Model\DistribuicaoNfeDocumentoListagem
```
...
[**\ACBrAPI\Model\DistribuicaoNfeDocumentoListagem**](../Model/DistribuicaoNfeDocumentoListagem.md)
...
```php
listarManifestacaoNfe($cpf_cnpj, $ambiente, $top, $skip, $inlinecount): \ACBrAPI\Model\ManifestacaoNfeListagem
```
...
[**\ACBrAPI\Model\ManifestacaoNfeListagem**](../Model/ManifestacaoNfeListagem.md)
...
```php
listarNfeSemManifestacao($cpf_cnpj, $ambiente, $top, $skip, $inlinecount, $conclusiva): \ACBrAPI\Model\DistribuicaoNfeNotaListagem
```
...
[**\ACBrAPI\Model\DistribuicaoNfeNotaListagem**](../Model/DistribuicaoNfeNotaListagem.md)
...
```php
manifestarNfe($body): \ACBrAPI\Model\DistribuicaoNfeEvento
```
...
$body = new \ACBrAPI\Model\DistribuicaoNfePedidoManifestacao(); // \ACBrAPI\Model\DistribuicaoNfePedidoManifestacao | Contém os dados do pedido para manifestação do destinatário.
...
| Nome | Tipo | Descrição  | Notas |
| ------------- | ------------- | ------------- | ------------- |
| **body** | [**\ACBrAPI\Model\DistribuicaoNfePedidoManifestacao**](../Model/DistribuicaoNfePedidoManifestacao.md)| Contém os dados do pedido para manifestação do destinatário. | |
