...
$apiInstance = new ACBrAPI\Api\CteOsApi(
...
```php
cancelarCteOs($id, $body): \ACBrAPI\Model\DfeCancelamento
```
...
$id = 'id_example'; // string | ID único do CT-e OS gerado pela Nuvem Fiscal.
$body = new \ACBrAPI\Model\CteOsPedidoCancelamento(); // \ACBrAPI\Model\CteOsPedidoCancelamento
...
| ------------- | ------------- | ------------- | ------------- |
| **id** | **string**| ID único do CT-e OS gerado pela Nuvem Fiscal. | |
| **body** | [**\ACBrAPI\Model\CteOsPedidoCancelamento**](../Model/CteOsPedidoCancelamento.md)|  | [optional] |
...
```php
consultarCancelamentoCteOs($id): \ACBrAPI\Model\DfeCancelamento
```
...
```php
consultarCartaCorrecaoCteOs($id): \ACBrAPI\Model\CteOsCartaCorrecao
```
...
[**\ACBrAPI\Model\CteOsCartaCorrecao**](../Model/CteOsCartaCorrecao.md)
...
```php
consultarCteOs($id): \ACBrAPI\Model\Dfe
```
...
```php
consultarEventoCteOs($id): \ACBrAPI\Model\DfeEvento
```
...
```php
consultarStatusSefazCteOs($cpf_cnpj, $autorizador): \ACBrAPI\Model\DfeSefazStatus
```
...
```php
criarCartaCorrecaoCteOs($id, $body): \ACBrAPI\Model\CteOsCartaCorrecao
```
...
$id = 'id_example'; // string | ID único do CT-e OS gerado pela Nuvem Fiscal.
$body = new \ACBrAPI\Model\CteOsPedidoCartaCorrecao(); // \ACBrAPI\Model\CteOsPedidoCartaCorrecao
...
| ------------- | ------------- | ------------- | ------------- |
| **id** | **string**| ID único do CT-e OS gerado pela Nuvem Fiscal. | |
| **body** | [**\ACBrAPI\Model\CteOsPedidoCartaCorrecao**](../Model/CteOsPedidoCartaCorrecao.md)|  | |
...
```php
emitirCteOs($body): \ACBrAPI\Model\Dfe
```
...
$body = new \ACBrAPI\Model\CteOsPedidoEmissao(); // \ACBrAPI\Model\CteOsPedidoEmissao
...
| Nome | Tipo | Descrição  | Notas |
| ------------- | ------------- | ------------- | ------------- |
| **body** | [**\ACBrAPI\Model\CteOsPedidoEmissao**](../Model/CteOsPedidoEmissao.md)|  | |
...
```php
listarCteOs($cpf_cnpj, $ambiente, $top, $skip, $inlinecount, $referencia, $chave, $serie): \ACBrAPI\Model\DfeListagem
```
...
```php
sincronizarCteOs($id): \ACBrAPI\Model\DfeSincronizacao
```
