...
```php
consultarEmail($id): \ACBrAPI\Model\Email
```
...
$apiInstance = new ACBrAPI\Api\EmailApi(
...
[**\ACBrAPI\Model\Email**](../Model/Email.md)
...
```php
listarEmails($cpf_cnpj, $top, $skip, $inlinecount, $undelivered, $email): \ACBrAPI\Model\EmailListagem
```
...
[**\ACBrAPI\Model\EmailListagem**](../Model/EmailListagem.md)
