...
$apiInstance = new ACBrAPI\Api\CteApi(
...
```php
cancelarCte($id, $body): \ACBrAPI\Model\DfeCancelamento
```
...
```php
consultarCancelamentoCte($id): \ACBrAPI\Model\DfeCancelamento
```
...
```php
consultarCartaCorrecaoCte($id): \ACBrAPI\Model\CteCartaCorrecao
```
...
[**\ACBrAPI\Model\CteCartaCorrecao**](../Model/CteCartaCorrecao.md)
...
```php
consultarCte($id): \ACBrAPI\Model\Dfe
```
...
```php
consultarEventoCte($id): \ACBrAPI\Model\DfeEvento
```
...
```php
consultarStatusSefazCte($cpf_cnpj, $autorizador): \ACBrAPI\Model\DfeSefazStatus
```
...
```php
criarCartaCorrecaoCte($id, $body): \ACBrAPI\Model\CteCartaCorrecao
```
...
```php
emitirCte($body): \ACBrAPI\Model\Dfe
```
...
$body = new \ACBrAPI\Model\CtePedidoEmissao(); // \ACBrAPI\Model\CtePedidoEmissao
...
| Nome | Tipo | Descrição  | Notas |
| ------------- | ------------- | ------------- | ------------- |
| **body** | [**\ACBrAPI\Model\CtePedidoEmissao**](../Model/CtePedidoEmissao.md)|  | |
...
```php
emitirCteSimp($body): \ACBrAPI\Model\Dfe
```
...
$body = new \ACBrAPI\Model\CteSimpPedidoEmissao(); // \ACBrAPI\Model\CteSimpPedidoEmissao
...
| Nome | Tipo | Descrição  | Notas |
| ------------- | ------------- | ------------- | ------------- |
| **body** | [**\ACBrAPI\Model\CteSimpPedidoEmissao**](../Model/CteSimpPedidoEmissao.md)|  | |
...
```php
listarCte($cpf_cnpj, $ambiente, $top, $skip, $inlinecount, $referencia, $chave, $serie): \ACBrAPI\Model\DfeListagem
```
...
```php
sincronizarCte($id): \ACBrAPI\Model\DfeSincronizacao
```
