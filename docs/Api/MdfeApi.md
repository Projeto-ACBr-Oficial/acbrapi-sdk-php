...
$apiInstance = new ACBrAPI\Api\MdfeApi(
...
```php
cancelarMdfe($id, $body): \ACBrAPI\Model\DfeCancelamento
```
...
```php
consultarCancelamentoMdfe($id): \ACBrAPI\Model\DfeCancelamento
```
...
```php
consultarEncerramentoMdfe($id): \ACBrAPI\Model\MdfeEncerramento
```
...
[**\ACBrAPI\Model\MdfeEncerramento**](../Model/MdfeEncerramento.md)
...
```php
consultarEventoMdfe($id): \ACBrAPI\Model\DfeEvento
```
...
```php
consultarLoteMdfe($id): \ACBrAPI\Model\DfeLote
```
...
```php
consultarMdfe($id): \ACBrAPI\Model\Dfe
```
...
```php
consultarMdfeNaoEncerrados($cpf_cnpj): \ACBrAPI\Model\MdfeNaoEncerrados
```
...
[**\ACBrAPI\Model\MdfeNaoEncerrados**](../Model/MdfeNaoEncerrados.md)
...
```php
consultarStatusSefazMdfe($cpf_cnpj, $autorizador): \ACBrAPI\Model\DfeSefazStatus
```
...
```php
emitirLoteMdfe($body): \ACBrAPI\Model\DfeLote
```
...
$body = new \ACBrAPI\Model\MdfePedidoEmissaoLote(); // \ACBrAPI\Model\MdfePedidoEmissaoLote
...
| Nome | Tipo | Descrição  | Notas |
| ------------- | ------------- | ------------- | ------------- |
| **body** | [**\ACBrAPI\Model\MdfePedidoEmissaoLote**](../Model/MdfePedidoEmissaoLote.md)|  | |
...
```php
emitirMdfe($body): \ACBrAPI\Model\Dfe
```
...
$body = new \ACBrAPI\Model\MdfePedidoEmissao(); // \ACBrAPI\Model\MdfePedidoEmissao
...
| Nome | Tipo | Descrição  | Notas |
| ------------- | ------------- | ------------- | ------------- |
| **body** | [**\ACBrAPI\Model\MdfePedidoEmissao**](../Model/MdfePedidoEmissao.md)|  | |
...
```php
encerrarMdfe($id, $body): \ACBrAPI\Model\MdfeEncerramento
```
...
```php
incluirCondutorMdfe($id, $body): \ACBrAPI\Model\MdfeInclusaoCondutor
```
...
[**\ACBrAPI\Model\MdfeInclusaoCondutor**](../Model/MdfeInclusaoCondutor.md)
...
```php
incluirDfeMdfe($id, $body): \ACBrAPI\Model\MdfeInclusaoDfe
```
...
[**\ACBrAPI\Model\MdfeInclusaoDfe**](../Model/MdfeInclusaoDfe.md)
...
```php
listarLotesMdfe($cpf_cnpj, $ambiente, $top, $skip, $inlinecount, $referencia): \ACBrAPI\Model\DfeLoteListagem
```
...
```php
listarMdfe($cpf_cnpj, $ambiente, $top, $skip, $inlinecount, $referencia, $chave, $serie): \ACBrAPI\Model\DfeListagem
```
...
```php
sincronizarMdfe($id): \ACBrAPI\Model\DfeSincronizacao
```
