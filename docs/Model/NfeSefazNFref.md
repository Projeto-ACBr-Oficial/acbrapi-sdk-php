...
**ref_nf** | [**\ACBrAPI\Model\NfeSefazRefNF**](NfeSefazRefNF.md) |  | [optional]
**ref_nfp** | [**\ACBrAPI\Model\NfeSefazRefNFP**](NfeSefazRefNFP.md) |  | [optional]
**ref_cte** | **string** | Utilizar esta TAG para referenciar um CT-e emitido anteriormente, vinculada a NF-e atual. | [optional]
**ref_ecf** | [**\ACBrAPI\Model\NfeSefazRefECF**](NfeSefazRefECF.md) |  | [optional]
