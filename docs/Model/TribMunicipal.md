...
**exig_susp** | [**\ACBrAPI\Model\ExigSuspensa**](ExigSuspensa.md) |  | [optional]
**bm** | [**\ACBrAPI\Model\BeneficioMunicipal**](BeneficioMunicipal.md) |  | [optional]
...
**c_loc_incid** | **string** | Código do município de incidência do ISSQN (tabela do IBGE).    Caso o envio seja pelo Sistema Nacional NFS-e, essa propriedade - ignorada e o município de incidência do ISSQN - determinado automaticamente pela SEFIN nacional, conforme regras do aspecto espacial da lei complementar federal (LC 116/03) que são válidas para todos os municípios. | [optional]
