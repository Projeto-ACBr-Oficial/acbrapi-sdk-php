...
**cpf** | **string** | CPF do emitente.  Informar zeros não significativos.  Usar com série específica 920-969 para emitente pessoa física com inscrição estadual.  Poderá ser usado também para emissão do Regime Especial da Nota Fiscal Fácil.    ***Obrigatório caso o emitente seja pessoa física***. | [optional]
...
**ender_emit** | [**\ACBrAPI\Model\MdfeSefazEndeEmi**](MdfeSefazEndeEmi.md) |  | [optional]
