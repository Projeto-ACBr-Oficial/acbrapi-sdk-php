...
**fluxo** | [**\ACBrAPI\Model\CteSimpSefazFluxoSimp**](CteSimpSefazFluxoSimp.md) |  | [optional]
**x_obs** | **string** | Observações Gerais. | [optional]
**obs_cont** | [**\ACBrAPI\Model\CteSimpSefazObsContSimp[]**](CteSimpSefazObsContSimp.md) |  | [optional]
**obs_fisco** | [**\ACBrAPI\Model\CteSimpSefazObsFiscoSimp[]**](CteSimpSefazObsFiscoSimp.md) |  | [optional]
