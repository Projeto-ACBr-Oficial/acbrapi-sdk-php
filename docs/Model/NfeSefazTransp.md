...
**transporta** | [**\ACBrAPI\Model\NfeSefazTransporta**](NfeSefazTransporta.md) |  | [optional]
**ret_transp** | [**\ACBrAPI\Model\NfeSefazRetTransp**](NfeSefazRetTransp.md) |  | [optional]
**veic_transp** | [**\ACBrAPI\Model\NfeSefazVeiculo**](NfeSefazVeiculo.md) |  | [optional]
**reboque** | [**\ACBrAPI\Model\NfeSefazVeiculo[]**](NfeSefazVeiculo.md) |  | [optional]
**vagao** | **string** | Identificação do vagão (v2.0). | [optional]
**balsa** | **string** | Identificação da balsa (v2.0). | [optional]
**vol** | [**\ACBrAPI\Model\NfeSefazVol[]**](NfeSefazVol.md) |  | [optional]
